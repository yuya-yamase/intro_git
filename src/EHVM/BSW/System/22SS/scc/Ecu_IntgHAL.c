...
#define VAL_WR_u4RESFC_CLR (0x0000F5DDUL)                     /* R_RESF_CLR */
#endif
 ...
 * [Notes]	None
 *--------------------------------------------------------------------------*/
#if (((SS_USE_LWH == SS_LWH_EXIST) && defined(ECU_VM0)) || (SS_USE_LWH == SS_LWH_NONE))
void Ecu_IntgHAL_clearRAMV(void)
{
    ...
    SS_CpuCore_entryMasterSection();
    {
        ...
        u4Dummy = REG_u4VLVIKCPROT; /* dummy read */
        Ecu_Int_syncp();
    }
...
#endif /* ((SS_USE_LWH == SS_LWH_EXIST) && defined(ECU_VM0)) || (SS_USE_LWH == SS_LWH_NONE) */

/**---------------------------------------------------------------------------
 * [Format]		void Ecu_IntgHAL_clearResetFactor(void)
 ...
 *--------------------------------------------------------------------------*/
#ifdef ECU_VM0
void Ecu_IntgHAL_clearResetFactor(void)
{
    {
        volatile uint32 u4Dummy;

        REG_u4RESFC = VAL_WR_u4RESFC_CLR;
