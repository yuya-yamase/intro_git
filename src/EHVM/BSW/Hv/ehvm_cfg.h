...
#define SPID12_NUM_OF_RECEIVED_VCCID       (0x09U)
#define SPID13_NUM_OF_RECEIVED_VCCID       (0x01U)
#define SPID14_NUM_OF_RECEIVED_VCCID       (0x0AU)
