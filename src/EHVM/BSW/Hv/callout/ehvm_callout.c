...
#include "ehvm.h"
#include "ehvm_cfg.h"
#include "ehvm_callout.h"
#include "ehvm_callout_ghs.h"
#include "Ecu_Int.h"
#include "Port.h"
#include "Mcu.h"
#include "ErrH.h"
...
void ehvm_user_wakeup_event_init(void)
{
    /*------------------------------------------------------------------------------------------*/
    /* Zantei Memo :                                                                            */
    /* In the sample, the VM startup factors are set based on the MCU reset factors.            */
    /* Modify it to set the VM startup factors commonly regardless of the reset factors.        */
    /*------------------------------------------------------------------------------------------*/
