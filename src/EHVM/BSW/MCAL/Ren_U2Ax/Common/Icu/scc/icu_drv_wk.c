    ...
    if(u1_a_CH < (U1)ICU_WK_NUM_CH){
        ...
        if(u1_t_el < u1_g_ICU_NUM_EL) {
            ...
            if(u1_t_nex != u1_t_las){
                ...
                (void)u1_g_IntHndlrIRQst(u2_t_irq_ch, (U1)TRUE);
...
/*  1.2.0    10/29/2025  TN       u4_g_IcuWkRQst was updated because of BEVStep3-Cockpit Battery Low Detection                       */
/*                                                                                                                                   */
