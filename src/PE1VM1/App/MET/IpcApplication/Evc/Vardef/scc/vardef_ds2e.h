...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VDF_DS_2E_NUM_DID                        (4U)

#define VDF_DS_2E_2002                           (0U)     /* MET Customization / Odo Display-On Delay                */
#define VDF_DS_2E_2003                           (1U)     /* HUD Customization / Memory Call ...                     */
#define VDF_DS_2E_2041                           (2U)     /* MET Customization / Body Function                       */
#define VDF_DS_2E_20C2                           (3U)     /* MET Customization / Shift-By-Wire Reverse Buzzer 2      */
