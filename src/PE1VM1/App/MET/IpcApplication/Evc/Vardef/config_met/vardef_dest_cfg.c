...
/*  Macro Definitions                                                                                                                */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VDF_DEST_NUM_LAW_DESTID         (15U)
...
#define VDF_DEST_SPEC_DESTID0020        (5U)
#define VDF_DEST_SPEC_DESTID0021        (6U)
#define VDF_DEST_SPEC_DESTID0022        (7U)
#define VDF_DEST_SPEC_DESTID0023        (8U)
#define VDF_DEST_SPEC_DESTID0024        (9U)
#define VDF_DEST_SPEC_DESTID0025        (10U)
#define VDF_DEST_SPEC_DESTID0026        (11U)
#define VDF_DEST_SPEC_DESTID0027        (12U)
#define VDF_DEST_SPEC_DESTID0028        (13U)
#define VDF_DEST_SPEC_DESTID0029        (14U)

#define VDF_DEST_SPEC_LAW_DESTID        (3U)
...
static volatile const U1 *const    u1p_sp2_VDF_DST_SPEC_CCODESUP[VDF_DST_SPEC_NUM_C_CODE_REG][VDF_DEST_NUM_LAW_DESTID] = {
     /* DESTID0001                       DESTID0002                       DESTID0014                       DESTID0017                       DESTID0018                       DESTID0020                        DESTID0021                       DESTID0022                         DESTID0023                          DESTID0024                      DESTID0025                         DESTID0026                         DESTID0027                         DESTID0028                        DESTID0029                      */
    {&u1_CALIB_MCUID0933_FUECO_UNIT_1  , &u1_CALIB_MCUID0943_UNIT_SW_1  , &u1_CALIB_MCUID0953_BUZ_REV_1  , &u1_CALIB_MCUID0963_BUZ_GSO_1  , &u1_CALIB_MCUID0973_BUZ_AIS_1  , &u1_CALIB_MCUID1093_BUZ_BELT_1  , &u1_CALIB_MCUID0993_SP_UNIT_1  , &u1_CALIB_MCUID1003_SPUN_MSSW_1  , &u1_CALIB_MCUID1013_SUB_SP_DIS_1  , &u1_CALIB_MCUID1023_SP_TOL_1  , &u1_CALIB_MCUID1033_CH_REG_GB_1  , &u1_CALIB_MCUID1043_FMV_BRATT_1  , &u1_CALIB_MCUID1053_FMV_ABSTT_1  , &u1_CALIB_MCUID1063_FMV_EPTT_1  , &u1_CALIB_MCUID1073_FMV_THTT_1  },
    {&u1_CALIB_MCUID0934_FUECO_UNIT_2  , &u1_CALIB_MCUID0944_UNIT_SW_2  , &u1_CALIB_MCUID0954_BUZ_REV_2  , &u1_CALIB_MCUID0964_BUZ_GSO_2  , &u1_CALIB_MCUID0974_BUZ_AIS_2  , &u1_CALIB_MCUID1094_BUZ_BELT_2  , &u1_CALIB_MCUID0994_SP_UNIT_2  , &u1_CALIB_MCUID1004_SPUN_MSSW_2  , &u1_CALIB_MCUID1014_SUB_SP_DIS_2  , &u1_CALIB_MCUID1024_SP_TOL_2  , &u1_CALIB_MCUID1034_CH_REG_GB_2  , &u1_CALIB_MCUID1044_FMV_BRATT_2  , &u1_CALIB_MCUID1054_FMV_ABSTT_2  , &u1_CALIB_MCUID1064_FMV_EPTT_2  , &u1_CALIB_MCUID1074_FMV_THTT_2  },
    {&u1_CALIB_MCUID0935_FUECO_UNIT_3  , &u1_CALIB_MCUID0945_UNIT_SW_3  , &u1_CALIB_MCUID0955_BUZ_REV_3  , &u1_CALIB_MCUID0965_BUZ_GSO_3  , &u1_CALIB_MCUID0975_BUZ_AIS_3  , &u1_CALIB_MCUID1095_BUZ_BELT_3  , &u1_CALIB_MCUID0995_SP_UNIT_3  , &u1_CALIB_MCUID1005_SPUN_MSSW_3  , &u1_CALIB_MCUID1015_SUB_SP_DIS_3  , &u1_CALIB_MCUID1025_SP_TOL_3  , &u1_CALIB_MCUID1035_CH_REG_GB_3  , &u1_CALIB_MCUID1045_FMV_BRATT_3  , &u1_CALIB_MCUID1055_FMV_ABSTT_3  , &u1_CALIB_MCUID1065_FMV_EPTT_3  , &u1_CALIB_MCUID1075_FMV_THTT_3  },
    {&u1_CALIB_MCUID0936_FUECO_UNIT_4  , &u1_CALIB_MCUID0946_UNIT_SW_4  , &u1_CALIB_MCUID0956_BUZ_REV_4  , &u1_CALIB_MCUID0966_BUZ_GSO_4  , &u1_CALIB_MCUID0976_BUZ_AIS_4  , &u1_CALIB_MCUID1096_BUZ_BELT_4  , &u1_CALIB_MCUID0996_SP_UNIT_4  , &u1_CALIB_MCUID1006_SPUN_MSSW_4  , &u1_CALIB_MCUID1016_SUB_SP_DIS_4  , &u1_CALIB_MCUID1026_SP_TOL_4  , &u1_CALIB_MCUID1036_CH_REG_GB_4  , &u1_CALIB_MCUID1046_FMV_BRATT_4  , &u1_CALIB_MCUID1056_FMV_ABSTT_4  , &u1_CALIB_MCUID1066_FMV_EPTT_4  , &u1_CALIB_MCUID1076_FMV_THTT_4  },
    {&u1_CALIB_MCUID0937_FUECO_UNIT_5  , &u1_CALIB_MCUID0947_UNIT_SW_5  , &u1_CALIB_MCUID0957_BUZ_REV_5  , &u1_CALIB_MCUID0967_BUZ_GSO_5  , &u1_CALIB_MCUID0977_BUZ_AIS_5  , &u1_CALIB_MCUID1097_BUZ_BELT_5  , &u1_CALIB_MCUID0997_SP_UNIT_5  , &u1_CALIB_MCUID1007_SPUN_MSSW_5  , &u1_CALIB_MCUID1017_SUB_SP_DIS_5  , &u1_CALIB_MCUID1027_SP_TOL_5  , &u1_CALIB_MCUID1037_CH_REG_GB_5  , &u1_CALIB_MCUID1047_FMV_BRATT_5  , &u1_CALIB_MCUID1057_FMV_ABSTT_5  , &u1_CALIB_MCUID1067_FMV_EPTT_5  , &u1_CALIB_MCUID1077_FMV_THTT_5  },
    {&u1_CALIB_MCUID0938_FUECO_UNIT_6  , &u1_CALIB_MCUID0948_UNIT_SW_6  , &u1_CALIB_MCUID0958_BUZ_REV_6  , &u1_CALIB_MCUID0968_BUZ_GSO_6  , &u1_CALIB_MCUID0978_BUZ_AIS_6  , &u1_CALIB_MCUID1098_BUZ_BELT_6  , &u1_CALIB_MCUID0998_SP_UNIT_6  , &u1_CALIB_MCUID1008_SPUN_MSSW_6  , &u1_CALIB_MCUID1018_SUB_SP_DIS_6  , &u1_CALIB_MCUID1028_SP_TOL_6  , &u1_CALIB_MCUID1038_CH_REG_GB_6  , &u1_CALIB_MCUID1048_FMV_BRATT_6  , &u1_CALIB_MCUID1058_FMV_ABSTT_6  , &u1_CALIB_MCUID1068_FMV_EPTT_6  , &u1_CALIB_MCUID1078_FMV_THTT_6  },
    {&u1_CALIB_MCUID0939_FUECO_UNIT_7  , &u1_CALIB_MCUID0949_UNIT_SW_7  , &u1_CALIB_MCUID0959_BUZ_REV_7  , &u1_CALIB_MCUID0969_BUZ_GSO_7  , &u1_CALIB_MCUID0979_BUZ_AIS_7  , &u1_CALIB_MCUID1099_BUZ_BELT_7  , &u1_CALIB_MCUID0999_SP_UNIT_7  , &u1_CALIB_MCUID1009_SPUN_MSSW_7  , &u1_CALIB_MCUID1019_SUB_SP_DIS_7  , &u1_CALIB_MCUID1029_SP_TOL_7  , &u1_CALIB_MCUID1039_CH_REG_GB_7  , &u1_CALIB_MCUID1049_FMV_BRATT_7  , &u1_CALIB_MCUID1059_FMV_ABSTT_7  , &u1_CALIB_MCUID1069_FMV_EPTT_7  , &u1_CALIB_MCUID1079_FMV_THTT_7  },
    {&u1_CALIB_MCUID0940_FUECO_UNIT_8  , &u1_CALIB_MCUID0950_UNIT_SW_8  , &u1_CALIB_MCUID0960_BUZ_REV_8  , &u1_CALIB_MCUID0970_BUZ_GSO_8  , &u1_CALIB_MCUID0980_BUZ_AIS_8  , &u1_CALIB_MCUID1100_BUZ_BELT_8  , &u1_CALIB_MCUID1000_SP_UNIT_8  , &u1_CALIB_MCUID1010_SPUN_MSSW_8  , &u1_CALIB_MCUID1020_SUB_SP_DIS_8  , &u1_CALIB_MCUID1030_SP_TOL_8  , &u1_CALIB_MCUID1040_CH_REG_GB_8  , &u1_CALIB_MCUID1050_FMV_BRATT_8  , &u1_CALIB_MCUID1060_FMV_ABSTT_8  , &u1_CALIB_MCUID1070_FMV_EPTT_8  , &u1_CALIB_MCUID1080_FMV_THTT_8  },
    {&u1_CALIB_MCUID0941_FUECO_UNIT_9  , &u1_CALIB_MCUID0951_UNIT_SW_9  , &u1_CALIB_MCUID0961_BUZ_REV_9  , &u1_CALIB_MCUID0971_BUZ_GSO_9  , &u1_CALIB_MCUID0981_BUZ_AIS_9  , &u1_CALIB_MCUID1101_BUZ_BELT_9  , &u1_CALIB_MCUID1001_SP_UNIT_9  , &u1_CALIB_MCUID1011_SPUN_MSSW_9  , &u1_CALIB_MCUID1021_SUB_SP_DIS_9  , &u1_CALIB_MCUID1031_SP_TOL_9  , &u1_CALIB_MCUID1041_CH_REG_GB_9  , &u1_CALIB_MCUID1051_FMV_BRATT_9  , &u1_CALIB_MCUID1061_FMV_ABSTT_9  , &u1_CALIB_MCUID1071_FMV_EPTT_9  , &u1_CALIB_MCUID1081_FMV_THTT_9  },
    {&u1_CALIB_MCUID0942_FUECO_UNIT_10 , &u1_CALIB_MCUID0952_UNIT_SW_10 , &u1_CALIB_MCUID0962_BUZ_REV_10 , &u1_CALIB_MCUID0972_BUZ_GSO_10 , &u1_CALIB_MCUID0982_BUZ_AIS_10 , &u1_CALIB_MCUID1102_BUZ_BELT_10 , &u1_CALIB_MCUID1002_SP_UNIT_10 , &u1_CALIB_MCUID1012_SPUN_MSSW_10 , &u1_CALIB_MCUID1022_SUB_SP_DIS_10 , &u1_CALIB_MCUID1032_SP_TOL_10 , &u1_CALIB_MCUID1042_CH_REG_GB_10 , &u1_CALIB_MCUID1052_FMV_BRATT_10 , &u1_CALIB_MCUID1062_FMV_ABSTT_10 , &u1_CALIB_MCUID1072_FMV_EPTT_10 , &u1_CALIB_MCUID1082_FMV_THTT_10 }
};

static const U1    u1_sp2_VDF_DST_LAW_CCODESUP[VDF_DST_LAW_NUM_C_CODE_REG][VDF_DEST_LAW_DBF_NBYTE] = {
     /* DEFUNIT_SPD               DEFUNIT_DST              DEFUNIT_ELECO                  UNITSLCT_DEST           BZ_SBW_SUP            MDLEST_WRN   INDSDBZR                SEATBLT_CONST               SUBDIGSPD                SPDTLRNC                   CHN_REQ     TTBRAKE               TTABS               TTEPBPKB                TTTAILHEAD                     */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_NA  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1136 , (U1)VDF_SUBDIGSPD_KMPH , (U1)VDF_SPDTLRNC_USA_CAN , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Canada            */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KMPKWH    , (U1)VDF_UNIT_TYPE_JPN , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0606 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Rep of Korea_UNR  */
      { (U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH  , (U1)VDF_UNIT_TYPE_UK  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_MPH  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* United Kingdom    */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_NA  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0604 , (U1)VDF_SUBDIGSPD_BOTH , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Mexico_UNR        */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* South Africa      */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_WITH , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* India             */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0607 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)TRUE  , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* China             */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)TRUE   , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1136 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Bahrain           */
      ...
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)TRUE   , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1136 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* UAE               */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)TRUE   , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1136 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Saudi Arabia      */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)TRUE   , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1136 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Oman              */
      ...
      { (U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH  , (U1)VDF_UNIT_TYPE_NA  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0606 , (U1)VDF_SUBDIGSPD_MPH  , (U1)VDF_SPDTLRNC_USA_CAN , (U1)FALSE , (U1)VDF_TTBRAKE_NO4 , (U1)VDF_TTABS_NO6 , (U1)VDF_TTEPBPKB_NO10 , (U1)VDF_TTTAILHEAD_NO12 },      /* Rep of Korea_FMVSS*/
      { (U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH  , (U1)VDF_UNIT_TYPE_NA  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0604 , (U1)VDF_SUBDIGSPD_BOTH , (U1)VDF_SPDTLRNC_USA_CAN , (U1)FALSE , (U1)VDF_TTBRAKE_NO4 , (U1)VDF_TTABS_NO6 , (U1)VDF_TTEPBPKB_NO10 , (U1)VDF_TTTAILHEAD_NO12 }       /* Mexico_FMVSS      */
};

static const U1    u1_sp2_VDF_DST_CCODESUP[VDF_DST_NUM_C_CODE][VDF_DEST_DBF_NBYTE] = {
     /* DESTINATION              TIMEFMT               TTTRCOFF                 UNIT_AMBTMP                    */
      { (U1)VDF_DEST_CAN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO155 , (U1)UNIT_VAL_AMBTMP_CEL },      /* Canada            */
      { (U1)VDF_DEST_KOR       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Rep of Korea      */
      { (U1)VDF_DEST_UK        , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* United Kingdom    */
      { (U1)VDF_DEST_MEX       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO155 , (U1)UNIT_VAL_AMBTMP_CEL },      /* Mexico            */
      { (U1)VDF_DEST_ZAF       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* South Africa      */
      { (U1)VDF_DEST_IND       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* India             */
      { (U1)VDF_DEST_CHN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* China             */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Bahrain           */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Qatar             */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Kuwait            */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* UAE               */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Saudi Arabia      */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Oman              */
      { (U1)VDF_DEST_HKGMACSGP , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Hong Kong         */
      { (U1)VDF_DEST_HKGMACSGP , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Macau             */
      { (U1)VDF_DEST_AUST      , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Australia         */
      { (U1)VDF_DEST_AUST      , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Papua New Guinea  */
      { (U1)VDF_DEST_AUST      , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* New Zealand       */
      { (U1)VDF_DEST_AUST      , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Solomon Islands   */
      { (U1)VDF_DEST_TWN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Taiwan            */
      { (U1)VDF_DEST_HKGMACSGP , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL }       /* Singapore         */
};

static const U1    u1_sp2_VDF_DST_LAW_DESTBDBSUP[VDF_DST_LAW_NUM_DEST_BDB_REG][VDF_DEST_LAW_DBF_NBYTE] = {
     /* DEFUNIT_SPD               DEFUNIT_DST              DEFUNIT_ELECO                  UNITSLCT_DEST           BZ_SBW_SUP            MDLEST_WRN   INDSDBZR                SEATBLT_CONST               SUBDIGSPD                SPDTLRNC                   CHN_REQ     TTBRAKE               TTABS               TTEPBPKB                TTTAILHEAD                     */
      { (U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH  , (U1)VDF_UNIT_TYPE_NA  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1135 , (U1)VDF_SUBDIGSPD_MPH  , (U1)VDF_SPDTLRNC_USA_CAN , (U1)FALSE , (U1)VDF_TTBRAKE_NO4 , (U1)VDF_TTABS_NO6 , (U1)VDF_TTEPBPKB_NO10 , (U1)VDF_TTTAILHEAD_NO12 },      /* America           */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_UK  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_KMPH , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Turkey            */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0607 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)TRUE  , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* China             */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* South Africa      */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Australia         */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)TRUE   , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID1136 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* MDE               */
      ...
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM , (U1)VDF_UNIT_TYPE_EU  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* New Zealand       */
      { (U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KMPKWH    , (U1)VDF_UNIT_TYPE_JPN , (U1)VDF_BZ_SBW_NON  , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_NON  , (U1)VDF_SPDTLRNC_UNR_AUS , (U1)FALSE , (U1)VDF_TTBRAKE_NO3 , (U1)VDF_TTABS_NO7 , (U1)VDF_TTEPBPKB_NO9  , (U1)VDF_TTTAILHEAD_NO11 },      /* Japan             */
      ...
      { (U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH  , (U1)VDF_UNIT_TYPE_NA  , (U1)VDF_BZ_SBW_WITH , (U1)FALSE  , (U1)VDF_INDSDBZR_NON  , (U1)VDF_SEATBLT_MCUID0605 , (U1)VDF_SUBDIGSPD_MPH  , (U1)VDF_SPDTLRNC_USA_CAN , (U1)FALSE , (U1)VDF_TTBRAKE_NO4 , (U1)VDF_TTABS_NO6 , (U1)VDF_TTEPBPKB_NO10 , (U1)VDF_TTTAILHEAD_NO12 }       /* GNR_FMVSS         */
};

static const U1    u1_sp2_VDF_DST_DESTBDBSUP[VDF_DST_NUM_DEST_BDB][VDF_DEST_DBF_NBYTE] = {
     /* DESTINATION              TIMEFMT               TTTRCOFF                 UNIT_AMBTMP                    */
      { (U1)VDF_DEST_USA       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO155 , (U1)UNIT_VAL_AMBTMP_FAH },      /* America           */
      { (U1)VDF_DEST_EU        , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Turkey            */
      { (U1)VDF_DEST_CHN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* China             */
      { (U1)VDF_DEST_ZAF       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* South Africa      */
      { (U1)VDF_DEST_AUST      , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Australia         */
      { (U1)VDF_DEST_MDLEST    , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* MDE               */
      { (U1)VDF_DEST_EU        , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Europe            */
      { (U1)VDF_DEST_EU        , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Russia            */
      { (U1)VDF_DEST_AUST      , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* New Zealand       */
      { (U1)VDF_DEST_JPN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* Japan             */
      { (U1)VDF_DEST_GEN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL },      /* GNR_L             */
      { (U1)VDF_DEST_GEN       , (U1)TIMEFMT_VAL_12H , (U1)VDF_TTTRCOFF_NO8   , (U1)UNIT_VAL_AMBTMP_CEL }       /* GNR_R             */
};

static const U1    u1_sp_VDF_DST_SPEC_DESTID[VDF_NUM_UNIT_DEF_CFG][VDF_DEST_SPEC_LAW_DESTID] = {
    /*  DEFUNIT_SPD            DEFUNIT_DST              DEFUNIT_ELECO               */
    {(U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH },
    {(U1)UNIT_VAL_SPEED_MPH  , (U1)UNIT_VAL_DIST_MILE , (U1)UNIT_VAL_ELECO_MILEPKWH },
    {(U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KMPKWH   },
    {(U1)UNIT_VAL_SPEED_KMPH , (U1)UNIT_VAL_DIST_KM   , (U1)UNIT_VAL_ELECO_KWHP100KM}
};
...
/*  BEV-6     3/17/2026  PG       Change config for BEV FF2(MET-M_DESTVARI-CSTD-0-02)                                                */
/*                                Delete u1_g_VardefCfgUnitType                                                                      */
/*                                                                                                                                   */
