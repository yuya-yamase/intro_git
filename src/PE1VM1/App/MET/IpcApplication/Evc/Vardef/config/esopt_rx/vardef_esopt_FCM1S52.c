...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_FCM1S52_C_MAJOR             (2)
#define VARDEF_ESOPT_FCM1S52_C_MINOR             (6)
#define VARDEF_ESOPT_FCM1S52_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_FCM1S52_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_FCM1S52_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_FCM1S52_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_FCM1S52.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_AHB(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_AHBEXIST, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
...
U1      u1_g_VdfEsoRx_SW_PDASA(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_SDGEXIST, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
U1      u1_g_VdfEsoRx_SW_PDADA(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_USMEXIST, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
U1      u1_g_VdfEsoRx_SW_PDAOAA(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_PDAEXIST, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
U1      u1_g_VdfEsoRx_DMC(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_DMCEXIST, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
U1      u1_g_VdfEsoRx_EDSS(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_EDSSEXST, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
U1      u1_g_VdfEsoRx_CC(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_CCEX, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
U1      u1_g_VdfEsoRx_ERM(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_ACCERMEX, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
