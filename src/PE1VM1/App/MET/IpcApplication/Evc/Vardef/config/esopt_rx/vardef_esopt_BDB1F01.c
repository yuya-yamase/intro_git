...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_BDB1F01_C_MAJOR             (2)
#define VARDEF_ESOPT_BDB1F01_C_MINOR             (5)
#define VARDEF_ESOPT_BDB1F01_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_BDB1F01_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_BDB1F01_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_BDB1F01_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_BDB1F01.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_SW_THESEN(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_INT_EQ, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
...
/*  117D-1    8/25/2022  MG       Change config for 117D 1A                                                                          */
/*  19PFv3-1  1/31/2024  SW       Add source file for 19PFv3                                                                         */
/*                                                                                                                                   */
