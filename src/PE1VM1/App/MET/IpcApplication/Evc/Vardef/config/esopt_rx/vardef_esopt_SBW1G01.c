...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_SBW1G01_C_MAJOR             (2)
#define VARDEF_ESOPT_SBW1G01_C_MINOR             (5)
#define VARDEF_ESOPT_SBW1G01_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_SBW1G01_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_SBW1G01_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_SBW1G01_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_SBW1G01.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_SBW(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_SBWFUNC, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
