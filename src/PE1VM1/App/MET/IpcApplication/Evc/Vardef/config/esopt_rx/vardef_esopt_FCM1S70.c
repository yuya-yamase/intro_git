...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_FCM1S70_C_MAJOR             (2)
#define VARDEF_ESOPT_FCM1S70_C_MINOR             (6)
#define VARDEF_ESOPT_FCM1S70_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_FCM1S70_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_FCM1S70_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_FCM1S70_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_FCM1S70.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_SW_SRPCUS(void)
{
    ...
    u1_t_rx     = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_SRP_PRE, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
...
/* --------- ----------  -------  -------------------------------------------------------------------------------------------------- */
/*  19PFv3-1 10/11/2023  KH       Change config for 19PFv3 CV                                                                        */
/*  19PFv3-2  3/ 1/2024  RO       Change config for 19PFv3 CV                                                                        */
/*  19PFv3-3  4/08/2024  SN       Change config for 19PFv3 CV(add function for AHSSWVEX,AHSSDEEX)                                    */
/*                                                                                                                                   */
