...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_AVNMC08_C_MAJOR             (2)
#define VARDEF_ESOPT_AVNMC08_C_MINOR             (6)
#define VARDEF_ESOPT_AVNMC08_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_AVNMC08_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_AVNMC08_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_AVNMC08_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_AVNMC08.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_AISMM(void)
{
    ...
    (void)Com_ReceiveSignal(ComConf_ComSignal_L_MMCKPT, &u1_t_rx);
#endif
    if(u1_t_rx != (U1)0U){
