...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_BCC1S06_C_MAJOR             (2)
#define VARDEF_ESOPT_BCC1S06_C_MINOR             (6)
#define VARDEF_ESOPT_BCC1S06_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_BCC1S06_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_BCC1S06_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_BCC1S06_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_BCC1S06.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
