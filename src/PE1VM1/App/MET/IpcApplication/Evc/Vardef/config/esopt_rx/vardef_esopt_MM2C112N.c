...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_MM2C112N_C_MAJOR             (2)
#define VARDEF_ESOPT_MM2C112N_C_MINOR             (4)
#define VARDEF_ESOPT_MM2C112N_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_MM2C112N_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_MM2C112N_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_MM2C112N_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_MM2C112N.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_ETH_NAVI_TAB(void)
{
    ...
    u1_t_rx = (U1)0U;
    vd_g_HmiVardefRecieveSig((U1)HMIVARDEF_SIG_NAVFUNC, &u1_t_rx);
...
U1      u1_g_VdfEsoRx_ETH_NAVI(void)
{
    ...
    if(u1_t_sts == (U1)VDF_MM_MTHD_ETHER){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
        u1_t_ava_rx  = (U1)VDF_ESO_AVA_RX_UNK;
...
/* --------- ----------  -------  -------------------------------------------------------------------------------------------------- */
/*  800B-1   12/03/2020  SF       Change config for 800B 1A                                                                          */
