...
#define VARDEF_ESOPT_GVIF_C_MINOR                (4)
...
U1      u1_g_VdfEsoRx_GVIF_MM(void)
{
    ...
    u1_t_sts = u1_g_LcomSpiGvifSts_MM();

    if(u1_t_sts == (U1)LCOM_SPI_GVIF_MM_NML){
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_ACT;
    }
    else{
        u1_t_ava_rx = (U1)VDF_ESO_AVA_RX_UNK;
...
/*  19PFv3-2 11/04/2024  SI       Add MM-GVIF detect function                                                                        */
/*                                                                                                                                   */
