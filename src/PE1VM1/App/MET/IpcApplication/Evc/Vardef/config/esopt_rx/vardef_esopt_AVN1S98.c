...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_AVN1S98_C_MAJOR             (2)
#define VARDEF_ESOPT_AVN1S98_C_MINOR             (4)
#define VARDEF_ESOPT_AVN1S98_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_AVN1S98_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_AVN1S98_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_AVN1S98_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_AVN1S98.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
U1      u1_g_VdfEsoRx_SW_PERSET(void)
{
    ...
    u1_t_rx = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_UI_DEPLY, &u1_t_rx);
    if(u1_t_rx != (U1)0U){
