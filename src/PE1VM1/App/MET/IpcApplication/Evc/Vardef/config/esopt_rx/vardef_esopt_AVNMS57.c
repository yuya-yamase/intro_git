...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VARDEF_ESOPT_AVNMS57_C_MAJOR             (2)
#define VARDEF_ESOPT_AVNMS57_C_MINOR             (5)
#define VARDEF_ESOPT_AVNMS57_C_PATCH             (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((VARDEF_ESOPT_AVNMS57_C_MAJOR != VARDEF_ESOPT_RX_H_MAJOR) || \
     (VARDEF_ESOPT_AVNMS57_C_MINOR != VARDEF_ESOPT_RX_H_MINOR) || \
     (VARDEF_ESOPT_AVNMS57_C_PATCH != VARDEF_ESOPT_RX_H_PATCH))
#error "vardef_esopt_AVNMS57.c and vardef_esopt_rx.h : source and header files are inconsistent!"
#endif
...
/* --------- ----------  -------  -------------------------------------------------------------------------------------------------- */
/*  800B-1   12/03/2020  SF       Change config for 1A                                                                               */
