...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define ALERT_S_ADBZR_ACC_C_MAJOR                      (5)
#define ALERT_S_ADBZR_ACC_C_MINOR                      (8)
#define ALERT_S_ADBZR_ACC_C_PATCH                      (1)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if (ALERT_S_ADBZR_ACC_C_MAJOR != ALERT_CFG_H_MAJOR)
#error "alert_S_ADBZR_ACC.c and alert_cfg_private.h : source and header files are inconsistent!"
#endif

/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*  Literal Definitions                                                                                                              */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define ALERT_S_ADBZR_ACC_NUM_DST                (64U)
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
static U4      u4_s_AlertS_adbzr_accSrcchk   (const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS);

/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*  Constant Definitions                                                                                                             */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
static const U1  u1_sp_ALERT_S_ADBZR_ACC_DST[ALERT_S_ADBZR_ACC_NUM_DST] = {
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 00 UNKNOWN                                         */
    (U1)ALERT_REQ_S_ADBZR_ACC_WARN,                                            /* 01 WARN                                            */
    (U1)ALERT_REQ_S_ADBZR_ACC_CANCEL,                                          /* 02 CANCEL                                          */
    (U1)ALERT_REQ_S_ADBZR_ACC_REQ_BRK,                                         /* 03 REQ_BRK                                         */
    (U1)ALERT_REQ_S_ADBZR_ACC_OVER_SPD,                                        /* 04 OVER_SPD                                        */
    (U1)ALERT_REQ_S_ADBZR_ACC_START_APRV,                                      /* 05 START_APRV                                      */
    (U1)ALERT_REQ_S_ADBZR_ACC_START,                                           /* 06 START                                           */
    (U1)ALERT_REQ_S_ADBZR_ACC_REQ_OPE,                                         /* 07 REQ_OPE                                         */
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
const ST_ALERT_MTRX st_gp_ALERT_S_ADBZR_ACC_MTRX[1] = {
    {
        &u4_s_AlertS_adbzr_accSrcchk,                                          /* fp_u4_SRC_CHK                                      */
        vdp_PTR_NA,                                                            /* fp_vd_XDST                                         */

        (const U4 *)vdp_PTR_NA,                                                /* u4p_MASK                                           */
        (const U4 *)vdp_PTR_NA,                                                /* u4p_CRIT                                           */

        &u1_sp_ALERT_S_ADBZR_ACC_DST[0],                                       /* u1p_DST                                            */
        (U2)ALERT_S_ADBZR_ACC_NUM_DST,                                         /* u2_num_srch                                        */
...
/*  5.8.1    12/17/2025  EA       Change for BEV System_Consideration_2.(MET-S_ADBZR-CSTD-0-06-A-C0)                                 */
/*                                                                                                                                   */
/*  * RI   = Ren Ito, NTTD MSE                                                                                                       */
