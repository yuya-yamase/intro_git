...
static U4      u4_s_AlertC_tpmsTtSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_PDU_RX_CAN_TPM1S02) && defined(ComConf_ComSignal_TPM_IND)
    ...
    u1_t_msgsts   = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_TPM1S02,
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_PDU_RX_CAN_TPM1S02) && defined(ComConf_ComSignal_TPM_IND) */
}
...
static U4      u4_s_AlertC_tpmsBcSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_PDU_RX_CAN_TPM1S02) && defined(ComConf_ComSignal_TPM_BZR)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_PDU_RX_CAN_TPM1S02) && defined(ComConf_ComSignal_TPM_BZR) */
}
...
static U4      u4_s_AlertC_tpmsPdSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if (defined(OXCAN_PDU_RX_CAN_TPM1S02) && defined(ComConf_ComSignal_TPM_DISP)) && (defined(OXCAN_PDU_RX_CAN_TPM1S03) && defined(ComConf_ComSignal_TPM_REQ0))
    ...
    u1_t_tpm1s02_sts = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_TPM1S02,
                                        (U2)OXCAN_RX_SYS_NRX_IGR | (U2)OXCAN_RX_SYS_TOE_IGR,
    ...
    u1_t_tpm1s03_sts = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_TPM1S03,
                                        (U2)OXCAN_RX_SYS_NRX_IGR | (U2)OXCAN_RX_SYS_TOE_IGR,
                                        (U2)U2_MAX) & (U1)COM_NO_RX;
...
#else
    return((U4)0U);
#endif /* (defined(OXCAN_PDU_RX_CAN_TPM1S02) && defined(ComConf_ComSignal_TPM_DISP)) &&
          (defined(OXCAN_PDU_RX_CAN_TPM1S03) && defined(ComConf_ComSignal_TPM_REQ0)) */
}
