...
static U4      u4_s_AlertH_towwarSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_PDU_RX_CAN_EHV1S94_RXCH0) && defined(ComConf_ComSignal_TOWW)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_PDU_RX_CAN_EHV1S94_RXCH0) && defined(ComConf_ComSignal_TOWW) */
}
...
#if 0   /* BEV BSW provisionally */
    (void)Com_SendSignal(ComConf_ComSignal_PULW, &u1_t_sgnl);    /* COM Tx STUB delete */
#endif
}
