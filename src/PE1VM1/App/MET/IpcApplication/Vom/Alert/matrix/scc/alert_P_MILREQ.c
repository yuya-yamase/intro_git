...
#define ALERT_P_MILREQ_C_MINOR                   (2)
...
static U4      u4_s_AlertP_milreqSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
    ...
    u1_t_msgsts   = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_ENG1F07,
...
static void    vd_s_AlertP_milreqRwTx(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_DST)
{
    ...
    u1_t_esopt = u1_g_AlertEsOptAvailable((U2)ALERT_OPT_ID_P_MILREQ_PTSYS);
...
/*  5.2.0     1/ 9/2025  KH       Fix vd_s_AlertP_milreqRwTx to add function presence.                                               */
/*                                                                                                                                   */
