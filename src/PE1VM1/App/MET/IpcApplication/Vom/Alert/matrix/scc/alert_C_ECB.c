...
static void    vd_s_AlertC_ecbRwTx(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_DST)
{
    ...
    static const U4 u4_s_ALERT_C_ECB_RWTX_OPT = ((U4)((U4)1U << ALERT_REQ_C_ECB_FDISP_RW     )
    ...
    u1_t_esopt = u1_g_AlertEsOptAvailable((U2)ALERT_OPT_ID_C_ECB_ECBEXIST);

    if(((u1_a_VOM & (U1)ALERT_VOM_RWT_EN)      != (U1)0U) &&
       ((u4_t_rw  & u4_s_ALERT_C_ECB_RWTX_CRT) != (U4)0U)){
        u1_t_sgnl = (U1)ALERT_RW_SGNL_ON;
    }
    else if(((u1_a_VOM & (U1)ALERT_VOM_RWT_EN)      != (U1)0U  ) &&
            ((u4_t_rw  & u4_s_ALERT_C_ECB_RWTX_OPT) != (U4)0U  ) &&
            (u1_t_esopt                             == (U1)TRUE)){
        u1_t_sgnl = (U1)ALERT_RW_SGNL_ON;
    }
    else{
...
/*  5.5.0     1/ 9/2025  KH       Fix vd_s_AlertC_ecbRwTx to add function presence.                                                  */
/*                                                                                                                                   */
