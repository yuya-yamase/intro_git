...
#define ALERT_H_XMODE_C_MINOR                    (1)
...
#define ALERT_H_XMODE_TT_NUM_DST                 (64U)
...
static const U1  u1_sp_ALERT_H_XMODE_TT_DST[ALERT_H_XMODE_TT_NUM_DST] = {
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 00 UNKNOWN                                         */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 01 UNKNOWN                                         */
    (U1)ALERT_REQ_H_XMODE_TT_SNWDRT,                                           /* 02 SNWDRT                                          */
    (U1)ALERT_REQ_H_XMODE_TT_DSNWMUD,                                          /* 03 DSNWMUD                                         */
    (U1)ALERT_REQ_H_XMODE_TT_SNWDRT_CNL,                                       /* 04 SNWDRT_CNL                                      */
    (U1)ALERT_REQ_H_XMODE_TT_DSNWMUD_CNL,                                      /* 05 DSNWMUD_CNL                                     */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 06 UNKNOWN                                         */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 07 UNKNOWN                                         */
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
const ST_ALERT_MTRX st_gp_ALERT_H_XMODE_MTRX[3] = {
    {
    ...
    {
        &u4_s_AlertH_xmodeTtSrcchk,                                            /* fp_u4_SRC_CHK                                      */
        vdp_PTR_NA,                                                            /* fp_vd_XDST                                         */

        (const U4*)vdp_PTR_NA,                                                 /* u4p_MASK                                           */
        (const U4*)vdp_PTR_NA,                                                 /* u4p_CRIT                                           */

        &u1_sp_ALERT_H_XMODE_TT_DST[0],                                        /* u1p_DST                                            */
        (U2)ALERT_H_XMODE_TT_NUM_DST,                                          /* u2_num_srch                                        */
        (U1)ALERT_VOM_IGN_ON                                                   /* u1_vom_act                                         */
    }
};
...
static U4      u4_s_AlertH_xmodeTtSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
    ...
    u1_t_msgsts = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_EHV1E00,
                                   ...
                                   u2_s_ALERT_H_XMODE_TT_TO_TRESH) & ((U1)COM_TIMEOUT | (U1)COM_NO_RX);

    u1_t_sgnl = (U1)0U;
    (void)Com_ReceiveSignal(ComConf_ComSignal_B_XMODE, &u1_t_sgnl);
    u4_t_src_chk = (U4)u1_t_sgnl;
...
/*  5.1.0    08/27/2024  JMH      Update for 19PFv3 R2                                                                               */
/*                                                                                                                                   */
/*  * RO   = Ryo Oohashi, KSE                                                                                                        */
