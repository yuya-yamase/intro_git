...
#define ALERT_HW_ID_P_OILLEV_OIL_W               (U2_MAX)
#define ALERT_HW_ID_P_OILPRE_OP_SW               (U2_MAX)
...
#define ALERT_C_DRIMOD_CH_NUM                    (2U)
...
#define ALERT_P_OILMIL_CH_NUM                    (2U)
...
#define ALERT_C_CRAWL_CH_NUM                     (2U)
#define ALERT_C_MTS_CH_NUM                       (2U)
#define ALERT_H_BATTRW_CH_NUM                    (2U)
...
extern const ST_ALERT_MTRX         st_gp_ALERT_C_CRAWL_MTRX[ALERT_C_CRAWL_CH_NUM];
extern const ST_ALERT_MTRX         st_gp_ALERT_C_MTS_MTRX[ALERT_C_MTS_CH_NUM];
