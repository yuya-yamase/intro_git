...
static U4      u4_s_AlertH_reasysTtSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_RXD_PDU_CAN_ECT1S93_CH0) && defined(ComConf_ComSignal_DRDYSTS)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_RXD_PDU_CAN_ECT1S93_CH0) && defined(ComConf_ComSignal_DRDYSTS) */
}
...
static U4      u4_s_AlertH_reasysBcSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_RXD_PDU_CAN_ECT1S93_CH0) && defined(ComConf_ComSignal_DRDYB)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_RXD_PDU_CAN_ECT1S93_CH0) && defined(ComConf_ComSignal_DRDYB) */
}
