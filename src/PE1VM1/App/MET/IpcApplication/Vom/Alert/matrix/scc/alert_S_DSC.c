...
static U4      u4_s_AlertS_dscSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_PDU_RX_CAN_ENG1G92_RXCH0) || defined(OXCAN_PDU_RX_CAN_ENG1S92)
#ifdef OXCAN_PDU_RX_CAN_ENG1G92_RXCH0
...
#endif /* OXCAN_PDU_RX_CAN_ENG1G92_RXCH0 */
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_PDU_RX_CAN_ENG1G92_RXCH0) || defined(OXCAN_PDU_RX_CAN_ENG1S92) */
...
#if 0   /* BEV BSW provisionally */
    (void)Com_SendSignal(ComConf_ComSignal_GOSW, &u1_t_sgnl);    /* COM Tx STUB delete */
#endif
}
