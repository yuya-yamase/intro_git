...
static U4      u4_s_AlertS_dscSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_RXD_PDU_CAN_ENG1G92_CH0) || defined(OXCAN_PDU_RX_CAN_ENG1S92)
#ifdef OXCAN_RXD_PDU_CAN_ENG1G92_CH0
...
#endif /* OXCAN_RXD_PDU_CAN_ENG1G92_CH0 */
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_RXD_PDU_CAN_ENG1G92_CH0) || defined(OXCAN_PDU_RX_CAN_ENG1S92) */
