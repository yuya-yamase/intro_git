...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if (defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0) || defined(OXCAN_PDU_RX_CAN_PMN1F03)) && defined(ComConf_ComSignal_MOD_EIG) /* _235D_CAN_ */
static U1      u1_s_alert_o_eigcon_pow_msg_pmn;
#endif /* (defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0) || defined(OXCAN_PDU_RX_CAN_PMN1F03)) && defined(ComConf_ComSignal_BZRQ_EIG) */
#if (defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0) || defined(OXCAN_PDU_RX_CAN_PMN1F03)) && defined(ComConf_ComSignal_MOD_EIG) /* _235D_CAN_ */
static U1      u1_s_alert_o_eigcon_pow_msg_pdc;
#endif /* (defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0) || defined(OXCAN_PDU_RX_CAN_PMN1F03)) && defined(ComConf_ComSignal_MOD_EIG) */
...
static U4      u4_s_AlertO_eigconEngSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if (defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0) || defined(OXCAN_PDU_RX_CAN_PMN1F03)) && defined(ComConf_ComSignal_BZRQ_EIG) /* _235D_CAN_ */
...
#if defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0)
...
#else
    u1_t_msgsts   = u1_g_oXCANRxdStat((U2)OXCAN_PDU_RX_CAN_PMN1F03,
                                          (U4)OXCAN_SYS_IGR,
                                          u2_s_ALERT_O_EIGCON_ENG_TO_TRSH) & ((U1)COM_TIMEOUT | (U1)COM_NO_RX);
#endif /* defined(OXCAN_RXD_PDU_CAN_PMN1G03_CH0) */
...
static U4      u4_s_AlertO_eigconPowstsSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
    ...
    u1_t_msgsts   = u1_g_oXCANRxdStat((U2)OXCAN_RXD_PDU_CAN_PDC1G01_CH0,
                                          (U4)ALERT_CAN_SYS_PNC_ALL,
                                          u2_s_ALERT_O_EIGCON_POW_TO_TRSH) & ((U1)COM_TIMEOUT | (U1)COM_NO_RX);
