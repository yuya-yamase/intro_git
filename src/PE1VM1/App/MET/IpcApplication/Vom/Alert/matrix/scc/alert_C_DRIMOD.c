...
#define ALERT_C_DRIMOD_C_MINOR                   (3)
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
const ST_ALERT_MTRX st_gp_ALERT_C_DRIMOD_MTRX[1] = {
    {
...
static U4      u4_s_AlertC_drimodTtSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_RXD_PDU_CAN_ENG1G90_CH0) && defined(ComConf_ComSignal_B_DMODE)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_RXD_PDU_CAN_ENG1G90_CH0) && defined(ComConf_ComSignal_B_DMODE) */
}
