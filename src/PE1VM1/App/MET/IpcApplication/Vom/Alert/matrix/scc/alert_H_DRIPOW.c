...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if (ALERT_H_DRIPOW_C_MAJOR != ALERT_CFG_H_MAJOR)
#error "alert_H_DRIPOW.c and alert_cfg_private.h : source and header files are inconsistent!"
#endif
...
const ST_ALERT_MTRX st_gp_ALERT_H_DRIPOW_MTRX[1] = {
    {
        ...
        &u1_sp_ALERT_H_DRIPOW_DST[0],                                          /* u1p_DST                                            */
        (U2)ALERT_H_DRIPOW_NUM_DST,                                            /* u2_num_srch                                        */
...
static void    vd_s_AlertH_dripowRwTx(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_DST)
{
    ...
    (void)Com_SendSignal(ComConf_ComSignal_EVHW, &u1_t_sgnl);
