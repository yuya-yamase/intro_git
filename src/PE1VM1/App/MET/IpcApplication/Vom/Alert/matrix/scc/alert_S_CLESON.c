...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if defined(OXCAN_PDU_RX_CAN_CSR1S07_RXCH0)
static U1      u1_sp_alert_s_cleson_csr1s07[ALERT_S_CLESON_CI_NUM_CSR1S07];
#endif /* defined(OXCAN_PDU_RX_CAN_CSR1S07_RXCH0) */
...
static U4      u4_s_AlertS_clesonTtSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_PDU_RX_CAN_CSR1S07_RXCH0) && defined(ComConf_ComSignal_CS_LAMP)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_PDU_RX_CAN_CSR1S07_RXCH0) && defined(ComConf_ComSignal_CS_LAMP) */
}
