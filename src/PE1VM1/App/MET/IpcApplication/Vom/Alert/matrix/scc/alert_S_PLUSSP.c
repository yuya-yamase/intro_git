...
static U4      u4_s_AlertS_plusspSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
    ...
    #if (defined(OXCAN_RXD_PDU_CAN_SCN1S01_CH0) && defined(ComConf_ComSignal_DRVCLS)) /*@@@ 19pvf CANFDItem  @@@*/
    u1_t_msgsts   = u1_g_oXCANRxdStat((U2)OXCAN_RXD_PDU_CAN_SCN1S01_CH0,
                                          (U4)OXCAN_SYS_IGR,
