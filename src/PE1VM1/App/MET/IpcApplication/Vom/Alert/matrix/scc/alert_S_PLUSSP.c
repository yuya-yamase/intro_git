...
#define ALERT_S_PLUSSP_C_MINOR                   (3)
...
static U4      u4_s_AlertS_plusspSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
    ...
    #if (defined(OXCAN_PDU_RX_CAN_SCN1S01_RXCH0) && defined(ComConf_ComSignal_DRVCLS)) /*@@@ 19pvf CANFDItem  @@@*/
    u1_t_msgsts   = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_SCN1S01_RXCH0,
    ...
    #endif
    u1_t_sgnl     = (U1)0U;
#if defined(ComConf_ComSignal_DRVCLS)
    (void)Com_ReceiveSignal(ComConf_ComSignal_DRVCLS, &u1_t_sgnl);
#endif /* defined(ComConf_ComSignal_DRVCLS) */
