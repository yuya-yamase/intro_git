...
static U4      u4_s_AlertS_pksbTtSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_RXD_PDU_CAN_CSR1S04_CH0) && defined(ComConf_ComSignal_ICSLAMP)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_RXD_PDU_CAN_CSR1S04_CH0) && defined(ComConf_ComSignal_ICSLAMP) */
}
...
static U4      u4_s_AlertS_pksbPdSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
#if defined(OXCAN_RXD_PDU_CAN_CSR1S04_CH0) && defined(ComConf_ComSignal_ICSINFO)
...
#else
    return((U4)0U);
#endif /* defined(OXCAN_RXD_PDU_CAN_CSR1S04_CH0) && defined(ComConf_ComSignal_ICSINFO) */
}
