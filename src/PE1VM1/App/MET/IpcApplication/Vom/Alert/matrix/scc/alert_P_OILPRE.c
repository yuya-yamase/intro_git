...
static U4      u4_s_AlertP_oilpreWrnSrcchk(const U1 u1_a_VOM, const U4 u4_a_IGN_TM, const U1 u1_a_LAS)
{
    ...
    if((u1_a_VOM & (U1)ALERT_VOM_IGN_ON) != (U1)0U){
        ...
        u1_t_msgstspdc = u1_g_oXCANRxStat((U2)OXCAN_PDU_RX_CAN_PDC1G01,
...
#if defined(OXCAN_PDU_RX_CAN_EHV1S90) && defined(ComConf_ComSignal_MOPSINH)
...
#endif /* defined(OXCAN_PDU_RX_CAN_EHV1S90) && defined(ComConf_ComSignal_MOPSINH) */
