...
static const U1  u1_sp_ALERT_S_LTA_2_PD_DST[ALERT_S_LTA_2_PD_NUM_DST] = {
    ...
    (U1)ALERT_REQ_S_LTA_2_PD_UNAVLBL4,                                         /* 03 UNAVLBL4                                        */
    ...
    (U1)ALERT_REQ_S_LTA_2_PD_UNAVLBL5,                                         /* 07 UNAVLBL5                                        */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 08 UNKNOWN                                         */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 09 UNKNOWN                                         */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 10 UNKNOWN                                         */
    (U1)ALERT_REQ_UNKNOWN,                                                     /* 11 UNKNOWN                                         */
...
/*  5.1.0    11/08/2023  JMH      Added Parameter for MET-S_LTA-CSTD-2-02-A-C0                                                       */
/*                                - Added ALERT_REQ_S_LTA_2_PD_UNAVLBL4 (REQ13) and ALERT_REQ_S_LTA_2_PD_UNAVLBL5 (REQ14)            */
/*                                                                                                                                   */
