...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define CANTXAPP_MET1S62_C_MAJOR                     (0)
#define CANTXAPP_MET1S62_C_MINOR                     (0)
#define CANTXAPP_MET1S62_C_PATCH                     (0)
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
static U4    u4_sp_cantxapp_met1s62data[CANTXAPP_NBYTE_PAYLOAD2];

/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*  Static Function Prototypes                                                                                                       */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
static void    vd_s_CanTxAppSend_RNGMSW(void);
...
static void    vd_s_CanTxAppSend_RNGMSW(void)
{
    ...
    u1_t_tx = u1_CANTXAPP_MET_READ_BIT(u4_sp_cantxapp_met1s62data[1], (U1)CANTXAPP_POS_5_3, (U1)CANTXAPP_LEN_1);
    u1_t_pre_tx = (U1)0U;
