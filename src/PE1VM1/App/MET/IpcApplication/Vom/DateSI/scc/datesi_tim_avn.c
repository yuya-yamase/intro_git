...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define DATESI_TIM_AVN_C_MAJOR                  (3)
#define DATESI_TIM_AVN_C_MINOR                  (2)
...
/*                                Add RxHook Function                                                                                */
/*                                ADD Time adjustment SW control                                                                     */
/*                                Change GPS synchronization process                                                                 */
/*  2.1.0    10/07/2020  TN       Change CAN Tx Function                                                                             */
/*                                Change Time adjustment SW control                                                                  */
/*  2.2.0    01/08/2021  TN       ADD Clock Adjustment History                                                                       */
/*                                ADD Private Memory(Offset Time)                                                                    */
/*                                Change Code Review FB                                                                              */
/*  2.2.1    03/10/2021  TN       Fix Zero Reset prosess                                                                             */
