...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define DATESI_CAL_C_MAJOR                      (3)
#define DATESI_CAL_C_MINOR                      (2)
...
/*  1.1.0    10/07/2020  TN       Change CAN Tx Function                                                                             */
/*                                Change Time adjustment SW control                                                                  */
/*                                Change NVM rewriting condition                                                                     */
/*  1.1.1    01/08/2021  TN       Change Code Review FB                                                                              */
/*  1.1.2    03/10/2021  TN       Fix Zero Reset prosess                                                                             */
...
/* 19PFv3-2  01/11/2024  SH       Change MCUCONST guard process to set default                                                       */
/* 19PFv3-3  03/07/2024  SH       Change daycount logic                                                                              */
/* 19PFv3-4  04/16/2024  SH       Add calibration guard                                                                              */
