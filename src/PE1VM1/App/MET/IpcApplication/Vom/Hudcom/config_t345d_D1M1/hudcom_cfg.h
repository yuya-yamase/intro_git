...
#define HCOM_DSPCNTT_PRPS				(DSPCNTT_PRPS)
#define HCOM_DSPSTM_00					(DSPSTM_00)
...
#define u1_HCOM_CANMSGSTS_HUDSTS()		((U1)u1_g_oXCANRxdStat((U2)OXCAN_PDU_RX_CAN_HUD1S01,(U4)OXCAN_SYS_IGR,(U2)HCOM_HUD1S01_TO_THRSH) & ((U1)COM_TIMEOUT | (U1)COM_NO_RX))  /*  HUD1S01              */
