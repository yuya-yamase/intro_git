...
#define DTE_ED_CFG_C_MINOR                     (3)
#define DTE_ED_CFG_C_PATCH                     (0)
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*===================================================================================================================================*/
/*  U1      u1_g_DteEdCfgFuelRcmOOR(void)                                                                                            */
/* --------------------------------------------------------------------------------------------------------------------------------- */
/*  Arguments:      -                                                                                                                */
/*  Return:         -                                                                                                                */
/*===================================================================================================================================*/
U1      u1_g_DteEdCfgFuelRcmOOR(void)
{
    ...
    u1_t_abn |= u1_g_FuelvolTauEasAct((U1)FUEL_TAU_EAS_ID_RCM_ACT, (U1)FUEL_TAU_EAS_EDG_CRNT);
    return(u1_t_abn);
}

/*===================================================================================================================================*/
/*  U1      u1_g_DteEdCfgFuelGsiAct(void)                                                                                            */
/* --------------------------------------------------------------------------------------------------------------------------------- */
/*  Arguments:      -                                                                                                                */
/*  Return:         -                                                                                                                */
/*===================================================================================================================================*/
...
U2      u2_g_DteEdCfgMeEmptyLit0p01(void)
{
    return(u2_CALIB_MCUID0433_FU_ANALITMA[CALIB_MCUID0448_FU_LITMA_ME]);
}
...
/*  2.3.0    02/18/2024  MaO(M)   dte_ed.c v2.2.0 -> v2.3.0.                                                                         */
/*                                                                                                                                   */
/*                                                                                                                                   */
...
/*  19PFv3-7 10/22/2024  TH       Change ME-Point                                                                                    */
/*  19PFv3-8 12/24/2024  SH       Change Rental Car Mode timing to same Out Of Range                                                 */
/*                                                                                                                                   */
