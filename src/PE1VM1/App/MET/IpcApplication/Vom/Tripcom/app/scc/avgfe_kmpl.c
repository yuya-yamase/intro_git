...
#define AVGFE_KMPL_C_MINOR                      (2)
#define AVGFE_KMPL_C_PATCH                      (1)
...
/*===================================================================================================================================*/
/* U1              u1_g_AvgFeRstImmwRslt(const U1 u1_a_AVG_FE_CH)                                                                    */
/* --------------------------------------------------------------------------------------------------------------------------------- */
/*  Arguments:      -                                                                                                                */
/*  Return:         -                                                                                                                */
/*===================================================================================================================================*/
U1              u1_g_AvgFeRstImmwRslt(const U1 u1_a_AVG_FE_CH)
{
    ...
    if (u1_a_AVG_FE_CH < (U1)AVGFE_NUM_CNTTS) {
        u1_t_rslt  = st_sp_avgfe_var[u1_a_AVG_FE_CH].u1_rstimmw;
    }
...
/*  2.2.1    04/22/2025  KM       Bug fix ： Change update timing of u1_s_avgfe_econ_init_bk                                          */
/*                                                                                                                                   */
