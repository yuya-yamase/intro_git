...
#define DTE_ED_C_MINOR                        (2)
#define DTE_ED_C_PATCH                        (1)
...
#define DTE_ED_RCM_GFI                      (0x0004U)   /* Rental Car Mode or Gas FIlling */
#define DTE_ED_OOR                          (0x0008U)   /* Out Of Range                   */
...
static U1       u1_s_DteEdRcmGfi(const U2 * u2_ap_STSFIELD);
static U1       u1_s_DteEdOor(const U2 * u2_ap_STSFIELD);
...
static const U2     u2_s_DTE_ED_FUCHG_JDGBIT  = (U2)DTE_ED_RCM_GFI | (U2)DTE_ED_OOR;
...
void    vd_g_DteEdAppTask(const U2 * u2_ap_STSFIELD)
{
    static const ST_DTE_ED_APPLTASK     st_sp_DTE_ED_APPLTASK[] = {
        ...
        {(U2)DTE_ED_RCM_GFI,     &u1_s_DteEdRcmGfi          },
        {(U2)DTE_ED_OOR,         &u1_s_DteEdOor             },
...
static U1       u1_s_DteEdRcmGfi(const U2 * u2_ap_STSFIELD)
{
    ...
    u1_t_ret = u1_g_DteEdCfgFuelRcmGsiAct();
    return(u1_t_ret);
}
/*===================================================================================================================================*/
/*  static U1       u1_s_DteEdOor(const U2 * u2_ap_STSFIELD)                                                                         */
...
static U1       u1_s_DteEdCgStsSetdefcgAct(void)
{
    ...
    if((u2_s_dte_ed_applsts & (U2)DTE_ED_IGON) != (U2)0U){
        if((u2_s_dte_ed_applsts & (U2)DTE_ED_RCM_GFI) != (U2)0U){
...
static U1       u1_s_DteEdCgStsFailAct(void)
{
    ...
    else if(((u2_s_dte_ed_applsts & (U2)DTE_ED_RCM_GFI) != (U2)0U) &&
            ((u2_s_dte_ed_applsts & (U2)DTE_ED_OOR    ) == (U2)0U)){
        u1_t_sts = (U1)CGSTS_RDYUPDT;
    }
    else{
        u1_t_sts = (U1)CGSTS_HOLD;
...
static U1       u1_s_DteEdCgStsRdyUpdtAct(void)
{
    ...
    else if((u2_s_dte_ed_applsts & (U2)DTE_ED_OOR) != (U2)0U){
        u1_t_sts = (U1)CGSTS_HOLD;
    }
    else if((u2_s_dte_ed_applsts & (U2)DTE_ED_RCM_GFI) == (U2)0U){
...
static void    vd_s_DteEdCgCal(void)
{
    ...
    u2_t_fuel_full = u2_g_DteEdCfgSeFullLit0p01();
