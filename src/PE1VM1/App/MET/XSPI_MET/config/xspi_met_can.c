...
void    vd_g_XSpiMETCANGWPushPDU(const U2 u2_a_MSG)
{
    ...
    static const U2 u2_sp_XSPI_MET_CANGW_OX2IDX[] = {
        ...
        (U2)121U,   /*     81:MSG_BDC1SV1_CH0     (104U) */
        (U2)22U,    /*     82:MSG_BDC1SV2_CH0     (105U) */
        (U2)U2_MAX, /*     83:MSG_BDF3S01_CH0     (106U) */
        (U2)U2_MAX, /*     84:MSG_BDF3S02_CH0     (107U) */
        (U2)U2_MAX, /*     85:MSG_BDR3S02_CH0     (108U) */
        (U2)29U,    /*     86:MSG_BKD1S01_CH0     (109U) */
        (U2)U2_MAX, /*     87:MSG_BKD1S02_CH0     (110U) */
        (U2)30U,    /*     88:MSG_BSR1S01_CH0     (111U) */
        (U2)31U,    /*     89:MSG_BSR1S02_CH0     (112U) */
        (U2)32U,    /*     90:MSG_BSR1S03_CH0     (113U) */
        (U2)U2_MAX, /*     91:MSG_CMB1S03_CH0     (114U) */
        (U2)U2_MAX, /*     92:MSG_CMB1S04_CH0     (115U) */
        (U2)U2_MAX, /*     93:MSG_CSR1G10_CH0     (116U) */
        (U2)33U,    /*     94:MSG_CSR1S04_CH0     (117U) */
        (U2)34U,    /*     95:MSG_CSR1S07_CH0     (118U) */
        (U2)35U,    /*     96:MSG_CSR1S08_CH0     (119U) */
        (U2)U2_MAX, /*     97:MSG_DDM1S00_CH0     (120U) */
        (U2)U2_MAX, /*     98:MSG_DDM1S09_CH0     (121U) */
        (U2)36U,    /*     99:MSG_DDM1S12_CH0     (122U) */
        (U2)U2_MAX, /*    100:MSG_DDM1S16_CH0     (123U) */
        (U2)37U,    /*    101:MSG_DDM1S17_CH0     (124U) */
        (U2)U2_MAX, /*    102:MSG_DDM1S32_CH0     (125U) */
        (U2)26U,    /*    103:MSG_DDM1S35_CH0     (126U) */
        (U2)U2_MAX, /*    104:MSG_DDM1SFH_CH0     (127U) */
        (U2)U2_MAX, /*    105:MSG_DKY1S26_CH0     (128U) */
        (U2)38U,    /*    106:MSG_DMC1S08_CH0     (129U) */
        (U2)U2_MAX, /*    107:MSG_DRL1S03_CH0     (130U) */
        (U2)U2_MAX, /*    108:MSG_DRR1S03_CH0     (131U) */
        (U2)U2_MAX, /*    109:MSG_DS11S27_CH0     (132U) */
        (U2)39U,    /*    110:MSG_DS11S37_CH0     (133U) */
        (U2)40U,    /*    111:MSG_DS11S40_CH0     (134U) */
        (U2)41U,    /*    112:MSG_DS12F02_CH0     (135U) */
        (U2)42U,    /*    113:MSG_DS12F03_CH0     (136U) */
        (U2)43U,    /*    114:MSG_DST1S02_CH0     (137U) */
        (U2)U2_MAX, /*    115:MSG_EBU1D01_CH0     (138U) */
        (U2)44U,    /*    116:MSG_ECT1G01_CH0     (139U) */
        (U2)45U,    /*    117:MSG_ECT1G92_CH0     (140U) */
        (U2)U2_MAX, /*    118:MSG_ECT1S80_CH0     (141U) */
        (U2)46U,    /*    119:MSG_ECT1S93_CH0     (142U) */
        ...
        (U2)47U,    /*    125:MSG_EHV1S26_CH0     (148U) */
        (U2)48U,    /*    126:MSG_EHV1S31_CH0     (149U) */
        (U2)49U,    /*    127:MSG_EHV1S90_CH0     (150U) */
        (U2)50U,    /*    128:MSG_EHV1S94_CH0     (151U) */
        (U2)51U,    /*    129:MSG_EHV1S95_CH0     (152U) */
        (U2)52U,    /*    130:MSG_EHV1S96_CH0     (153U) */
        (U2)53U,    /*    131:MSG_EHV1S97_CH0     (154U) */
        (U2)54U,    /*    132:MSG_EHV1S99_CH0     (155U) */
        (U2)55U,    /*    133:MSG_EHV2G02_CH0     (156U) */
        (U2)U2_MAX, /*    134:MSG_EHV2G10_CH0     (157U) */
        (U2)U2_MAX, /*    135:MSG_EHV2G20_CH0     (158U) */
        (U2)56U,    /*    136:MSG_EHV2G70_CH0     (159U) */
        ...
        (U2)57U,    /*    147:MSG_ENG1G03_CH0     (170U) */
        (U2)U2_MAX, /*    148:MSG_ENG1G13_CH0     (171U) */
        (U2)U2_MAX, /*    149:MSG_ENG1G17_CH0     (172U) */
        (U2)58U,    /*    150:MSG_ENG1G90_CH0     (173U) */
        (U2)59U,    /*    151:MSG_ENG1G92_CH0     (174U) */
        (U2)60U,    /*    152:MSG_ENG1S60_CH0     (175U) */
        (U2)61U,    /*    153:MSG_ENG1S99_CH0     (176U) */
        (U2)U2_MAX, /*    154:MSG_EPS1D50_CH0     (177U) */
        (U2)62U,    /*    155:MSG_EPS1S11_CH0     (178U) */
        (U2)63U,    /*    156:MSG_EPS1S90_CH0     (179U) */
        (U2)U2_MAX, /*    157:MSG_FCM1C01_CH0     (180U) */
        (U2)64U,    /*    158:MSG_FCM1S10_CH0     (181U) */
        (U2)65U,    /*    159:MSG_FCM1S12_CH0     (182U) */
        (U2)66U,    /*    160:MSG_FCM1S39_CH0     (183U) */
        (U2)67U,    /*    161:MSG_FCM1S40_CH0     (184U) */
        (U2)68U,    /*    162:MSG_FCM1S41_CH0     (185U) */
        (U2)U2_MAX, /*    163:MSG_FCM1S49_CH0     (186U) */
        (U2)69U,    /*    164:MSG_FCM1S51_CH0     (187U) */
        (U2)70U,    /*    165:MSG_FCM1S52_CH0     (188U) */
        (U2)71U,    /*    166:MSG_FCM1S58_CH0     (189U) */
        (U2)72U,    /*    167:MSG_FCM1S70_CH0     (190U) */
        (U2)U2_MAX, /*    168:MSG_FCM1S76_CH0     (191U) */
        (U2)73U,    /*    169:MSG_FCM1S78_CH0     (192U) */
        (U2)U2_MAX, /*    170:MSG_FCM1S79_CH0     (193U) */
        (U2)U2_MAX, /*    171:MSG_FCM1S90_CH0     (194U) */
        (U2)74U,    /*    172:MSG_FCM1S92_CH0     (195U) */
        (U2)U2_MAX, /*    173:MSG_FCM1S95_CH0     (196U) */
        (U2)75U,    /*    174:MSG_FWD1S10_CH0     (197U) */
        (U2)76U,    /*    175:MSG_IDT1S02_CH0     (198U) */
        (U2)U2_MAX, /*    176:MSG_IDT1S07_CH0     (199U) */
        (U2)U2_MAX, /*    177:MSG_IDT1S15_CH0     (200U) */
        (U2)77U,    /*    178:MSG_IPA1S05_CH0     (201U) */
        (U2)78U,    /*    179:MSG_ITS1S01_CH0     (202U) */
        (U2)U2_MAX, /*    180:MSG_ITS1S04_CH0     (203U) */
        (U2)79U,    /*    181:MSG_ITS1S05_CH0     (204U) */
        (U2)80U,    /*    182:MSG_LVN1S01_CH0     (205U) */
        (U2)U2_MAX, /*    183:MSG_MET1S33_CH0     (206U) */
        (U2)U2_MAX, /*    184:MSG_MGC1F13_CH0     (207U) */
        (U2)81U,    /*    185:MSG_PCN1S01_CH0     (208U) */
        (U2)U2_MAX, /*    186:MSG_PDC1G01_CH0     (209U) */
        (U2)82U,    /*    187:MSG_PDC1G02_CH0     (210U) */
        (U2)83U,    /*    188:MSG_PDS1S01_CH0     (211U) */
        (U2)U2_MAX, /*    189:MSG_PLG1G15_CH0     (212U) */
        (U2)84U,    /*    190:MSG_PLG1G16_CH0     (213U) */
        (U2)85U,    /*    191:MSG_PLG1S01_CH0     (214U) */
        (U2)86U,    /*    192:MSG_PLG1S06_CH0     (215U) */
        (U2)87U,    /*    193:MSG_PLG1S20_CH0     (216U) */
        (U2)88U,    /*    194:MSG_PLG1S21_CH0     (217U) */
        (U2)89U,    /*    195:MSG_PMN1G03_CH0     (218U) */
        (U2)90U,    /*    196:MSG_PST1S01_CH0     (219U) */
        ...
        (U2)91U,    /*    202:MSG_RSE1G20_CH0     (225U) */
        ...
        (U2)92U,    /*    207:MSG_SBW1G02_CH0     (230U) */
        (U2)93U,    /*    208:MSG_SCN1S01_CH0     (231U) */
        (U2)94U,    /*    209:MSG_SCN1S02_CH0     (232U) */
        (U2)U2_MAX, /*    210:MSG_SCS1S10_CH0     (233U) */
        (U2)95U,    /*    211:MSG_SCS1S11_CH0     (234U) */
        (U2)96U,    /*    212:MSG_SCS1S14_CH0     (235U) */
        (U2)97U,    /*    213:MSG_SOL1S02_CH0     (236U) */
        (U2)98U,    /*    214:MSG_SOL1S06_CH0     (237U) */
        (U2)99U,    /*    215:MSG_TPM1S02_CH0     (238U) */
        (U2)100U,   /*    216:MSG_TPM1S03_CH0     (239U) */
        (U2)101U,   /*    217:MSG_TPM1S04_CH0     (240U) */
        (U2)102U,   /*    218:MSG_TPM1S05_CH0     (241U) */
        (U2)103U,   /*    219:MSG_TPM1S07_CH0     (242U) */
        (U2)104U,   /*    220:MSG_TRA1S01_CH0     (243U) */
        (U2)105U,   /*    221:MSG_UCB1S01_CH0     (244U) */
        (U2)106U,   /*    222:MSG_VAS1S01_CH0     (245U) */
        (U2)U2_MAX, /*    223:MSG_VGR1D50_CH0     (246U) */
        (U2)U2_MAX, /*    224:MSG_VSC1D51_CH0     (247U) */
        (U2)U2_MAX, /*    225:MSG_VSC1F01_CH0     (248U) */
        (U2)107U,   /*    226:MSG_VSC1G12_CH0     (249U) */
        (U2)108U,   /*    227:MSG_VSC1G13_CH0     (250U) */
        (U2)U2_MAX, /*    228:MSG_VSC1G14_CH0     (251U) */
        (U2)109U,   /*    229:MSG_VSC1G96_CH0     (252U) */
        ...
        (U2)14U,    /*    235:MSG_ZN11S14_CH0     (258U) */
        (U2)110U,   /*    236:MSG_ZN11S17_CH0     (259U) */
        (U2)111U,   /*    237:MSG_ZN11S19_CH0     (260U) */
        (U2)112U,   /*    238:MSG_ZN11S26_CH0     (261U) */
        (U2)U2_MAX, /*    239:MSG_ZN11S32_CH0     (262U) */
        (U2)113U,   /*    240:MSG_ZN11S38_CH0     (263U) */
        (U2)114U,   /*    241:MSG_ZN11S60_CH0     (264U) */
        ...
        (U2)115U,   /*    250:MSG_ZN21S13_CH0     (273U) */
