...
#define OXDC_MAIN_TICK_CFG                       (10U)            /* DCM_TASKTIME_MSEC : 10 milliseconds    */

#define OXDC_SID23_USE                           (OXDC_USE)
...
#define OXDC_SID14_NR_22_USE                     (OXDC_USE)
#define OXDC_SID27_NR_22_USE                     (OXDC_USE)
#define OXDC_SID28_NR_22_USE                     (OXDC_USE)
