...
#define OXDC_TMSTP_NWCM_TMSTP_NVM_SIZE          (8U)
#define OXDC_TMSTP_NWCM_DUMMY_2ND               (0U)
#define OXDC_TMSTP_NWCM_DUMMY_1ST               (1U)
#define OXDC_TMSTP_NWCM_TRIC_IDX_2ND            (2U)
#define OXDC_TMSTP_NWCM_TRIC_IDX_1ST            (3U)
#define OXDC_TMSTP_NWCM_TIMC_IDX_4TH            (4U)
#define OXDC_TMSTP_NWCM_TIMC_IDX_3RD            (5U)
#define OXDC_TMSTP_NWCM_TIMC_IDX_2ND            (6U)
#define OXDC_TMSTP_NWCM_TIMC_IDX_1ST            (7U)
...
static U4                    u4_s_oxdc_tmstp_timc_nwcm_br  __attribute__((section(".bss_BACK")));
...
static void    vd_s_oXdcTmstpWriteNwcm(const U2 u2_a_TRI_CNT, const U4 u4_a_TIM_CNT);
...
void    vd_g_oXDoCANTmstpBonInit(void)
{
    U1      u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TMSTP_NVM_SIZE];
    U4      u4_t_tim_cnt;
    U2      u2_t_tri_cnt;
    U1      u1_t_init_tmstp;

    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_DUMMY_2ND]    = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_DUMMY_1ST]    = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TRIC_IDX_2ND] = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TRIC_IDX_1ST] = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_4TH] = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_3RD] = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_2ND] = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_1ST] = (U1)0U;

    u1_t_init_tmstp = u1_g_NWCMReadData(u1_g_OXDC_TMSTP_NWCMID, &u1_tp_nwcm_tmstp[0], (U1)OXDC_TMSTP_NWCM_TMSTP_NVM_SIZE);

    if(u1_t_init_tmstp != (U1)NWCM_RESULT_OK){
        u2_t_tri_cnt = (U2)0U;
        u4_t_tim_cnt = (U4)0U;
        vd_s_oXdcTmstpWriteNwcm(u2_t_tri_cnt, u4_t_tim_cnt);
    }
    else{
        u2_t_tri_cnt  = (U2)((U2)u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TRIC_IDX_2ND] << OXDC_TMSTP_CNT_LSB_2ND);
        u2_t_tri_cnt |= (U2)u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TRIC_IDX_1ST];

        u4_t_tim_cnt  = (U4)((U4)u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_4TH] << OXDC_TMSTP_CNT_LSB_4TH);
        u4_t_tim_cnt |= (U4)((U4)u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_3RD] << OXDC_TMSTP_CNT_LSB_3RD);
        u4_t_tim_cnt |= (U4)((U4)u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_2ND] << OXDC_TMSTP_CNT_LSB_2ND);
        u4_t_tim_cnt |= (U4)u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_1ST];
    }
    u4_s_oxdc_tmstp_timc_nwcm_br  = u4_t_tim_cnt;
...
void    vd_g_oXDoCANTmstpRstInit(void)
{
    ...
    if(st_s_oxdc_tmstp_br.u2_chk == (U2)OXDC_TMSTP_BR_LAS){
        ...
        if((u4_s_oxdc_tmstp_timc_nwcm_br != u4_s_oxdc_tmstp_timc_ofst_br) ||
           ((u4_t_elpsd & (U4)OXDC_TMSTP_TIMC_REC_MASK) != (U4)0U       )){

            vd_g_DateclkEtmStart(u1_g_OXDC_TMSTP_DCT_CH, (U4)0U);
            u4_s_oxdc_tmstp_timc_ofst_br = u4_s_oxdc_tmstp_tim_cnt;
            vd_s_oXdcTmstpWriteNwcm(u2_s_oxdc_tmstp_tri_cnt, u4_s_oxdc_tmstp_tim_cnt);
        }
...
void    vd_g_oXDoCANTmstpMainTask(const U2 u2_a_TSLOT, const U1 u1_a_EOM)
{
    ...
    if((u1_a_EOM & (U1)OXDC_EOM_IGN_ON) != (U1)0){
...
static void    vd_s_oXdcTmstpTripUpdt(void)
{
    ...
    if(u2_t_tric_rx < (U2)OXDC_TMSTP_TRIC_UNK){
        ...
        if(u2_s_oxdc_tmstp_tri_cnt != u2_t_tric_rx){
            ...
            vd_s_oXdcTmstpWriteNwcm(u2_t_tric_rx, (U4)0U);
...
static void     vd_s_oXdcTmstpWriteNwcm(const U2 u2_a_TRI_CNT, const U4 u4_a_TIM_CNT)
{
    ...
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_DUMMY_2ND]    = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_DUMMY_1ST]    = (U1)0U;
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TRIC_IDX_2ND] = (U1)(u2_a_TRI_CNT >> OXDC_TMSTP_CNT_LSB_2ND);
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TRIC_IDX_1ST] = (U1)(u2_a_TRI_CNT);
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_4TH] = (U1)(u4_a_TIM_CNT >> OXDC_TMSTP_CNT_LSB_4TH);
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_3RD] = (U1)(u4_a_TIM_CNT >> OXDC_TMSTP_CNT_LSB_3RD);
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_2ND] = (U1)(u4_a_TIM_CNT >> OXDC_TMSTP_CNT_LSB_2ND);
    u1_tp_nwcm_tmstp[OXDC_TMSTP_NWCM_TIMC_IDX_1ST] = (U1)(u4_a_TIM_CNT);

    u1_t_ret = u1_g_NWCMWriteData(u1_g_OXDC_TMSTP_NWCMID, &u1_tp_nwcm_tmstp[0], (U1)OXDC_TMSTP_NWCM_TMSTP_NVM_SIZE);
    if(u1_t_ret == (U1)NWCM_RESULT_OK){
        u4_s_oxdc_tmstp_timc_nwcm_br = u4_a_TIM_CNT;
    }
}
/*===================================================================================================================================*/
/*                                                                                                                                   */
