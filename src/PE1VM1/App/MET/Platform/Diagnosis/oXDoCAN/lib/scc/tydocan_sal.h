...
#define OXDC_SECURITY_KEYADR_UNLOCK              (0x001FFFE0U)
#define OXDC_SECURITY_KEYADR_CANDI               (0x001FFB00U)
#define OXDC_SECURITY_KEYADR_SID2E               (0x001FFC90U)
#define OXDC_SECURITY_KEYADR_OTA                 (0x001FFE20U)
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
U1      u1_g_oXDoCANSecKeyStat(void);
