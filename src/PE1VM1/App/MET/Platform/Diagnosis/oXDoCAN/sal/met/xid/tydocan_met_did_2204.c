...
/*===================================================================================================================================*/
/* TyDoCAN Service Application Layer / DID 0x2204                                                                                    */
/*                                                                                                                                   */
/*===================================================================================================================================*/
...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define TYDOCAN_MET_DID_2204_C_MAJOR             (1)
#define TYDOCAN_MET_DID_2204_C_MINOR             (0)
#define TYDOCAN_MET_DID_2204_C_PATCH             (0)
...
U1      u1_g_oXDoCANRebyId_2204(U1 * u1_ap_ans, const U2 u2_a_ELPSD)
{
    return(u1_g_TyDoCANNvmIfRead(u1_ap_ans, (U2)TYDC_NVM_2E_2204));
}
/*===================================================================================================================================*/
...
U1      u1_g_oXDoCANWrbyId_2204(const U1 * u1_ap_REQ, const U2 u2_a_ELPSD)
{
    return(u1_g_TyDoCANNvmIfWrite(u1_ap_REQ, u2_a_ELPSD, (U2)TYDC_NVM_2E_2204));
}
/*===================================================================================================================================*/
/*                                                                                                                                   */
/*  Change History                                                                                                                   */
