...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define TYDOCAN_MET_DID_10A7_C_MAJOR             (1)
#define TYDOCAN_MET_DID_10A7_C_MINOR             (0)
#define TYDOCAN_MET_DID_10A7_C_PATCH             (0)
...
U1      u1_g_oXDoCANRebyId_10A7(U1 * u1_ap_ans, const U2 u2_a_ELPSD)
{
    return(u1_g_TyDoCANLogRAM(u1_ap_ans, (U1)TYDC_LOGRAM_10A7));
}
/*===================================================================================================================================*/
/*                                                                                                                                   */
/*  Change History                                                                                                                   */
