...
U1      u1_g_oXDoCANRebyId_F188(U1 * u1_ap_ans, const U2 u2_a_ELPSD)
{
    ...
    u1_t_pn_chk     = u1_g_Product((U1)PRDCT_PN_SOFT_N, &u1_tp_pn_tx[OXDC_SOFT_N_LB1], (U1)PRDCT_SOFT_N_NBYTE);
    ...
    u1_t_socpn_sts   = u1_g_LComSpiSpnRx((U1)LCOM_SPI_SPN_RX_LB3, &u1_tp_pn_tx[OXDC_SOFT_N_LB3], (U1)LCOM_SPI_SPN_NB_LB3);
    if(u1_t_socpn_sts != (U1)TRUE){
        vd_g_MemfillU1(&u1_tp_pn_tx[OXDC_SOFT_N_LB3], (U1)0x3FU, (U4)OXDC_SOFT_N_LENGTH);
    }
    ...
    u1_t_socpn_sts   = u1_g_LComSpiSpnRx((U1)LCOM_SPI_SPN_RX_LB4, &u1_tp_pn_tx[OXDC_SOFT_N_LB4], (U1)LCOM_SPI_SPN_NB_LB4);
    if(u1_t_socpn_sts != (U1)TRUE){
        vd_g_MemfillU1(&u1_tp_pn_tx[OXDC_SOFT_N_LB4], (U1)0x3FU, (U4)OXDC_SOFT_N_LENGTH);
    }
    ...
    u1_t_socpn_sts   = u1_g_LComSpiSpnRx((U1)LCOM_SPI_SPN_RX_LB5, &u1_tp_pn_tx[OXDC_SOFT_N_LB5], (U1)LCOM_SPI_SPN_NB_LB5);
    if(u1_t_socpn_sts != (U1)TRUE){
        vd_g_MemfillU1(&u1_tp_pn_tx[OXDC_SOFT_N_LB5], (U1)0x3FU, (U4)OXDC_SOFT_N_LENGTH);
    }
    ...
    u1_t_socpn_sts   = u1_g_LComSpiSpnRx((U1)LCOM_SPI_SPN_RX_LB6, &u1_tp_pn_tx[OXDC_SOFT_N_LB6], (U1)LCOM_SPI_SPN_NB_LB6);
    if(u1_t_socpn_sts != (U1)TRUE){
        vd_g_MemfillU1(&u1_tp_pn_tx[OXDC_SOFT_N_LB6], (U1)0x3FU, (U4)OXDC_SOFT_N_LENGTH);
    }
