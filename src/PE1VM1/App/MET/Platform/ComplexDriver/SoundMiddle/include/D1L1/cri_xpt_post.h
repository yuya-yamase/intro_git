...
#define CRI_FALSE	((CriBool)0)
#endif
#if !defined(CRI_TRUE)
#define CRI_TRUE	((CriBool)1)
#endif
...
#if !defined(CRI_TYPEDEF_CriUint64Adr)
#define CRI_TYPEDEF_CriUint64Adr
...
#if !defined(CRI_TYPEDEF_Uint8)
#define CRI_TYPEDEF_Uint8
typedef CriUint8				Uint8;		/* 符号なし１バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Sint8)
#define CRI_TYPEDEF_Sint8
typedef CriSint8				Sint8;		/* 符号つき１バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Uint16)
#define CRI_TYPEDEF_Uint16
typedef CriUint16				Uint16;		/* 符号なし２バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Sint16)
#define CRI_TYPEDEF_Sint16
typedef CriSint16				Sint16;		/* 符号つき２バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Uint32)
#define CRI_TYPEDEF_Uint32
typedef CriUint32				Uint32;		/* 符号なし４バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Sint32)
#define CRI_TYPEDEF_Sint32
typedef CriSint32				Sint32;		/* 符号つき４バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Uint64)
#define CRI_TYPEDEF_Uint64
typedef CriUint64				Uint64;		/* 符号なし８バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Sint64)
#define CRI_TYPEDEF_Sint64
typedef CriSint64				Sint64;		/* 符号つき８バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Uint128)
#define CRI_TYPEDEF_Uint128
typedef CriUint128				Uint128;	/* 符号なし16バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Sint128)
#define CRI_TYPEDEF_Sint128
typedef CriSint128				Sint128;	/* 符号つき16バイト整数 */
#endif

#if !defined(CRI_TYPEDEF_Float16)
#define CRI_TYPEDEF_Float16
typedef CriFloat16				Float16;	/* ２バイト実数 */
#endif

#if !defined(CRI_TYPEDEF_Float32)
#define CRI_TYPEDEF_Float32
typedef CriFloat32				Float32;	/* ４バイト実数 */
#endif

#if !defined(CRI_TYPEDEF_Float64)
#define CRI_TYPEDEF_Float64
typedef CriFloat64				Float64;	/* ８バイト実数 */
#endif

#if !defined(CRI_TYPEDEF_Fixed32)
#define CRI_TYPEDEF_Fixed32
typedef CriFixed32				Fixed32;	/* 固定小数点32ビット */
#endif

/* X11 API（xtrapproto.h）との競合回避用 */
#if !defined(CRI_TYPEDEF_Bool) && !defined(Bool)
#define CRI_TYPEDEF_Bool
typedef CriBool					Bool;		/* 論理型（論理定数を値にとる） */
#endif

#if !defined(CRI_TYPEDEF_Char8)
#define CRI_TYPEDEF_Char8
typedef CriChar8				Char8;		/* 文字型 */
#endif

#if !defined(CRI_TYPEDEF_SintPtr)
#define CRI_TYPEDEF_SintPtr
typedef CriSintPtr				SintPtr;
#endif

#if !defined(CRI_TYPEDEF_UintPtr)
#define CRI_TYPEDEF_UintPtr
