 ...
 * Module   : CRI Common Header for RH850U2A
 * File     : cri_xpts_rh850u2a.h
 * Date     : 2024-11-26
 * Version  : 1.00
 *
 ****************************************************************************/

#if !defined(CRI_INCL_CRI_XPTS_RH850U2A_H)
#define CRI_INCL_CRI_XPTS_RH850U2A_H
...
typedef CriSint32			CriSintPtr; /* 4 bytes pointer */
#endif

#if !defined(CRI_TYPEDEF_CriUintPtr)
#define CRI_TYPEDEF_CriUintPtr
typedef CriUint32			CriUintPtr; /* 4 bytes pointer */
#endif
...
#endif	/* CRI_INCL_CRI_XPTS_RH850U2A_H */
