...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define SOUND_OW_WAV_IDX_NUM                     (61U)        /* Number of Active Test ID for buzzer/speaker action                  */
...
#define SOUND_AT_0P8_LRG_0P8_CO                  (6U)         /* Frequency:0.8kHz, Volume:High, Decrement:T=0.8s, Continuation       */
...
#define SOUND_AT_0P8_LRG_NONE_SI                 (11U)        /* Frequency:0.8kHz, Volume:High, Decrement:None,   0.9s Single shot   */
#define SOUND_AT_0P8_LRG_NONE_TW                 (12U)        /* Frequency:0.8kHz, Volume:High, Decrement:None,   0.2s Double shot   */
#define SOUND_AT_0P8_LRG_NONE_CO                 (13U)        /* Frequency:0.8kHz, Volume:High, Decrement:None,   Continuation       */
...
#define SOUND_AT_0P8_SML_0P8_CO                  (20U)        /* Frequency:0.8kHz, Volume:Low,  Decrement:T=0.8s, Continuation       */
...
#define SOUND_AT_0P8_SML_NONE_SI                 (25U)        /* Frequency:0.8kHz, Volume:Low,  Decrement:None,   0.9s Single shot   */
#define SOUND_AT_0P8_SML_NONE_TW                 (26U)        /* Frequency:0.8kHz, Volume:Low,  Decrement:None,   0.2s Double shot   */
#define SOUND_AT_0P8_SML_NONE_CO                 (27U)        /* Frequency:0.8kHz, Volume:Low,  Decrement:None,   Continuation       */
...
#define SOUND_AT_CLESON_FRS                      (42U)        /* Clearance sonar Fr detection (Closest approach/Short distance)      */
...
#define SOUND_AT_CLESON_FRRRS                    (50U)        /* Clearance sonar Fr & Rr detection (Closest approach/Short distance) */
...
#define SOUND_AT_AT_REVERSE_IN                   (U1_MAX)     /* A/T reverse buzzer                                                  */
#define SOUND_AT_SBW_REVERSE_IN                  (54U)        /* SBW reverse buzzer                                                  */
#define SOUND_AT_SEAREM_FMV                      (55U)        /* Seatbelt reminder buzzer (Regulation intermittence)                 */
#define SOUND_AT_SEAREM_LV2                      (56U)        /* Seatbelt reminder buzzer (Level 2)                                  */
#define SOUND_AT_SEAREM_LV1                      (57U)        /* Seatbelt reminder buzzer (Level 1)                                  */
#define SOUND_AT_SEAREM_SI                       (58U)        /* Unbuckle notification buzzer                                        */
#define SOUND_AT_MC_SI                           (U1_MAX)     /* Master caution buzzer                                               */
#define SOUND_AT_MMTURHAZ_STA                    (59U)        /* Flasher operating sound (Start of lighting)                         */
#define SOUND_AT_MMTURHAZ_FIN                    (60U)        /* Flasher operating sound (End of lighting)                           */
