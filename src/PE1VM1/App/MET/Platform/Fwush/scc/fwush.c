...
static U1 u1_s_FwushDetectResumeEvent(void)
{
    ...
    static U1 u1_s_FWUSH_PROG_ACT_CRIT = (U1)FWUSH_PROGRESS_ACT_DONE;
    static U1 u1_s_FWUSH_PROG_VALID_CRIT = (U1)(FWUSH_PROGRESS_ACT_DONE | FWUSH_PROGRESS_VALIDATE_DONE);
    U1 u1_t_event;
    U1 u1_t_veri_target;
    U1 u1_t_veri_comp;
