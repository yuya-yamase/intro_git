...
#define XSPI_SCLK_MODE_CFG 		(PORT_MODE_CFG_P4_7_6)		/* SCLKポート設定値（MCAL/PORT） */
#define XSPI_TXD_MODE_CFG 		(PORT_MODE_CFG_P4_10_7)		/* TXDポート設定値（MCAL/PORT） */
#define XSPI_RXD_MODE_CFG 		(PORT_MODE_CFG_P4_6_5)		/* RXDポート設定値（MCAL/PORT） */
