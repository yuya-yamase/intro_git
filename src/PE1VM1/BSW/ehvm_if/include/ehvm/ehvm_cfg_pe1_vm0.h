...
#define EHVM_TX_VCCID_VCCBUFFER_9_VM1_TOOTHERVM ((ehvm_uint32_t)9U)
#define EHVM_TX_VCCID_VCCBUFFER_13_VM1_TOVM3 ((ehvm_uint32_t)13U)
#define EHVM_TX_VCCID_VCC_SHARED_TX_VM1 ((ehvm_uint32_t)17U)
#define EHVM_TX_VCCID_VCC_VCRYCL_TX_VM1 ((ehvm_uint32_t)21U)
#define EHVM_TX_VCCID_VCC_OXSEC_TX_VM1 ((ehvm_uint32_t)23U)
...
#define EHVM_TX_VCCID_VCCBUFFER_9_VM1_TOOTHERVM_MAX ((ehvm_uint32_t)0x00000004U)
#define EHVM_TX_VCCID_VCCBUFFER_13_VM1_TOVM3_MAX ((ehvm_uint32_t)0x00000004U)
#define EHVM_TX_VCCID_VCC_SHARED_TX_VM1_MAX ((ehvm_uint32_t)0x00000100U)
#define EHVM_TX_VCCID_VCC_VCRYCL_TX_VM1_MAX ((ehvm_uint32_t)0x00000020U)
#define EHVM_TX_VCCID_VCC_OXSEC_TX_VM1_MAX ((ehvm_uint32_t)0x00000008U)
...
#define EHVM_RX_VCCID_VCC_VCRYPX_TX_VM0 ((ehvm_uint32_t)22U)
...
#define EHVM_RX_VCCID_VCC_VCRYPX_TX_VM0_MAX ((ehvm_uint32_t)0x00000010U)
