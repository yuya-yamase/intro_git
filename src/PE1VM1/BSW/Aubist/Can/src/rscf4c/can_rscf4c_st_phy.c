/* can_rscf4c_st_phy_c_m10700_v3-0-0                                        */
/****************************************************************************/
/* Protected                                                                */
...
/****************************************************************************/
/* Object Name  | CAN/RSCF4C/ST/PHYSICAL/CODE                               */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/
...
Can_st_Stop( uint8 u1Controller )
{
    ...
    if ( ( *(ptChReg->ptu4CmSTS) & CAN_u4CMSTS_MODEALL_MSK ) == CAN_u4CMSTS_CMODE_COMM )
    {
        ...
        u4TMTRSTSyLo       = ptChReg->ptu4TMTRSTSy[CAN_IDX0];
        u4TMTRSTSyHi       = ptChReg->ptu4TMTRSTSy[CAN_IDX1];
        if ( ( ( u4TMTRSTSyLo & u4TxMbUseBitMaskLo ) == CAN_u4BIT_NONE )
        &&   ( ( u4TMTRSTSyHi & u4TxMbUseBitMaskHi ) == CAN_u4BIT_NONE ) )
        {
...
Can_st_SetConfigMbox( uint8 u1Controller )
{
    ...
    if ( ( ( u4GSTS & CAN_u4GSTS_MODEALL_MSK )           == CAN_u4GSTS_GMODE_RESET )
    &&   ( ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX0 ] != u4GAFLCFG0Conf         )
#if (CAN_CFG_CONTROLLERNUM_MAX > 2U)
        || ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX1 ] != u4GAFLCFG1Conf         )
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 2U) */
#if (CAN_CFG_CONTROLLERNUM_MAX > 4U)
        || ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX2 ] != u4GAFLCFG2Conf         )
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 4U) */
#if (CAN_CFG_CONTROLLERNUM_MAX > 6U)
        || ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX3 ] != u4GAFLCFG3Conf         )
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 6U) */
    ) )
    {
        Can_st_SetRxRule();
...
Can_st_GlobalRegCheck( uint8 u1Controller )
{
    ...
    {
        u4GAFLCFG0Conf = Can_tb_u4GAFLCFG0Conf;
        if ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX0 ] != u4GAFLCFG0Conf )
        {
            u1Ret = (uint8)CAN_PROC_NG;
        }
...
#if (CAN_CFG_CONTROLLERNUM_MAX > 2U)
        u4GAFLCFG1Conf = Can_tb_u4GAFLCFG1Conf;
        if ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX1 ] != u4GAFLCFG1Conf )
        {
            u1Ret = (uint8)CAN_PROC_NG;
        }
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 2U) */
...
#if (CAN_CFG_CONTROLLERNUM_MAX > 4U)
        u4GAFLCFG2Conf = Can_tb_u4GAFLCFG2Conf;
        if ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX2 ] != u4GAFLCFG2Conf )
        {
            u1Ret = (uint8)CAN_PROC_NG;
        }
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 4U) */
...
#if (CAN_CFG_CONTROLLERNUM_MAX > 6U)
        u4GAFLCFG3Conf = Can_tb_u4GAFLCFG3Conf;
        if ( Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX3 ] != u4GAFLCFG3Conf )
        {
            u1Ret = (uint8)CAN_PROC_NG;
        }
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 6U) */
...
Can_st_InitGlobalReg( void )
{
    ...
    *(Can_tb_stGlobalReg.ptu4GFTBAC)   = CAN_u4GFTBAC_INIT;
    ...
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX0 ] = CAN_u4GAFLCFGV_INIT;
#if (CAN_CFG_CONTROLLERNUM_MAX > 2U)
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX1 ] = CAN_u4GAFLCFGV_INIT;
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 2U) */
#if (CAN_CFG_CONTROLLERNUM_MAX > 4U)
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX2 ] = CAN_u4GAFLCFGV_INIT;
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 4U) */
#if (CAN_CFG_CONTROLLERNUM_MAX > 6U)
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX3 ] = CAN_u4GAFLCFGV_INIT;
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 6U) */
    ...
    *(Can_tb_stGlobalReg.ptu4RMNB)     = CAN_u4RMNB_INIT;
    ...
    for ( u1Controller = (uint8)0U; u1Controller < u1CtrlNum; u1Controller++ )
    {
        if ( Can_tb_stCtrlInfo[ u1Controller ].u1CtrlAct == (uint8)CAN_TRUE )
        {
            ...
            ptChReg->ptu4CFCCEk[ CAN_TRX_FIFO_0 ] = CAN_u4CFCCEK_INIT;
            ptChReg->ptu4CFCCEk[ CAN_TRX_FIFO_1 ] = CAN_u4CFCCEK_INIT;
            ptChReg->ptu4CFCCEk[ CAN_TRX_FIFO_2 ] = CAN_u4CFCCEK_INIT;
        }
    }
}
...
Can_st_InitChannelReg( uint8 u1Controller )
{
    ...
    *(ptChReg->ptu4CmFDCFG) = CAN_u4CMFDCFG_INIT;
    ...
    ptChReg->ptu4TMIECy[CAN_IDX0] = CAN_u4TMIECY_INIT;
    ptChReg->ptu4TMIECy[CAN_IDX1] = CAN_u4TMIECY_INIT;

    *(ptChReg->ptu4TXQCC0m) = CAN_u4TXQCC0M_INIT;
    *(ptChReg->ptu4TXQCC1m) = CAN_u4TXQCC1M_INIT;
    *(ptChReg->ptu4TXQCC2m) = CAN_u4TXQCC2M_INIT;
    *(ptChReg->ptu4TXQCC3m) = CAN_u4TXQCC3M_INIT;
...
Can_st_StopChannel( uint8 u1Controller )
{
    ...
    ptChReg->ptu4CFSTSk[ CAN_TRX_FIFO_0 ] = CAN_u4CFSTSK_CLEARALL;
    ptChReg->ptu4CFSTSk[ CAN_TRX_FIFO_1 ] = CAN_u4CFSTSK_CLEARALL;
    ptChReg->ptu4CFSTSk[ CAN_TRX_FIFO_2 ] = CAN_u4CFSTSK_CLEARALL;
...
Can_st_StartChannel( uint8 u1Controller )
{
    ...
    if ( ( *(ptChReg->ptu4CmSTS) & CAN_u4CMSTS_MODEALL_MSK ) == CAN_u4CMSTS_CMODE_RESET )
    {
        *(ptChReg->ptu4CmCTR)    = ptSetRSCANReg->u4CmCTRConf | CAN_u4CMCTR_CHMDC_RESET_SET;
        ...
        ptChReg->ptu4TMIECy[CAN_IDX0] = Can_tb_stTxMbBit[ u1Controller ].u4TxIntrBit[CAN_IDX0];
        ptChReg->ptu4TMIECy[CAN_IDX1] = Can_tb_stTxMbBit[ u1Controller ].u4TxIntrBit[CAN_IDX1];
...
Can_st_SetRxRule( void )
{
    ...
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX0 ] = Can_tb_u4GAFLCFG0Conf;
#if (CAN_CFG_CONTROLLERNUM_MAX > 2U)
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX1 ] = Can_tb_u4GAFLCFG1Conf;
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 2U) */
#if (CAN_CFG_CONTROLLERNUM_MAX > 4U)
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX2 ] = Can_tb_u4GAFLCFG2Conf;
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 4U) */
#if (CAN_CFG_CONTROLLERNUM_MAX > 6U)
    Can_tb_stGlobalReg.ptu4GAFLCFGv[ CAN_IDX3 ] = Can_tb_u4GAFLCFG3Conf;
#endif /* (CAN_CFG_CONTROLLERNUM_MAX > 6U) */
