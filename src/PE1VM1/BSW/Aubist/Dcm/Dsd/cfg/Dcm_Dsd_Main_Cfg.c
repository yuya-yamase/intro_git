...
/* Dcm_Dsd_stService[0009] SID=0x10 SF=0x03 */
/* Table of subfunctions SessionCheck */
static CONST(AB_83_ConstV uint8, DCM_CONFIG_DATA) Dcm_Dsd_stIdx0009SB03SesChk[2] =
{
    /* Enable Session List */
    (uint8)0x01U,
    (uint8)0x03U
...
/* Dcm_Dsd_stService[0009] SID=0x10 */
/* Table of subfunctions */
static CONST(AB_83_ConstV Dcm_Dsd_SubServiceType, DCM_CONFIG_DATA) Dcm_Dsd_stIdx0009SubService[2] =
{
    /* Dcm_Dsd_stService[0009] SID=0x10 SF=0x01 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID10_Sub01), NULL_PTR,                       NULL_PTR,                       (uint8)0x01U,   (uint8)0U,          (uint8)0U
    },
    ...
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID10_Sub03), NULL_PTR,                       Dcm_Dsd_stIdx0009SB03SesChk,    (uint8)0x03U,   (uint8)0U,          (uint8)2U
    }
};

/* Dcm_Dsd_stService[000A] SID=0x10 */
/* Table of subfunctions */
static CONST(AB_83_ConstV Dcm_Dsd_SubServiceType, DCM_CONFIG_DATA) Dcm_Dsd_stIdx000ASubService[2] =
{
    /* Dcm_Dsd_stService[000A] SID=0x10 SF=0x01 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID10_Sub01), NULL_PTR,                       NULL_PTR,                       (uint8)0x01U,   (uint8)0U,          (uint8)0U
    },
    /* Dcm_Dsd_stService[000A] SID=0x10 SF=0x03 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
...
/* Dcm_Dsd_stService[000B] SID=0x19 */
/* Table of subfunctions */
static CONST(AB_83_ConstV Dcm_Dsd_SubServiceType, DCM_CONFIG_DATA) Dcm_Dsd_stIdx000BSubService[5] =
{
    /* Dcm_Dsd_stService[000B] SID=0x19 SF=0x02 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID19_Sub02), NULL_PTR,                       NULL_PTR,                       (uint8)0x02U,   (uint8)0U,          (uint8)0U
    },
    /* Dcm_Dsd_stService[000B] SID=0x19 SF=0x03 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID19_Sub03), NULL_PTR,                       NULL_PTR,                       (uint8)0x03U,   (uint8)0U,          (uint8)0U
    },
    /* Dcm_Dsd_stService[000B] SID=0x19 SF=0x04 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID19_Sub04), NULL_PTR,                       NULL_PTR,                       (uint8)0x04U,   (uint8)0U,          (uint8)0U
    },
    /* Dcm_Dsd_stService[000B] SID=0x19 SF=0x17 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID19_Sub17), NULL_PTR,                       NULL_PTR,                       (uint8)0x17U,   (uint8)0U,          (uint8)0U
    },
    /* Dcm_Dsd_stService[000B] SID=0x19 SF=0x18 */
    {
        /* ptFnc            ptSecurityLevel                 ptSessionLevel                  u1Id            u1SecurityLevelNum  u1SessionLevelNum    */
        &(Dcm_SID19_Sub18), NULL_PTR,                       NULL_PTR,                       (uint8)0x18U,   (uint8)0U,          (uint8)0U
    }
...
CONST(AB_83_ConstV Dcm_Dsd_ServiceType, DCM_CONFIG_DATA) Dcm_Dsd_stService[DCM_D_SERVICE_NUM] =
{
    ...
    {
        /* ptFnc        ptSecurityLevelRef          ptSessionLevelRef           ptSubService                    u1Id            bSubfuncAvail       u1SecurityLevelNum  u1SessionLevelNum   u1SubServiceNum        */
        NULL_PTR,       NULL_PTR,                   NULL_PTR,                   Dcm_Dsd_stIdx0009SubService,    (uint8)0x10U,   (boolean)TRUE,      (uint8)0U,          (uint8)0U,          (uint8)2U
    },
    /* Idx=000A SID=0x10 */
    {
        /* ptFnc        ptSecurityLevelRef          ptSessionLevelRef           ptSubService                    u1Id            bSubfuncAvail       u1SecurityLevelNum  u1SessionLevelNum   u1SubServiceNum        */
        NULL_PTR,       NULL_PTR,                   NULL_PTR,                   Dcm_Dsd_stIdx000ASubService,    (uint8)0x10U,   (boolean)TRUE,      (uint8)0U,          (uint8)0U,          (uint8)2U
    },
    /* Idx=000B SID=0x19 */
    {
        /* ptFnc        ptSecurityLevelRef          ptSessionLevelRef           ptSubService                    u1Id            bSubfuncAvail       u1SecurityLevelNum  u1SessionLevelNum   u1SubServiceNum        */
        NULL_PTR,       NULL_PTR,                   NULL_PTR,                   Dcm_Dsd_stIdx000BSubService,    (uint8)0x19U,   (boolean)TRUE,      (uint8)0U,          (uint8)0U,          (uint8)5U
    }
};

/* Table of Dcm_Dsd_stService Index */
static CONST(AB_83_ConstV uint16, DCM_CONFIG_DATA) Dcm_Dsd_PduId0004_ServiceIndex[9] = 
{
...
static CONST(AB_83_ConstV uint16, DCM_CONFIG_DATA) Dcm_Dsd_PduId0005_ServiceIndex[9] = 
{
    /* Index of Dcm_Dsd_stService */
    (uint8)0x0009U,
    (uint8)0x0001U,
...
static CONST(AB_83_ConstV uint16, DCM_CONFIG_DATA) Dcm_Dsd_PduId0006_ServiceIndex[5] = 
{
    /* Index of Dcm_Dsd_stService */
    (uint8)0x000AU,
    (uint8)0x000BU,
...
static CONST(AB_83_ConstV uint16, DCM_CONFIG_DATA) Dcm_Dsd_PduId0007_ServiceIndex[9] = 
{
    /* Index of Dcm_Dsd_stService */
    (uint8)0x0000U,
    (uint8)0x0001U,
...
static CONST(AB_83_ConstV uint16, DCM_CONFIG_DATA) Dcm_Dsd_PduId0008_ServiceIndex[9] = 
{
    /* Index of Dcm_Dsd_stService */
    (uint8)0x0009U,
    (uint8)0x0001U,
...
CONST(AB_83_ConstV Dcm_DsdType, DCM_CONFIG_DATA) Dcm_Dsd_stConfigSet =
{
    ...
    /* stServiceTable */
    {
        ...
        {  (uint16)0x0004U, (uint8)9U,            Dcm_Dsd_PduId0004_ServiceIndex },
        {  (uint16)0x0005U, (uint8)9U,            Dcm_Dsd_PduId0005_ServiceIndex },
        {  (uint16)0x0006U, (uint8)5U,            Dcm_Dsd_PduId0006_ServiceIndex },
        {  (uint16)0x0007U, (uint8)9U,            Dcm_Dsd_PduId0007_ServiceIndex },
        {  (uint16)0x0008U, (uint8)9U,            Dcm_Dsd_PduId0008_ServiceIndex },
