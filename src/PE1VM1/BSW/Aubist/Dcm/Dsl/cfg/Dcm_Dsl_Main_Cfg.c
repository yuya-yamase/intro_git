...
CONST(AB_83_ConstV Dcm_Dsl_ProtocolRxType, DCM_CONFIG_DATA) Dcm_Dsl_R0_C4_stProtocolRx[DCM_DSL_R0_C4_PROTOCOLRX_NUM]=
{
    {
        (uint32)0UL,    /* u4ExtResTimeout */
...
{
    {
        ...
        NULL_PTR,    /* ptPeriodicConnectionRef */
        &Dcm_Dsl_R0_C0_stResponseOnEvent[0]        /* ptRoeConnectionRef */
    }
};
...
CONST(AB_83_ConstV Dcm_Dsl_MainConnectionType, DCM_CONFIG_DATA) Dcm_Dsl_R0_C4_stMainConnection[1] =
{
    {
        ...
        &Dcm_Dsl_R0_C4_stProtocolTx[0],    /* ptProtocolTx */
        NULL_PTR,    /* ptPeriodicConnectionRef */
        &Dcm_Dsl_R0_C0_stResponseOnEvent[0]        /* ptRoeConnectionRef */
    }
};
...
{
    {
        NULL_PTR,                              /* ptMainConnection */
        NULL_PTR,                              /* ptPeriodicTransmission */
        &Dcm_Dsl_R0_C0_stResponseOnEvent[0]    /* ptResponseOnEvent */
    },
    {
    ...
    {
        &Dcm_Dsl_R0_C4_stMainConnection[0],    /* ptMainConnection */
        NULL_PTR,                              /* ptPeriodicTransmission */
        NULL_PTR                               /* ptResponseOnEvent */
    }
};
...
{
    {
        ...
        (uint32)50UL,    /* u4DiagFailSafeTimeout */
...
{
    &Dcm_Dsp_SID27_ClearSeed,
    &Dcm_Dsp_SID28_ResetComCtrl,
    &Dcm_Dsp_SID86_NotifySesCtrl
};
