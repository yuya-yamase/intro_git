...
{
    &Dcm_Dsp_StorageMng_GetSleepPermission,
    NULL_PTR
};
...
{
    &Dcm_Dsp_StorageMng_PreWriteAll,
    NULL_PTR
};
...
{
    &Dcm_Dsp_StorageMng_Refresh,
    &Dcm_Dsp_SID27_Refresh,
    &Dcm_Dsp_SID86_Refresh,
    NULL_PTR
};
...
{
    &Dcm_Dsp_SID86_SetActiveResponse
};
