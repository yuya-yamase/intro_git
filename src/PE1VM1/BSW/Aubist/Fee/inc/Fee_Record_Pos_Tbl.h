...
/* Macros                                                                   */
/*--------------------------------------------------------------------------*/
/* Valid record position TBL setting value */
#define FEE_IDNONE              ((uint16)0xAAAAU)   /* Unregistered data */
#define FEE_ID_MRR_NONE         ((uint16)0x5555U)   /* Unregistered data (mirror) */
