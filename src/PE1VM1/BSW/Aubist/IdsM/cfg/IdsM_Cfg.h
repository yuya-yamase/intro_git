...
#define IDSM_CFG_USE_INTSEV_EVEBUFFUL        (STD_ON)
#define IDSM_CFG_USE_INTSEV_CTXBUFFUL        (STD_ON)
#define IDSM_CFG_USE_INTSEV_TRAFFICLMIT        (STD_OFF)
#define IDSM_CFG_USE_FILTERCHAIN        (STD_ON)
#define IDSM_CFG_USE_FIL_BLKSTATE        (STD_OFF)
#define IDSM_CFG_USE_FIL_AGGREGATION        (STD_ON)
