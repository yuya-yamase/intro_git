...
/****************************************************************************/
/* Object Name  | CAN/RSCF41C/HEADER                                        */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/

#ifndef     CAN_RSCF41C_H
#define     CAN_RSCF41C_H
...
#define CAN_CV_IP                       (CAN_IP_RSCF41C)
...
#define Can_tb_Interrupt                (CAN_CV_CONVERT_NAME(_tb_Interrupt))
#define Can_tb_Interrupt_0              (CAN_CV_CONVERT_NAME(_tb_Interrupt_0))
#define Can_tb_Interrupt_1              (CAN_CV_CONVERT_NAME(_tb_Interrupt_1))
#define Can_tb_Interrupt_2              (CAN_CV_CONVERT_NAME(_tb_Interrupt_2))
#define Can_tb_Interrupt_3              (CAN_CV_CONVERT_NAME(_tb_Interrupt_3))
#define Can_tb_Interrupt_4              (CAN_CV_CONVERT_NAME(_tb_Interrupt_4))
#define Can_tb_Interrupt_5              (CAN_CV_CONVERT_NAME(_tb_Interrupt_5))
#define Can_tb_Interrupt_6              (CAN_CV_CONVERT_NAME(_tb_Interrupt_6))
#define Can_tb_Interrupt_7              (CAN_CV_CONVERT_NAME(_tb_Interrupt_7))
...
#define Can_tb_u4GAFLCFG2Conf           (CAN_CV_CONVERT_NAME(_tb_u4GAFLCFG2Conf))
#define Can_tb_u4GAFLCFG3Conf           (CAN_CV_CONVERT_NAME(_tb_u4GAFLCFG3Conf))
...
#endif/* (CAN_CV_IP == CAN_IP_RSCF41C) */
