/* can_rsc_cm_phy_h_m10700_v2-2-0                                           */
/****************************************************************************/
/* Protected                                                                */
...
/****************************************************************************/
/* Object Name  | CAN/RSC/CM/PHYSICAL/HEADER                                */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/
#ifndef CAN_RSC_CM_PHY_H
#define CAN_RSC_CM_PHY_H
...
#define CAN_USER_DATABAUDRATE           (0x00000000UL)      /* データボーレート：ユーザボーレート        未使用 */
#define CAN_DB_125KBPS_2M_PTN1          (0x00000000UL)      /* データボーレート：125kbps_2M  ：パターン1 未使用 */
#define CAN_DB_125KBPS_2P5M_PTN1        (0x00000000UL)      /* データボーレート：125kbps_2.5M：パターン1 未使用 */
#define CAN_DB_250KBPS_4M_PTN1          (0x00000000UL)      /* データボーレート：250kbps_4M  ：パターン1 未使用 */
#define CAN_DB_250KBPS_4M_PTN2          (0x00000000UL)      /* データボーレート：250kbps_4M  ：パターン2 未使用 */
#define CAN_DB_250KBPS_5M_PTN1          (0x00000000UL)      /* データボーレート：250kbps_5M  ：パターン1 未使用 */
#define CAN_DB_250KBPS_5M_PTN2          (0x00000000UL)      /* データボーレート：250kbps_5M  ：パターン2 未使用 */
#define CAN_DB_500KBPS_8M_PTN1          (0x00000000UL)      /* データボーレート：500kbps_8M  ：パターン1 未使用 */
#define CAN_DB_500KBPS_8M_PTN2          (0x00000000UL)      /* データボーレート：500kbps_8M  ：パターン2 未使用 */
#define CAN_DB_500KBPS_8M_PTN3          (0x00000000UL)      /* データボーレート：500kbps_8M  ：パターン3 未使用 */
#define CAN_DB_500KBPS_8M_PTN4          (0x00000000UL)      /* データボーレート：500kbps_8M  ：パターン4 未使用 */
#define CAN_DB_500KBPS_8M_PTN5          (0x00000000UL)      /* データボーレート：500kbps_8M  ：パターン5 未使用 */
#define CAN_DB_500KBPS_10M_PTN1         (0x00000000UL)      /* データボーレート：500kbps_10M ：パターン1 未使用 */
#define CAN_DB_500KBPS_10M_PTN2         (0x00000000UL)      /* データボーレート：500kbps_10M ：パターン2 未使用 */
#define CAN_DB_500KBPS_10M_PTN3         (0x00000000UL)      /* データボーレート：500kbps_10M ：パターン3 未使用 */
#define CAN_DB_500KBPS_10M_PTN4         (0x00000000UL)      /* データボーレート：500kbps_10M ：パターン4 未使用 */
#define CAN_DB_500KBPS_10M_PTN5         (0x00000000UL)      /* データボーレート：500kbps_10M ：パターン5 未使用 */
#define CAN_DB_500KBPS_20M_PTN1         (0x00000000UL)      /* データボーレート：500kbps_20M ：パターン1 未使用 */
#define CAN_DB_500KBPS_32M_PTN1         (0x00000000UL)      /* データボーレート：500kbps_32M ：パターン1 未使用 */
#define CAN_DB_500KBPS_40M_PTN1         (0x00000000UL)      /* データボーレート：500kbps_40M ：パターン1 未使用 */
#define CAN_DB_500KBPS_40M_PTN2         (0x00000000UL)      /* データボーレート：500kbps_40M ：パターン2 未使用 */
#define CAN_DB_500KBPS_80M_PTN1         (0x00000000UL)      /* データボーレート：500kbps_80M ：パターン1 未使用 */
#define CAN_DB_2MBPS_20M_PTN1           (0x00000000UL)      /* データボーレート：2Mbps_20M   ：パターン1 未使用 */
#define CAN_DB_2MBPS_32M_PTN1           (0x00000000UL)      /* データボーレート：2Mbps_32M   ：パターン1 未使用 */
#define CAN_DB_2MBPS_40M_PTN1           (0x00000000UL)      /* データボーレート：2Mbps_40M   ：パターン1 未使用 */
#define CAN_DB_2MBPS_40M_PTN2           (0x00000000UL)      /* データボーレート：2Mbps_40M   ：パターン2 未使用 */
#define CAN_DB_2MBPS_80M_PTN1           (0x00000000UL)      /* データボーレート：2Mbps_80M   ：パターン1 未使用 */

#define CAN_BAUDRATEINFO_1_1            (0x00000000UL)      /* ボーレート情報1：未使用                  */

#define CAN_BAUDRATEINFO_2_1            (0x00000000UL)      /* ボーレート情報2：未使用                  */
...
/* レジスタ初期値マクロ                 */
/*======================================*/
#define CAN_u4CMCFG_INIT                (0x00000000UL)      /* 初期値 CmCFG                             */
...
#define CAN_u4CFSTSK_CFTXIF_CLR         (0x0000000CUL)      /* 送受信FIFO送信割り込み要求フラグクリア   */
#define CAN_u4CFSTSK_CFRXIF_CLR         (0x00000014UL)      /* 送受信FIFO受信割り込み要求フラグクリア   */
#define CAN_u4CFSTSK_CFMLT_CLR          (0x00000018UL)      /* 送受信FIFOメッセージロストフラグクリア   */
...
#define CAN_u4CFIDK_ID_MSK              (0x9FFFFFFFUL)      /* CFIDkレジスタ    CFIDE,CFIDマスク                       */
...
#define CAN_u4CMCTR_USEDBIT_MSK         (0x07E1FF0FUL)      /* CmCTRレジスタ    使用ビットマスク                       */
#define CAN_u4CMCTR_MODEALL_MSK         (0x00000007UL)      /* CmCTRレジスタ    CSLPR,CHMDCマスク                      */
#define CAN_u4GCFG_USEDBIT_MSK          (0x0000001FUL)      /* GCFGレジスタ     使用ビットマスク                       */
