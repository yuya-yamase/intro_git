...
#if defined(ECU_VM0)
#define ECU_INT_u4VECTOR_ADDRESS_0 (0x00210000UL)

#elif defined(ECU_VM1)
#define ECU_INT_u4VECTOR_ADDRESS_0 (0x00020000UL)

#elif defined(ECU_VM2)
#define ECU_INT_u4VECTOR_ADDRESS_0 (0x00404000UL)

#elif defined(ECU_VM3)
#define ECU_INT_u4VECTOR_ADDRESS_0 (0x005f0000UL)

#else
#define ECU_INT_u4VECTOR_ADDRESS_0 (0x003C0000UL)
