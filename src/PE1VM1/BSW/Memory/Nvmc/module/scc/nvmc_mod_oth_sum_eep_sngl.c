...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define NVMC_MOD_OTH_SUM_EEP_SNGL_C_MAJOR        (1U)
#define NVMC_MOD_OTH_SUM_EEP_SNGL_C_MINOR        (4U)
#define NVMC_MOD_OTH_SUM_EEP_SNGL_C_PATCH        (2U)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((NVMC_MOD_OTH_SUM_EEP_SNGL_C_MAJOR != NVMC_MOD_OTH_SUM_EEP_SNGL_H_MAJOR) || \
     (NVMC_MOD_OTH_SUM_EEP_SNGL_C_MINOR != NVMC_MOD_OTH_SUM_EEP_SNGL_H_MINOR) || \
     (NVMC_MOD_OTH_SUM_EEP_SNGL_C_PATCH != NVMC_MOD_OTH_SUM_EEP_SNGL_H_PATCH))
#error "nvmc_mod_oth_sum_eep_sngl.c and nvmc_mod_oth_sum_eep_sngl_private.h : source and header files are inconsistent!"
#endif
...
/*  Defines                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define NVMC_MOD_OTH_SUM_EEP_SNGL_RDNNUM         (1U)
#define NVMC_MOD_OTH_SUM_EEP_SNGL_LOST_BIT       (1U)

#define NVMCMOD_OTHSUM_EEP_SNGL_SHFT             (16U)
#define NVMCMOD_OTHSUM_EEP_SNGL_MASK             (0x0000FFFFU)

#define NVMCMOD_OTHSUM_EEP_MIN_BUFSIZE           (2U)                                         /* ( 4byte + SUM(4byte))          */
#define NVMCMOD_OTHSUM_EEP_SNGL_BUFSIZE          (NVMC_MOD_LIB_OTHR_MAX_BUFSIZE * NVMC_MOD_OTH_SUM_EEP_SNGL_RDNNUM)
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
static U1   u1_s_NvmcMod_OthSumSngl_EEP_RdnD(const U1 u1_a_SIZE, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS);
static U4   u4_s_NvmcMod_OthSumSngl_EEP_WrD(const U4 * const u4_ap_WRITEDATA, const U1 u1_a_BLOCKNUM, const U1 u1_a_SIZE);
...
U1   u1_d_NvmcMod_8bSumSngl_EEP_RdnD(const ST_NVMC_CFGDATA * const st_ap_CFGDATA, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    ...
    u1_t_ret = u1_s_NvmcMod_OthSumSngl_EEP_RdnD((U1)NVMCMOD_OTHSUM_EEP_8B_BLOCKNUM, u4_ap_rdnrslt, u4_ap_DATA, u1_ap_STATUS);
    return(u1_t_ret);
}
...
U1   u1_d_NvmcMod_12bSumSngl_EEP_RdnD(const ST_NVMC_CFGDATA * const st_ap_CFGDATA, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    ...
    u1_t_ret = u1_s_NvmcMod_OthSumSngl_EEP_RdnD((U1)NVMCMOD_OTHSUM_EEP_12B_BLOCKNUM, u4_ap_rdnrslt, u4_ap_DATA, u1_ap_STATUS);
    return(u1_t_ret);
}
...
U1   u1_d_NvmcMod_16bSumSngl_EEP_RdnD(const ST_NVMC_CFGDATA * const st_ap_CFGDATA, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    ...
    u1_t_ret = u1_s_NvmcMod_OthSumSngl_EEP_RdnD((U1)NVMCMOD_OTHSUM_EEP_16B_BLOCKNUM, u4_ap_rdnrslt, u4_ap_DATA, u1_ap_STATUS);
    return(u1_t_ret);
}
...
U1   u1_d_NvmcMod_20bSumSngl_EEP_RdnD(const ST_NVMC_CFGDATA * const st_ap_CFGDATA, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    ...
    u1_t_ret = u1_s_NvmcMod_OthSumSngl_EEP_RdnD((U1)NVMCMOD_OTHSUM_EEP_20B_BLOCKNUM, u4_ap_rdnrslt, u4_ap_DATA, u1_ap_STATUS);
    return(u1_t_ret);
}
...
U1   u1_d_NvmcMod_24bSumSngl_EEP_RdnD(const ST_NVMC_CFGDATA * const st_ap_CFGDATA, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    ...
    u1_t_ret = u1_s_NvmcMod_OthSumSngl_EEP_RdnD((U1)NVMCMOD_OTHSUM_EEP_24B_BLOCKNUM, u4_ap_rdnrslt, u4_ap_DATA, u1_ap_STATUS);
    return(u1_t_ret);
}
...
U1   u1_d_NvmcMod_28bSumSngl_EEP_RdnD(const ST_NVMC_CFGDATA * const st_ap_CFGDATA, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    ...
    u1_t_ret = u1_s_NvmcMod_OthSumSngl_EEP_RdnD((U1)NVMCMOD_OTHSUM_EEP_28B_BLOCKNUM, u4_ap_rdnrslt, u4_ap_DATA, u1_ap_STATUS);
    return(u1_t_ret);
}
...
void   vd_d_NvmcMod_8bSumSngl_EEP_WrD(U4 * const u4_ap_writedata, const U1 u1_a_RDNNUM, const U1 u1_a_BLOCKNUM)
{
    u4_ap_writedata[0] = u4_s_NvmcMod_OthSumSngl_EEP_WrD(u4_ap_writedata, u1_a_BLOCKNUM, (U1)NVMCMOD_OTHSUM_EEP_8B_BLOCKNUM);
}
...
void   vd_d_NvmcMod_12bSumSngl_EEP_WrD(U4 * const u4_ap_writedata, const U1 u1_a_RDNNUM, const U1 u1_a_BLOCKNUM)
{
    u4_ap_writedata[0] = u4_s_NvmcMod_OthSumSngl_EEP_WrD(u4_ap_writedata, u1_a_BLOCKNUM, (U1)NVMCMOD_OTHSUM_EEP_12B_BLOCKNUM);
}
...
void   vd_d_NvmcMod_16bSumSngl_EEP_WrD(U4 * const u4_ap_writedata, const U1 u1_a_RDNNUM, const U1 u1_a_BLOCKNUM)
{
    u4_ap_writedata[0] = u4_s_NvmcMod_OthSumSngl_EEP_WrD(u4_ap_writedata, u1_a_BLOCKNUM, (U1)NVMCMOD_OTHSUM_EEP_16B_BLOCKNUM);
}
...
void   vd_d_NvmcMod_20bSumSngl_EEP_WrD(U4 * const u4_ap_writedata, const U1 u1_a_RDNNUM, const U1 u1_a_BLOCKNUM)
{
    u4_ap_writedata[0] = u4_s_NvmcMod_OthSumSngl_EEP_WrD(u4_ap_writedata, u1_a_BLOCKNUM, (U1)NVMCMOD_OTHSUM_EEP_20B_BLOCKNUM);
}
...
void   vd_d_NvmcMod_24bSumSngl_EEP_WrD(U4 * const u4_ap_writedata, const U1 u1_a_RDNNUM, const U1 u1_a_BLOCKNUM)
{
    u4_ap_writedata[0] = u4_s_NvmcMod_OthSumSngl_EEP_WrD(u4_ap_writedata, u1_a_BLOCKNUM, (U1)NVMCMOD_OTHSUM_EEP_24B_BLOCKNUM);
}
...
void   vd_d_NvmcMod_28bSumSngl_EEP_WrD(U4 * const u4_ap_writedata, const U1 u1_a_RDNNUM, const U1 u1_a_BLOCKNUM)
{
    u4_ap_writedata[0] = u4_s_NvmcMod_OthSumSngl_EEP_WrD(u4_ap_writedata, u1_a_BLOCKNUM, (U1)NVMCMOD_OTHSUM_EEP_28B_BLOCKNUM);
}
...
static U1   u1_s_NvmcMod_OthSumSngl_EEP_RdnD(const U1 u1_a_SIZE, U4 * u4_ap_rdnrslt, const U4 * const u4_ap_DATA, const U1 * const u1_ap_STATUS)
{
    U4  u4_t_buf[NVMCMOD_OTHSUM_EEP_SNGL_BUFSIZE];
    U4  u4_t_sum;
    U1  u1_t_ret;
    U1  u1_t_nlong;
    U1  u1_t_sts_bit;
    ...
    vd_g_MemfillU4(u4_t_buf, (U4)0U, (U4)NVMCMOD_OTHSUM_EEP_SNGL_BUFSIZE);
    ...
    if(u1_t_nlong < (U1)NVMCMOD_OTHSUM_EEP_MIN_BUFSIZE){
        ...
        u1_t_sts_bit = u1_d_NvmcMod_Lib_StatusCheck((U1)NVMC_MOD_OTH_SUM_EEP_SNGL_RDNNUM, u1_a_SIZE, u1_ap_STATUS);
        if(u1_t_sts_bit == (U1)0U){
            vd_d_NvmcMod_Lib_PackRevU2toU4(&u4_t_buf[0], &u4_ap_DATA[0], (U4)u1_a_SIZE);

            u1_t_nlong--;
            u4_t_sum = (U4)0U;
            u1_t_chkrslt = u1_d_NvmcMod_GetErrDetectCode(&u4_t_buf[0], u1_t_nlong, &u4_t_sum);
            if((u1_t_chkrslt == (U1)TRUE) &&
               (u4_t_sum == u4_t_buf[u1_t_nlong])){
                vd_g_MemcpyU4(u4_ap_rdnrslt, &u4_t_buf[0], (U4)u1_t_nlong);
        ...
        else if(u1_t_sts_bit == (U1)NVMC_MOD_OTH_SUM_EEP_SNGL_LOST_BIT){
...
static U4   u4_s_NvmcMod_OthSumSngl_EEP_WrD(const U4 * const u4_ap_WRITEDATA, const U1 u1_a_BLOCKNUM, const U1 u1_a_SIZE)
{
    ...
    if(u1_t_nlong < (U1)NVMCMOD_OTHSUM_EEP_MIN_BUFSIZE){
        ...
        if((u1_a_BLOCKNUM & (U1)1U) != (U1)0U){
            u4_t_ret >>= NVMCMOD_OTHSUM_EEP_SNGL_SHFT;
        }
        u4_t_ret &= (U4)NVMCMOD_OTHSUM_EEP_SNGL_MASK;
    }
...
/*  1.1.4            4/22/2016  KM      Fixed u4_d_NvmcMod_16bSumSngl_EEP_WrD.                                                       */
/*  1.1.5            5/16/2016  HK      Fixed PCS3-2 issue.                                                                          */
/*  1.2.0            5/26/2016  KM      Add 20byte IF.                                                                               */
/*  1.2.1            6/17/2016  KM      Fixed code sonar issue.                                                                      */
/*  1.3.0            11/4/2016  HK      Changed with the small sector correspondence.                                                */
/*                                      Fixed AIP3GBSW-7 issue.                                                                      */
/*  1.3.1            8/22/2017  HK      Fixed AIP3GBSW-146 issue.                                                                    */
/*  1.4.0            9/ 4/2017  HK      Fixed AIP3GBSW-155 issue (add new module size(24, 28)).                                      */
/*  1.4.1           12/01/2017  HK      Fixed AIP3GBSW-222 issue.                                                                    */
