...
#define RIMID_U1_TIMEZONE_TZ                     (0x0002U)
#define RIMID_U1_TIMEZONE_TZ_SIGN                (0x0003U)
#define RIMID_U1_TIMEZONE_DST_S30                (0x0004U)
#define RIMID_U1_NVMC_ST_DTF_000                 (0x0005U)
#define RIMID_U1_NVMC_ST_DTF_001                 (0x0006U)
#define RIMID_U1_NVMC_ST_DTF_002                 (0x0007U)
#define RIMID_U1_NVMC_ST_DTF_003                 (0x0008U)
#define RIMID_U1_NVMC_ST_DTF_004                 (0x0009U)
#define RIMID_U1_NVMC_ST_DTF_005                 (0x000AU)
#define RIMID_U1_NVMC_ST_DTF_006                 (0x000BU)
#define RIMID_U1_NVMC_ST_DTF_007                 (0x000CU)
#define RIMID_U1_NVMC_ST_DTF_008                 (0x000DU)
#define RIMID_U1_NVMC_ST_DTF_009                 (0x000EU)
#define RIMID_U1_NVMC_ST_DTF_010                 (0x000FU)
#define RIMID_U1_NVMC_ST_DTF_011                 (0x0010U)
/* END : ##TOOL_OUT#RIM_ID_MOD_3B_U1## */
/* START : ##TOOL_OUT#RIM_ID_MOD_3B_U2## */
#define RIMID_U2_SAMPLE_BBB_2                    (0x4000U)
#define RIMID_U2_NVMC_DA_DTF_WRI_009             (0x4001U)
#define RIMID_U2_NVMC_DA_DTF_WRI_010             (0x4002U)
#define RIMID_U2_NVMC_DA_DTF_WRI_011             (0x4003U)
