...
static U1      u1_s_oXdcRebyIdSecuritychk(const U2 u2_a_REBYID_XID, const ST_OXDC_REQ * st_ap_REQ)
{
    ...
    u2_t_sec = st_gp_OXDC_DATA_XID[u2_a_REBYID_XID].u2_rd_sec;
...
static void    vd_s_oXdcRebyIdProcRun(const ST_OXDC_REQ * st_ap_REQ, ST_OXDC_ANS * st_ap_ans)
{
    ...
    do{
        ...
        if(u1_t_proc == (U1)OXDC_SAL_PROC_FIN){
            ...
            st_ap_ans->u1p_tx[u4_s_oxdc_rebyid_ansnbyte/* + OXDC_REBYID_DID_HI */] = (U1)((U4)st_gp_OXDC_DATA_XID[u2_gp_oxdc_rebyid_xidlist[u1_g_oxdc_rebyid_xidcnt]].u2_xid >> 8U);
            st_ap_ans->u1p_tx[u4_s_oxdc_rebyid_ansnbyte   + OXDC_REBYID_DID_LO   ] = (U1)st_gp_OXDC_DATA_XID[u2_gp_oxdc_rebyid_xidlist[u1_g_oxdc_rebyid_xidcnt]].u2_xid;
