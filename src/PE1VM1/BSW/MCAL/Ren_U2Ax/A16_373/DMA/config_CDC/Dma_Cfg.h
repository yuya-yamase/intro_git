...
#define	DMA_UCFG_CHDATA2_REQ				(PIL_DMAC_GR0_INTTAUD1I0)			/* See DMA_UCFG_CHDATA0_REQ for range			*/
#define	DMA_UCFG_CHDATA2_HWCH				(PIL_DMAC_CH6)						/* See DMA_UCFG_CHDATA0_HWCH for range			*/
...
#define	DMA_UCFG_CHDATA4_REQ				(PIL_DMAC_GR0_INTTAUD1I0)			/* See DMA_UCFG_CHDATA0_REQ for range			*/
