...
const U4               u4_gp_SCHDLR_TASK_CYCL_CFG[SCHDLR_TASK_CYCL_MAX] = {
    (U4)(SCHDLR_TASKBIT___5MS | SCHDLR_TASKBIT__10MS_A | SCHDLR_TASKBIT__20MS_A),
    (U4)0x00000000U,
    (U4)0x00000000U,
    (U4)0x00000000U,
    (U4)0x00000000U,
    ...
    (U4)0x00000000U,
    (U4)0x00000000U,
    (U4)(SCHDLR_TASKBIT___5MS | SCHDLR_TASKBIT__10MS_A | SCHDLR_TASKBIT__20MS_B),
    (U4)0x00000000U,
    (U4)0x00000000U,
    (U4)0x00000000U,
    (U4)0x00000000U,
...
void    vd_g_SchdlrCfgMainTick(const U4 u4_a_TRGBIT)
{
    ...
    (void)ActivateTask(eMCOS_TASK_Low);
    (void)ActivateTask(eMCOS_TASK_High);

    u4_t_jdgbit = u4_a_TRGBIT & (U4)SCHDLR_TASKBIT___5MS;
...
void    vd_g_SchdlrCfgIdleToRun(void)
{
    ...
    /*------------------------------------------------------------------------------*/
    vd_g_Gpt_OstStart((U1)GPT_OST_CH_02_SCHDLR_TICK, &u4_sp_SCHDLR_OST_START[0]);
