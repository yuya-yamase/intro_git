...
void    vd_g_SchdlrMainTask(void)
{
    ...
    U2                         u2_t_taskid;                                         /* throughput */

    vd_g_ThroughputMainStart();                                                     /* throughput */

    u1_t_run = u1_g_SchdlrCfgMainRunnablechk();

    vd_g_ThroughputMainFinish((U2)THRPTM_TASK_SCHDLR_MAIN_RUN_CHK);                 /* throughput */
    ...
    if(u1_t_run == (U1)TRUE){
        ...
        vd_g_ThroughputMainFinish((U2)THRPTM_TASK_SCHDLR_MAIN_STA);                 /* throughput */
#endif
        ...
        for(u4_t_cnt = (U4)0U; u4_t_cnt < (U4)u2_g_SCHDLR_RGLR_NUM_TASK; u4_t_cnt++){
            ...
            if(u4_t_exe != (U4)0U){
                ...
                u2_t_taskid = (U2)u4_t_cnt + (U2)THRPTM_TASK_SCHDLR_RGLR_1ST;       /* throughput */
                vd_g_ThroughputMainStart();                                         /* throughput */

                (*st_gp_SCHDLR_RGLR_TASK[u4_t_cnt].fp_vd_TASK)();

                vd_g_ThroughputMainFinish(u2_t_taskid);                             /* throughput */
            }
        }

        vd_g_ThroughputMainTask();                                                  /* throughput */
        ...
        vd_g_ThroughputMainFinish((U2)THRPTM_TASK_SCHDLR_MAIN_FIN);                 /* throughput */
#endif
    }
...
void    vd_g_SchdlrIdleTask(void)
{
    ...
    vd_g_ThroughputEcuToRun();                                                      /* throughput */
    ...
    vd_g_ThroughputInit();                                                          /* throughput */
    do{

#if (__SCHDLR_CFGHK_IDLE_START__ == 1)
        vd_g_ThroughputIdleStart();                                                 /* throughput */

        vd_g_SchdlrCfgIdleStart();

        vd_g_ThroughputIdleFinish((U2)THRPTM_TASK_SCHDLR_IDLE_STA);                 /* throughput */
     ...
     (__AIP_DEBUG_SIM__               == 1))
        ...
        u2_t_taskid = u2_t_cnt + (U2)THRPTM_TASK_SCHDLR_IDLE_1ST;                   /* throughput */
        vd_g_ThroughputIdleStart();                                                 /* throughput */

        (*fp_gp_vd_SCHDLR_IDLE_TASK[u2_t_cnt])();

        vd_g_ThroughputIdleFinish(u2_t_taskid);                                     /* throughput */
        u2_t_cnt++;
     ...
     (__AIP_DEBUG_SIM__               == 1))
        ...
        vd_g_ThroughputIdleFinish((U2)THRPTM_TASK_SCHDLR_IDLE_FIN);                 /* throughput */
        ...
        vd_g_ThroughputIdleFinish((U2)THRPTM_TASK_SCHDLR_SHTDWN_CHK);               /* throughput */
    }while(u1_t_sht != (U1)TRUE);

    vd_g_ThroughputEcuToShtdwn();
