/* can_rscf4c_tb_phy_h_m10700_v2-2-0                                        */
/****************************************************************************/
/* Protected                                                                */
...
/****************************************************************************/
/* Object Name  | CAN/RSCF4C/TB/PHYSICAL/HEADER                             */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/

#ifndef     CAN_RSCF4C_TB_PHY_H
#define     CAN_RSCF4C_TB_PHY_H
...
typedef struct
{
    volatile uint32 u4GAFLIDj;
    volatile uint32 u4GAFLMj;
    volatile uint32 u4GAFLP0j;
    volatile uint32 u4GAFLP1j;
} CanTbRegRxRuleType;
...
typedef struct
{
    ...
    volatile uint32 *                CanConst ptu4CFCCk;
    volatile uint32 *                CanConst ptu4CFCCEk;
    volatile uint32 *                CanConst ptu4CFSTSk;
    volatile uint32 *                CanConst ptu4CFPCTRk;
    volatile uint8  *                CanConst ptu1TMCp;
    volatile uint8  *                CanConst ptu1TMSTSp;
    volatile uint32 *                CanConst ptu4TMTRSTSy;
    volatile uint32 *                CanConst ptu4TMTARSTSy;
    volatile uint32 *                CanConst ptu4TMTCSTSy;
    volatile uint32 *                CanConst ptu4TMTASTSy;
    volatile uint32 *                CanConst ptu4TMIECy;
    volatile uint32 *                CanConst ptu4TXQCC0m;
    volatile uint32 *                CanConst ptu4TXQSTS0m;
    volatile uint32 *                CanConst ptu4TXQPCTR0m;
    volatile uint32 *                CanConst ptu4TXQCC1m;
    volatile uint32 *                CanConst ptu4TXQSTS1m;
    volatile uint32 *                CanConst ptu4TXQPCTR1m;
    volatile uint32 *                CanConst ptu4TXQCC2m;
    volatile uint32 *                CanConst ptu4TXQSTS2m;
    volatile uint32 *                CanConst ptu4TXQPCTR2m;
    volatile uint32 *                CanConst ptu4TXQCC3m;
    volatile uint32 *                CanConst ptu4TXQSTS3m;
    volatile uint32 *                CanConst ptu4TXQPCTR3m;
    volatile uint32 *                CanConst ptu4THLCCm;
    volatile uint32 *                CanConst ptu4THLSTSm;
    volatile uint32 *                CanConst ptu4THLPCTRm;
    volatile uint32 *                CanConst ptu4GRINTSTSm;
    ...
    volatile uint32 *                CanConst ptu4THLACC0m;
    volatile uint32 *                CanConst ptu4THLACC1m;
...
typedef struct
{
    ...
    volatile uint32 *                CanConst ptu4GAFLCFGv;
    volatile uint32 *                CanConst ptu4RMNB;
    volatile uint32 *                CanConst ptu4RMNDt;
    volatile uint32 *                CanConst ptu4RFCCx;
    volatile uint32 *                CanConst ptu4RFSTSx;
    volatile uint32 *                CanConst ptu4RFPCTRx;
    ...
    volatile uint32 *                CanConst ptu4GTINTSTSs;
    ...
    volatile uint32 *                CanConst ptu4RPGACCr;
...
typedef struct
{
    uint32 u4GAFLIDjConf;
    uint32 u4GAFLP0jConf;
    uint32 u4GAFLP1jConf;
    uint8  u1RxMaskRef;
