...
#define AR_OS_NUM_TASKS                                     ((uint16)0x0004U)
...
#define AR_OS_NUM_TASKS_PER_CORE_MAX                        (4)
#define AR_OS_ACT_COUNT_PER_CORE_MAX                        (7)
...
#define eMCOS_TASK_Low                                      (AR_OS_NUM_EXTEND_TASKS + ((uint16)0x0002U))
#define eMCOS_TASK_Medium                                   (AR_OS_NUM_EXTEND_TASKS + ((uint16)0x0003U))
