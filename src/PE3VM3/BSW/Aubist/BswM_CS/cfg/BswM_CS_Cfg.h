...
#define BSW_BSWM_CS_CFG_FUNC_CANTX            (BSW_NOUSE)
...
#define BswM_CSConf_SysStatusName_Special                   (BSW_BSWM_CS_SYSSTAT_USER3)
#define BswM_CSConf_SysStatusName_NM_0                      (BSW_BSWM_CS_SYSSTAT_USER29)
