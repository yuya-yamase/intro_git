...
#define OXCAN_SYS_IGR                            (0x00000010U)    /* Ignition"R"-ON            IG voltage >= 7 volt               */

#define OXCAN_SYS_NM_0                           (0x80000000U)    /* VCAN BUS                                                     */

#define OXCAN_SYS_FIELDS                         (0x8000001fU)    /* VCAN BUS                                                     */
