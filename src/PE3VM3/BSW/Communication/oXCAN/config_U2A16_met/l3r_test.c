...
/*  Literal Definitions                                                                                                              */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define L3R_TEST_PDU_TX                          (MSG_AVN1SH1_TXCH0)  /* CAN-ID 0x2E3                   */
#define L3R_TEST_LTX_DLC_MAX                     (32U)                /* data length of L3R_TEST_PDU_TX */
#define L3R_TEST_LTX_RXC_MAX                     (15U)                /* (32 byte - 2 byte) / 2 byte    */
