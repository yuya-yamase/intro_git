...
#define SPI_UCFG_MODEA_CH0_COREID			(BSW_CORE_ID_CORE3)
...
#define SPI_COMC_ID_SOC_MCU3				(0)

#define SPI_UCFG_MODEC_CHANNEL_NUM			(1)

#define SPI_UCFG_MODEC_CH0_HARDCH			(PIL_SPI_CH4_0)
...
#define SPI_UCFG_MODEC_CH0_COREID			(BSW_CORE_ID_CORE3)
