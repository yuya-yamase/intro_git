...
*/
/****************************************************************************
 [ ehvm_cfg_pe3_vm0.h ] - EHVM module's configuration data file
****************************************************************************/

#ifndef EHVM_CFG_PE3_VM0_H
#define EHVM_CFG_PE3_VM0_H
...
/* ehvm_vcc_transmit */
#define EHVM_TX_VCCID_VCCBUFFER_3_SLEEPSTATUS_VM3_TOMASTER ((ehvm_uint32_t)3U)
#define EHVM_TX_VCCID_VCCBUFFER_7_VM3_TOOTHERS ((ehvm_uint32_t)7U)
#define EHVM_TX_VCCID_VCCBUFFER_11_VM3_TOOTHERVM ((ehvm_uint32_t)11U)
#define EHVM_TX_VCCID_VCCBUFFER_15_VM3_TOVM1_2 ((ehvm_uint32_t)15U)
#define EHVM_TX_VCCID_VCC_SHARED_TX_VM3 ((ehvm_uint32_t)19U)

#define EHVM_TX_VCCID_VCCBUFFER_3_SLEEPSTATUS_VM3_TOMASTER_MAX ((ehvm_uint32_t)0x00000004U)
#define EHVM_TX_VCCID_VCCBUFFER_7_VM3_TOOTHERS_MAX ((ehvm_uint32_t)0x00000048U)
#define EHVM_TX_VCCID_VCCBUFFER_11_VM3_TOOTHERVM_MAX ((ehvm_uint32_t)0x00000004U)
#define EHVM_TX_VCCID_VCCBUFFER_15_VM3_TOVM1_2_MAX ((ehvm_uint32_t)0x00000004U)
#define EHVM_TX_VCCID_VCC_SHARED_TX_VM3_MAX ((ehvm_uint32_t)0x00000100U)
...
#define EHVM_RX_VCCID_VCCBUFFER_13_VM1_TOVM3 ((ehvm_uint32_t)13U)
#define EHVM_RX_VCCID_VCCBUFFER_14_VM2_TOVM3 ((ehvm_uint32_t)14U)
...
#define EHVM_RX_VCCID_VCCBUFFER_13_VM1_TOVM3_MAX ((ehvm_uint32_t)0x00000004U)
#define EHVM_RX_VCCID_VCCBUFFER_14_VM2_TOVM3_MAX ((ehvm_uint32_t)0x00000004U)
...
#define EHVM_PE3_VM0_CTL_WAKEUP_FACTOR_A0_BIT_NUM_4  ((ehvm_uint32_t)4U)
#define EHVM_PE3_VM0_CTL_WAKEUP_FACTOR_A0_BIT_NUM_31  ((ehvm_uint32_t)31U)

/* ehvm_vwdt_set_mode,ehvm_vwdt_set_trigger_condition */

/* ehvm_vwdt_set_trigger_condition */

#endif /* EHVM_CFG_PE3_VM0_H */
