...
#define PWRCTRL_NOREDUN_WAIT_MBPWR_OFF_TIME         (2050U  / PWRCTRL_CFG_TASK_TIME )
...
#define PWRCTRL_NOREDUN_WAIT_DISP_OFF_TIME          (2050U  / PWRCTRL_CFG_TASK_TIME )
...
#define PWRCTRL_NOREDUN_WAIT_HUB_PWROFF_TIME        (60050U / PWRCTRL_CFG_TASK_TIME )
