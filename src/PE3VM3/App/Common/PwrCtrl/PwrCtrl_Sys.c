...
static void vd_s_PwrCtrlSysPwrOffFlw( void )
{
    ...
    case PWRCTRL_COMMON_PROCESS_STEP2:
        ...
        vd_g_Pwm_SetPeriodAndDuty((U1)PWM_CH_00_DDC_FREQ , (U2)PWRCTRL_SYS_PWM_PERIOD, (U2)0U);
        vd_g_Pwm_SetPeriodAndDuty((U1)PWM_CH_02_DDC_ASIL_FREQ , (U2)PWRCTRL_SYS_PWM_PERIOD, (U2)0U);
