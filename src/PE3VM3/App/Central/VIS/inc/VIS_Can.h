...
#define VIS_CAN_ODO_LSB                         (U1)(10U)           /* LSB変換(1km→0.1km) */
#define VIS_CAN_ODO_MILE_TO_KM                  (U1)(161U)          /* Mile→km変換値 */
#define VIS_CAN_ODO_MAX                         (U1)(9999990U)      /* オドメータ情報最大値(LSB0.1km) */
#define VIS_CAN_ODO_MASK                        (U1)(0x000000FF)    /* オドメータ情報マスク値 */
#define VIS_CAN_ODO_FAIL                        (U1)(0x00000000U)   /* オドメータ情報Fail値 */

/* 時間情報 */
#define VIS_CAN_TRIP_MASK                       (U1)(0x00FF)        /* Tripカウンタ情報マスク値 */
#define VIS_CAN_TRIP_FAIL                       (U1)(0xFFFFU)       /* TripカウンタFail値 */

/* 車速 */
#define VIS_CAN_SPD_MAX                         (U1)(0x00FFU)       /* 車速最大値 */
#define VIS_CAN_SPD_LSB                         (U1)(100U)          /* LSB変換(0.01km/h→1km/h) */
