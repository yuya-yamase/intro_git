...
#define VIS_CAN_TRANSREQ_DATA_YEAR              ((U1)5U)            /* チップ間通信：年情報格納領域 */
#define VIS_CAN_TRANSREQ_DATA_MONT              ((U1)4U)            /* チップ間通信：月情報格納領域 */
#define VIS_CAN_TRANSREQ_DATA_DAY               ((U1)3U)            /* チップ間通信：日情報格納領域 */
#define VIS_CAN_TRANSREQ_DATA_HOUR              ((U1)2U)            /* チップ間通信：時情報格納領域 */
#define VIS_CAN_TRANSREQ_DATA_MIN               ((U1)1U)            /* チップ間通信：分情報格納領域 */
#define VIS_CAN_TRANSREQ_DATA_SEC               ((U1)0U)            /* チップ間通信：秒情報格納領域 */
