...
#define CHIPCOM_LENGTH_VIS_TRIP                ((uint16)2U)
...
#define CHIPCOM_POS_TX_VIS_SPD                 ((uint16)210U)
#define CHIPCOM_POS_TX_VIS_RDYSTS              ((uint16)211U)
#define CHIPCOM_POS_TX_VIS_BASICSTATE          ((uint16)212U)
#define CHIPCOM_POS_TX_VIS_SPECIALSTATE        ((uint16)214U)
#define CHIPCOM_POS_TX_VIS_TRANSFLG            ((uint16)216U)
#define CHIPCOM_POS_TX_VIS_OTASWACT            ((uint16)218U)
#define CHIPCOM_POS_TX_VIS_PWRERRST            ((uint16)220U)
#define CHIPCOM_POS_TX_VIS_CRLYOF              ((uint16)222U)
#define CHIPCOM_POS_TX_VIS_VIN                 ((uint16)224U)
#define CHIPCOM_POS_TX_VIS_COMPWR              ((uint16)242U)
#define CHIPCOM_POS_TX_EVENTDATA_OFFSET        ((uint16)243U)
...
#define CHIPCOM_POS_RX_EVENTDATA_OFFSET        ((uint16) 38U)
...
#define CHIPCOM_POS_TX_EVENTDATA_OFFSET        ((uint16) 38U)
...
#define CHIPCOM_POS_RX_VIS_SPD                 ((uint16)210U)
#define CHIPCOM_POS_RX_VIS_RDYSTS              ((uint16)211U)
#define CHIPCOM_POS_RX_VIS_BASICSTATE          ((uint16)212U)
#define CHIPCOM_POS_RX_VIS_SPECIALSTATE        ((uint16)214U)
#define CHIPCOM_POS_RX_VIS_TRANSFLG            ((uint16)216U)
#define CHIPCOM_POS_RX_VIS_OTASWACT            ((uint16)218U)
#define CHIPCOM_POS_RX_VIS_PWRERRST            ((uint16)220U)
#define CHIPCOM_POS_RX_VIS_CRLYOF              ((uint16)222U)
#define CHIPCOM_POS_RX_VIS_VIN                 ((uint16)224U)
#define CHIPCOM_POS_RX_VIS_COMPWR              ((uint16)242U)
#define CHIPCOM_POS_RX_EVENTDATA_OFFSET        ((uint16)243U)
#endif
