...
uint8 ChipCom_Initval_Vsm_SleepNg                       [CHIPCOM_LENGTH_VSM_SLEEPNG                     ] = {
    0x01
};
uint8 ChipCom_Initval_EtherSwt_Swic_LinkInfo            [CHIPCOM_LENGTH_ETHERSWT_SWIC_LINKINFO          ] = {
    0x01, 0x00,
    0x01, 0x00,
    0x01, 0x00,
    0x01, 0x00,
...
uint8 ChipCom_Initval_EtherSwt_Swic_MIB                 [CHIPCOM_LENGTH_ETHERSWT_SWIC_MIB               ] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
uint8 ChipCom_Initval_EtherSwt_Swic_SQI                 [CHIPCOM_LENGTH_ETHERSWT_SWIC_SQI               ] = {
    0x01, 0x00,
    0x01, 0x00,
    0x00, 0x00, 0x00, 0x00
};
uint8 ChipCom_Initval_EtherSwt_Swic_DataUsageExceed     [CHIPCOM_LENGTH_ETHERSWT_SWIC_DATAUSAGEEXCEED   ] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00
};
...
PeriodicTable PeriodicRelation[CHIPCOM_PERIODICID_MAX] = {
    ...
    {CHIPCOM_PERIODICID_VSM_SLEEPNG                     ,   CHIPCOM_LENGTH_VSM_SLEEPNG                      , CHIPCOM_POS_TX_VSM_SLEEPNG                    , CHIPCOM_POS_RX_VSM_SLEEPNG                    , ChipCom_Initval_Vsm_SleepNg                   },
    {CHIPCOM_PERIODICID_ETHERSWT_SWIC_LINKINFO          ,   CHIPCOM_LENGTH_ETHERSWT_SWIC_LINKINFO           , CHIPCOM_POS_TX_ETHERSWT_SWIC_LINKINFO         , CHIPCOM_POS_RX_ETHERSWT_SWIC_LINKINFO         , ChipCom_Initval_EtherSwt_Swic_LinkInfo        },
