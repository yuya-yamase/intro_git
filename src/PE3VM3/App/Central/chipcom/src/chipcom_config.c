...
NotifcataionTable NotificationFunction[CHIPCOM_DATAID_MAX] = {
    ...
    {CHIPCOM_DATAID_CANIFPROXY_CANCELTRANSMIT  ,  CanIfProxy_CancelTransmit         },   /* MCU receive     CanIfProxy_CancelTransmit*/
    ...
    {CHIPCOM_DATAID_ETHERSWT_RIDCLEAR          ,  EthSwt_SWIC_Reg_RidClear          },   /* MCU receive     EthSwt_SWIC_Reg_RidClear */
    {CHIPCOM_DATAID_VIS_TIME                   ,  Vis_TimeStsReq                    },   /* MCU receive     Vis_TimeStsReq */
};
#else /* SAIL ChipCom */
NotifcataionTable NotificationFunction[CHIPCOM_DATAID_MAX] = {
    /* {DataId,                                   FunctionPtr} */
    ...
    {CHIPCOM_DATAID_CANTP_TPTXCONF             ,  CanIfStub_TxConfiramtion          },   /* SAIL receive     CanIfStub_TxConfiramtion */
