...
#define D_ETHSWT_SWIC_PWR_ST_WAITON             (1U)
#define D_ETHSWT_SWIC_PWR_ST_ON                 (2U)
#define D_ETHSWT_SWIC_PWR_ST_RESET_ASSERT       (3U)
#define D_ETHSWT_SWIC_PWR_ST_RESET_DEASSERT     (4U)
#define D_ETHSWT_SWIC_PWR_ST_NUM                (5U)

#define D_ETHSWT_SWIC_PWR_EV_START              (0U)
#define D_ETHSWT_SWIC_PWR_EV_PMIC_DONE          (1U)
#define D_ETHSWT_SWIC_PWR_EV_RESET              (2U)
#define D_ETHSWT_SWIC_PWR_EV_ASSERT_DONE        (3U)
#define D_ETHSWT_SWIC_PWR_EV_DEASSERT_DONE      (4U)
#define D_ETHSWT_SWIC_PWR_EV_STOP               (5U)
#define D_ETHSWT_SWIC_PWR_EV_NUM                (6U)
...
void EthSwt_SWIC_PWR_Init(void)
{
    ...
    EthSwt_SWIC_SetPowerOff();             /* OEM Config */
...
static void ethswt_swic_pwr_stm (uint32 event)
{
    static const SWIC_PWR_ACT   action_tbl[D_ETHSWT_SWIC_PWR_EV_NUM][D_ETHSWT_SWIC_PWR_ST_NUM] =
                        /*  { { S1:ST_OFF                     , S2:ST_WAITON                  , S3:ST_ON                          , S4:ST_RESET_ASSERT                , S5:ST_RESET_DEASSERT          }}*/
    /* EV_START         */  { { ethswt_swic_pwr_act_powerOn   , ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_none      }
    /* EV_PMIC_DONE     */  , { ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_setSpiMode, ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_none      }
    /* EV_RESET         */  , { ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_resetAssert   , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_none      }
    /* EV_ASSERT_DONE   */  , { ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_resetDeassert , ethswt_swic_pwr_act_none      }
    /* EV_DEASSERT_DONE */  , { ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_none      , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_none          , ethswt_swic_pwr_act_resume    }
    /* EV_STOP          */  , { ethswt_swic_pwr_act_powerOff  , ethswt_swic_pwr_act_powerOff  , ethswt_swic_pwr_act_powerOff      , ethswt_swic_pwr_act_powerOff      , ethswt_swic_pwr_act_powerOff  }
                            };
...
static uint32 ethswt_swic_pwr_act_powerOn (void)
{
    EthSwt_SWIC_SetPowerOn();              /* OEM Config */
