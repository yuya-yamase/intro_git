...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define BSW_M_C_MAJOR                            (1)
#define BSW_M_C_MINOR                            (11)
#define BSW_M_C_PATCH                            (0)
...
/*  Version Check                                                                                                                    */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if ((BSW_M_C_MAJOR != BSW_M_H_MAJOR) || \
     (BSW_M_C_MINOR != BSW_M_H_MINOR) || \
     (BSW_M_C_PATCH != BSW_M_H_PATCH))
#error "bsw_m.c and bsw_m.h : source and header files are inconsistent!"
#endif

#if ((BSW_M_C_MAJOR != BSW_M_CFG_H_MAJOR) || \
     (BSW_M_C_MINOR != BSW_M_CFG_H_MINOR) || \
     (BSW_M_C_PATCH != BSW_M_CFG_H_PATCH))
#error "bsw_m.c and bsw_m_cfg_private.h : source and config files are inconsistent!"
#endif
...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
static U4     u4_s_bsw_m_shtdwndlycnt;                           /* Shutdown Delay Timer/Counter   */
static U1     u1_s_bsw_m_shtdwnrqst;
...
void    vd_g_BswMInit(void)
{
    u4_s_bsw_m_shtdwndlycnt = (U4)U4_MAX;
    u1_s_bsw_m_shtdwnrqst   = (U1)FALSE;

    vd_g_BswMCfgInit();
}
/*===================================================================================================================================*/
/*  void    vd_g_BswMMainTask(void)                                                                                                  */
/* --------------------------------------------------------------------------------------------------------------------------------- */
/*  Arguments:      -                                                                                                                */
/*  Return:         -                                                                                                                */
/*===================================================================================================================================*/
void    vd_g_BswMMainTask(void)
{
    ...
    if(u4_s_bsw_m_shtdwndlycnt > (U4)U2_MAX){
        u4_s_bsw_m_shtdwndlycnt = (U4)0U;
    }
    else if(u4_s_bsw_m_shtdwndlycnt >= (U4)u2_g_BSW_M_TIMOUT_TO_SHTDWN){
        u4_s_bsw_m_shtdwndlycnt = (U4)u2_g_BSW_M_TIMOUT_TO_SHTDWN;
    }
    else{
        u4_s_bsw_m_shtdwndlycnt++;
    }

    u1_t_shtdwn_1st  = u1_g_BswMCfghkShtdwnchk1st();
    u1_t_shtdwn_1st &= u1_g_BswMCfgWksrcIrqchk();
    vd_g_BswMCfgWksrcCfgRefresh();
    ...
    u1_t_shtdwn_2nd = u1_g_BswMCfghkShtdwnchk2nd(u1_t_shtdwn_1st, (U2)u4_s_bsw_m_shtdwndlycnt);
    u1_s_bsw_m_shtdwnrqst = u1_t_shtdwn_1st & u1_t_shtdwn_2nd;
}
/*===================================================================================================================================*/
/*  U1      u1_g_BswMShtdwnRqst(void)                                                                                                */
/* --------------------------------------------------------------------------------------------------------------------------------- */
/*  Arguments:      -                                                                                                                */
/*  Return:         -                                                                                                                */
/*===================================================================================================================================*/
U1      u1_g_BswMShtdwnRqst(void)
{
    ...
    u1_t_shtdwn = u1_g_BswMCfgWksrcIrqchk();
    if(u1_t_shtdwn != (U1)TRUE){
        u4_s_bsw_m_shtdwndlycnt = (U4)U4_MAX;
        u1_s_bsw_m_shtdwnrqst   = (U1)FALSE;
    }

    return(u1_s_bsw_m_shtdwnrqst);
}
/*===================================================================================================================================*/
/*                                                                                                                                   */
/*  Change History                                                                                                                   */
