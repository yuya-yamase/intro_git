...
#ifndef XSPI_IVI_SUB1_CONTROL_H
#define XSPI_IVI_SUB1_CONTROL_H

/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define XSPI_IVI_SUB1_CONTROL_H_MAJOR           (0)
#define XSPI_IVI_SUB1_CONTROL_H_MINOR           (0)
#define XSPI_IVI_SUB1_CONTROL_H_PATCH           (0)
