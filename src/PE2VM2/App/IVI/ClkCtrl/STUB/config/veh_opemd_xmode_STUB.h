...
/*  Literal Definitions                                                                                                              */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define VEH_OPEMD_MDBIT_STUB_ACC                 (0x00000001U)  /* ACC        */
...
#define VEH_OPEMD_EVTBIT_IGN_TO_ON               (VEH_OPEMD_EVBIT_IG_R_TO_ON)
#define VEH_OPEMD_EVTBIT_IGN_TO_OFF              (VEH_OPEMD_EVBIT_IG_R_TO_OFF)
