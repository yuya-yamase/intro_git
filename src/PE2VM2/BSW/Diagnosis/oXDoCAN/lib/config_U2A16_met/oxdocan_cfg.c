...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#if 0   /* @todo T.inoue start: 20250415 Not yet supported. */
#include "tydocan_dtc_ma_cfg_private.h"
#include "tydocan_xid_ma_cfg_private.h"
#include "SchM_IdsM.h"
#endif  /* @todo T.inoue end: 20250415 Not yet supported. */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
...
#endif
/*    vd_g_oXDoCANWrbyIdInit();*//* @todo T.inoue : 20250415 Not yet supported. */
#if(OXDC_SID2F_USE == OXDC_USE)
    vd_g_oXDoCANIocInit();
#endif
/*    vd_g_oXDoCANRoutInit();*//* @todo T.inoue : 20250415 Not yet supported. */
...
/*    vd_g_oXDoCANRoutCfgInit();*//* @todo T.inoue : 20250415 Not yet supported. */
}
/*===================================================================================================================================*/
...
#endif
/*    vd_g_oXDoCANWrbyIdMainTask(st_ap_REQ, st_ap_ans);*//* SID 0x2E *//* @todo T.inoue : 20250415 Not yet supported. */
#if(OXDC_SID2F_USE == OXDC_USE)
    vd_g_oXDoCANIocMainTask(st_ap_REQ, st_ap_ans);     /* SID 0x2F */
#endif
/*    vd_g_oXDoCANRoutMainTask(st_ap_REQ, st_ap_ans);*//* SID 0x31 *//* @todo T.inoue : 20250415 Not yet supported. */
#if(OXDC_SIDBA_USE == OXDC_USE)
...
void    vd_g_oXDoCANCfgSesChange(const uint8 u1_a_OLD, const uint8 u1_a_NEW)
{
    ...
    vd_g_TyDoCANSecurityAesSeedKeyClear();
#endif  /* @todo T.inoue end: 20250415 Not yet supported. */
}
/*===================================================================================================================================*/
...
U2      u2_g_oXDoCANCfgKmph(void)
{
    ...
    u2_t_sp1     = (U2)0U;
    u1_t_rx_stat = u1_g_oXCANRxdStat((U2)OXCAN_RXD_PDU_CAN_VSC1G13_CH0, (U2)OXCAN_SYS_VDC, u2_s_OXDC_KMPH_RX_TOUT)
                 & ((U1)COM_NO_RX | (U1)COM_TIMEOUT);
    ...
    return(u2_t_kmph);
#endif
    return((U2)0U);	/* @todo T.inoue end: 20250415 Not yet supported. */
#else
    return((U2)0U);
#endif
}
