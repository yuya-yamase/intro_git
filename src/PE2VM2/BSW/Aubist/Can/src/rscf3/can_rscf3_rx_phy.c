/* can_rscf3_rx_phy_c_m10700_v3-0-0                                         */
/****************************************************************************/
/* Protected                                                                */
...
/****************************************************************************/
/* Object Name  | CAN/RSCF3/RX/PHYSICAL/CODE                                */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/
...
Can_rx_ChkRxFinMbox( uint8 u1Controller, uint8 u1Kind )
{
    ...
    uint32                          u4Data[ CAN_TB_MB_DATA_ARYSIZE ];    /* 受信データ取得用             */
    ...
    for ( u1Count = (uint8)0U; u1Count < u1MsgNum; u1Count++ )
    {
        ...
        {   /* CAN FDフレームの場合    */
            /* データフィールドの読み出し回数を設定 */
            u1DataReadSize = Can_tb_u1FifoReadSize[ u1Controller ][ u1TRxFifoIdx ];
