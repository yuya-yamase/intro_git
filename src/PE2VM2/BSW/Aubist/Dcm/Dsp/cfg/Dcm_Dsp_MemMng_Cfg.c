...
CONST( AB_83_ConstV uint32, DCM_CONFIG_DATA ) Dcm_Dsp_MemMng_u4MaxReadMemorySize = (uint32)0xFFFFFFFFU;
#endif /* DCM_SUPPORT_SID2C == STD_ON || DCM_SUPPORT_SID23 == STD_ON */
#if ( DCM_SUPPORT_SID3D == STD_ON )
CONST( AB_83_ConstV uint32, DCM_CONFIG_DATA ) Dcm_Dsp_MemMng_u4MaxWriteMemorySize = (uint32)0xFFFFFFFFU;
