/* Dcm_Main_EvtDistr_Cfg_h(v5-5-0)                                          */
/****************************************************************************/
/* Protected                                                                */
...
/* Macros                                                                   */
/*--------------------------------------------------------------------------*/
#define DCM_M_EVTDISTR_QUEUE_DSL_MAX    ((uint8)0x0EU)      /* Queue length limit DSL */
...
#define DCM_M_EVTDISTR_DEFINED_LAST_ID      ((uint8)98U)
#define DCM_M_EVTDISTR_DEFINED_ALL_ID_NUM   ((uint8)(DCM_M_EVTDISTR_DEFINED_LAST_ID + (uint8)1U))
#define DCM_M_EVTDISTR_ID_NUM               ((uint8)10U)     /* Event ID number */
...
#define DCM_M_EVTID_SID04_ALLCLEARDTC       (DCM_M_EVTDISTR_ID_010)
#define DCM_M_EVTID_SID09_GET_INFOTYPE      (DCM_M_EVTDISTR_ID_011)
#define DCM_M_EVTID_SID10_SETPROG           (DCM_M_EVTDISTR_ID_012)
#define DCM_M_EVTID_SID10_CHKSESCTRL        (DCM_M_EVTDISTR_ID_013)
#define DCM_M_EVTID_SID11_GETPRERESET       (DCM_M_EVTDISTR_ID_014)
#define DCM_M_EVTID_SID14_CLEARDTC          (DCM_M_EVTDISTR_ID_015)
#define DCM_M_EVTID_SID19_SUB01_GETNOD      (DCM_M_EVTDISTR_ID_016)
#define DCM_M_EVTID_SID19_SUB02_GETSIZE     (DCM_M_EVTDISTR_ID_017)
#define DCM_M_EVTID_SID19_SUB02_GETDTC      (DCM_M_EVTDISTR_ID_018)
#define DCM_M_EVTID_SID19_SUB03_GETRECORD   (DCM_M_EVTDISTR_ID_019)
#define DCM_M_EVTID_SID19_SUB04_DISREC      (DCM_M_EVTDISTR_ID_020)
#define DCM_M_EVTID_SID19_SUB04_GETSTS      (DCM_M_EVTDISTR_ID_021)
#define DCM_M_EVTID_SID19_SUB04_GETSIZE     (DCM_M_EVTDISTR_ID_022)
#define DCM_M_EVTID_SID19_SUB04_RMNASIZE    (DCM_M_EVTDISTR_ID_023)
#define DCM_M_EVTID_SID19_SUB04_GETFFDT     (DCM_M_EVTDISTR_ID_024)
#define DCM_M_EVTID_SID19_SUB05_STDSDATA    (DCM_M_EVTDISTR_ID_025)
#define DCM_M_EVTID_SID19_SUB05_GETSIZE     (DCM_M_EVTDISTR_ID_026)
#define DCM_M_EVTID_SID19_SUB05_GETDSDT     (DCM_M_EVTDISTR_ID_027)
#define DCM_M_EVTID_SID19_SUB06_DISREC      (DCM_M_EVTDISTR_ID_028)
#define DCM_M_EVTID_SID19_SUB06_GETEDR      (DCM_M_EVTDISTR_ID_029)
#define DCM_M_EVTID_SID19_SUB0A_GETSIZE     (DCM_M_EVTDISTR_ID_030)
#define DCM_M_EVTID_SID19_SUB0A_GETDTC      (DCM_M_EVTDISTR_ID_031)
#define DCM_M_EVTID_SID19_SUB17_GETSIZE     (DCM_M_EVTDISTR_ID_032)
#define DCM_M_EVTID_SID19_SUB17_GETDTC      (DCM_M_EVTDISTR_ID_033)
#define DCM_M_EVTID_SID19_SUB18_DISREC      (DCM_M_EVTDISTR_ID_034)
#define DCM_M_EVTID_SID19_SUB18_GETSTS      (DCM_M_EVTDISTR_ID_035)
#define DCM_M_EVTID_SID19_SUB18_GETSIZE     (DCM_M_EVTDISTR_ID_036)
#define DCM_M_EVTID_SID19_SUB18_GETFFDT     (DCM_M_EVTDISTR_ID_037)
#define DCM_M_EVTID_SID19_SUB19_DISREC      (DCM_M_EVTDISTR_ID_038)
#define DCM_M_EVTID_SID19_SUB19_GETEDR      (DCM_M_EVTDISTR_ID_039)
#define DCM_M_EVTID_SID19_SUB1A_GETDTC      (DCM_M_EVTDISTR_ID_040)
#define DCM_M_EVTID_SID19_SUB42_GETSIZE     (DCM_M_EVTDISTR_ID_041)
#define DCM_M_EVTID_SID19_SUB42_GETDTC      (DCM_M_EVTDISTR_ID_042)
#define DCM_M_EVTID_SID19_SUB55_GETDTC      (DCM_M_EVTDISTR_ID_043)
#define DCM_M_EVTID_SID22_DIDAVAILABLE      (DCM_M_EVTDISTR_ID_044)
#define DCM_M_EVTID_SID22_RANGE_DATA_LEN    (DCM_M_EVTDISTR_ID_045)
#define DCM_M_EVTID_SID22_CHKSUP_CYCLE      (DCM_M_EVTDISTR_ID_046)
#define DCM_M_EVTID_SID22_READ_DID_DATA     (DCM_M_EVTDISTR_ID_047)
#define DCM_M_EVTID_SID22_READ_CYCLE        (DCM_M_EVTDISTR_ID_048)
#define DCM_M_EVTID_SID22_UPDATEPAGE        (DCM_M_EVTDISTR_ID_049)
#define DCM_M_EVTID_SID22_UPDATERCRRP       (DCM_M_EVTDISTR_ID_050)
#define DCM_M_EVTID_SID23_READMEM           (DCM_M_EVTDISTR_ID_051)
#define DCM_M_EVTID_SID23_UPDATEPAGE        (DCM_M_EVTDISTR_ID_052)
#define DCM_M_EVTID_SID27_GET_SEED          (DCM_M_EVTDISTR_ID_053)
#define DCM_M_EVTID_SID27_COMPARE_KEY       (DCM_M_EVTDISTR_ID_054)
#define DCM_M_EVTID_SID27_READCONF          (DCM_M_EVTDISTR_ID_055)
#define DCM_M_EVTID_SID28_COMPCOMCTRL       (DCM_M_EVTDISTR_ID_056)
#define DCM_M_EVTID_SID29_VRFYCERTUNIDIR    (DCM_M_EVTDISTR_ID_057)
#define DCM_M_EVTID_SID29_VRFYCERTBIDIR     (DCM_M_EVTDISTR_ID_058)
#define DCM_M_EVTID_SID29_VRFYPOWN          (DCM_M_EVTDISTR_ID_059)
#define DCM_M_EVTID_SID2A_DIDAVAILABLE      (DCM_M_EVTDISTR_ID_060)
#define DCM_M_EVTID_SID2A_RANGE_DATA_LEN    (DCM_M_EVTDISTR_ID_061)
#define DCM_M_EVTID_SID2C_DIDAVAILABLE      (DCM_M_EVTDISTR_ID_062)
#define DCM_M_EVTID_SID2C_CHKPOSSIZE        (DCM_M_EVTDISTR_ID_063)
#define DCM_M_EVTID_SID2E_DIDAVAILABLE      (DCM_M_EVTDISTR_ID_064)
#define DCM_M_EVTID_SID2E_RANGE_DATA_LEN    (DCM_M_EVTDISTR_ID_065)
#define DCM_M_EVTID_SID2E_WRITE_DID_DATA    (DCM_M_EVTDISTR_ID_066)
#define DCM_M_EVTID_SID2F_IO_CONTROL        (DCM_M_EVTDISTR_ID_067)
#define DCM_M_EVTID_SID2F_READ_DATA         (DCM_M_EVTDISTR_ID_068)
#define DCM_M_EVTID_SID31_EXECUTE           (DCM_M_EVTDISTR_ID_069)
#define DCM_M_EVTID_SID31_UPDATEPAGE        (DCM_M_EVTDISTR_ID_070)
#define DCM_M_EVTID_SID31_UPDATERCRRP       (DCM_M_EVTDISTR_ID_071)
#define DCM_M_EVTID_SID34_CHKDFID           (DCM_M_EVTDISTR_ID_072)
#define DCM_M_EVTID_SID34_PROCREQDL         (DCM_M_EVTDISTR_ID_073)
#define DCM_M_EVTID_SID35_CHKDFID           (DCM_M_EVTDISTR_ID_074)
#define DCM_M_EVTID_SID35_PROCREQUL         (DCM_M_EVTDISTR_ID_075)
#define DCM_M_EVTID_SID36_CHKMSGLEN         (DCM_M_EVTDISTR_ID_076)
#define DCM_M_EVTID_SID36_CHKREQSEQUENCE    (DCM_M_EVTDISTR_ID_077)
#define DCM_M_EVTID_SID36_CHKREQSEQUENCEUL  (DCM_M_EVTDISTR_ID_078)
#define DCM_M_EVTID_SID36_CHKTFRDATSUSPEND  (DCM_M_EVTDISTR_ID_079)
#define DCM_M_EVTID_SID36_CHKTFRDATSUSPENDUL (DCM_M_EVTDISTR_ID_080)
#define DCM_M_EVTID_SID36_PROCTFRDATAWRITE  (DCM_M_EVTDISTR_ID_081)
#define DCM_M_EVTID_SID36_PROCTFRDATAREAD   (DCM_M_EVTDISTR_ID_082)
#define DCM_M_EVTID_SID37_CHKPROGPROCFIN    (DCM_M_EVTDISTR_ID_083)
#define DCM_M_EVTID_SID37_PROCREQTFREXIT    (DCM_M_EVTDISTR_ID_084)
#define DCM_M_EVTID_SID85_SUB01_ENA_DTC     (DCM_M_EVTDISTR_ID_085)
#define DCM_M_EVTID_SID85_SUB02_DIS_DTC     (DCM_M_EVTDISTR_ID_086)
#define DCM_M_EVTID_SID86_SERVTORESPTO      (DCM_M_EVTDISTR_ID_087)
#define DCM_M_EVTID_SID86_RESPQUEOVER       (DCM_M_EVTDISTR_ID_088)
#define DCM_M_EVTID_SID86_READCOMP          (DCM_M_EVTDISTR_ID_089)
#define DCM_M_EVTID_SIDA4_CLEARDTC          (DCM_M_EVTDISTR_ID_090)
#define DCM_M_EVTID_SIDA4_CLEAROBS          (DCM_M_EVTDISTR_ID_091)
#define DCM_M_EVTID_SIDBA_GETBEHAVIORMEMORY (DCM_M_EVTDISTR_ID_092)
#define DCM_M_EVTID_DSL_TXIFRETRY           (DCM_M_EVTDISTR_ID_093)
#define DCM_M_EVTID_STORAGEMNG_READALL      (DCM_M_EVTDISTR_ID_094)
#define DCM_M_EVTID_STORAGEMNG_READBLOCK    (DCM_M_EVTDISTR_ID_095)
#define DCM_M_EVTID_STORAGEMNG_WRITEGETSTS  (DCM_M_EVTDISTR_ID_096)
#define DCM_M_EVTID_STORAGEMNG_WRITEDEQ     (DCM_M_EVTDISTR_ID_097)
#define DCM_M_EVTID_STORAGEMNG_WRITERETRY   (DCM_M_EVTDISTR_ID_098)
