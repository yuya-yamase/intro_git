...
#define		ADC_VCR_GCTRL_0					(BIT0)			/* General Control */
	...
	#define		ADC_VCR_GCTRL_AVREFH_3_4		(0x0CU)		/* AVREFH×3/4 */
	#define		ADC_VCR_GCTRL_AVREFH_1_2		(0x08U)		/* AVREFH×1/2 */
	#define		ADC_VCR_GCTRL_AVREFH_1_4		(0x04U)		/* AVREFH×1/4 */
	#define		ADC_VCR_GCTRL_AVREFH_0			(0x00U)		/* AVREFH×0 */
