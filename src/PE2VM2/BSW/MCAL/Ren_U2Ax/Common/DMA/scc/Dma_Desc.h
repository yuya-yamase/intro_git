...
#define u2_DMAC_DESC_RAM_OFFSET         ((U2)5)
...
#define u2_DMAC_DESC_PTR_CH_P_0         (u2_DMAC_DESC_RAM_ADDR_0_6)
#define u2_DMAC_DESC_PTR_CH_P_1         (u2_DMAC_DESC_RAM_ADDR_0_6 + u2_DMAC_DESC_RAM_OFFSET)

#define u2_DMAC_DESC_PTR_CH_N_0         (u2_DMAC_DESC_RAM_ADDR_0_7)
#define u2_DMAC_DESC_PTR_CH_N_1         (u2_DMAC_DESC_RAM_ADDR_0_7 + u2_DMAC_DESC_RAM_OFFSET)

#define u2_DMAC_DESC_PTR_MASTER_0       (u2_DMAC_DESC_RAM_ADDR_0_8)
#define u2_DMAC_DESC_PTR_MASTER_1       (u2_DMAC_DESC_RAM_ADDR_0_8 + u2_DMAC_DESC_RAM_OFFSET)	
