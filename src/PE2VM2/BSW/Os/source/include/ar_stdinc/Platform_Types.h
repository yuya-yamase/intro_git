...
#if defined __ghs__
#if defined __V850__
#include "arch/v850/Platform_Types_v850_ghs.h"
#elif defined __Tricore /* #if defined __V850__ */
#include "arch/tc162/Platform_Types_tc162_ghs.h"
#elif defined __ARM__ /* #elif defined __Tricore */
#include "arch/armv7m/Platform_Types_armv7m_ghs.h"
#endif /* #elif defined __ARM__ */


#elif defined __GNUC__ && !defined __ARMCC_VERSION  /* #if defined __ghs__ */
#if defined __V850__
#include "arch/v850/Platform_Types_v850_gcc.h"
...
#include "arch/armv8r/Platform_Types_armv8r_armclang.h"
#else /* #if __ARMCC_VERSION >= 6000000U */
#include "arch/arm/Platform_Types_arm_armct.h"
#endif /* #if __ARMCC_VERSION >= 6000000U */
#elif defined __aarch64__
#if __ARMCC_VERSION >= 6000000U
#include "arch/arm/Platform_Types_arm_armclang.h"
#else /* #if __ARMCC_VERSION >= 6000000U */
#include "arch/arm/Platform_Types_arm_armct.h"
#endif /* #if __ARMCC_VERSION >= 6000000U */
