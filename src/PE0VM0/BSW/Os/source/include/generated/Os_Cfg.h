 ...
 */
/* Category 2 ISRs */
#define INTRIIC0EE_ISR                                      ((uint16)0x0000U)
#define INTRIIC0RI_ISR                                      ((uint16)0x0001U)
#define INTRIIC0TI_ISR                                      ((uint16)0x0002U)
#define INTRIIC0TEI_ISR                                     ((uint16)0x0003U)
#define INTRIIC1EE_ISR                                      ((uint16)0x0004U)
#define INTRIIC1RI_ISR                                      ((uint16)0x0005U)
#define INTRIIC1TI_ISR                                      ((uint16)0x0006U)
