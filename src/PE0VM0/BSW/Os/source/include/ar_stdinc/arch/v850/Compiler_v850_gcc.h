...
*/
/***************************************************************************
[ Compiler_v850_gcc.h ] - Compiler dependency header file
****************************************************************************/

#ifndef COMPILER_V850_GCC_H_
#define COMPILER_V850_GCC_H_

/*  NOTE : The following macros are not available for GCC. */
