...
/* #include "mem_bar.h" */
extern void __SYNCP(void);      /* zantei */
#include "int_drv.h"
...
/*                                                                                                                                   */
/* 3 * CLK_HSB + 4 * LIN communication clock sources(CLK_RLIN)                                                                       */
/*                                                                                                                                   */
/* The duration 1 [us] is being designed considering on slowest clock configuration (CLK_HSB = 80MHz,  CLK_RLIN = 2MHz)             */
/* Therefore, no need to change SPI_UART_MDSW_WAIT if clock configuration is equal or faster than above.                             */
/*                                                                                                                                   */
/* ----------------------------------------------------------------------------------------------------------------------------------*/
#define SPI_UART_MDSW_WAIT                       (GPT_BUSY_WAIT_1_US * 3)  /* 3 [us] */
