...
#define DCM_DSL_R0_CONNECTION_NUM           ((uint16)0x04U)  /* Number of Dcm_Dsl_ConnectionType */
#define DCM_DSL_R0_SESSION_NUM              ((uint8)0x00U)   /* Number of sessions to activate the S3Server */
#define DCM_DSL_R0_C0_PROTOCOLRX_NUM        ((uint8)0x02U)   /* Number of Dcm_Dsl_ProtocolRxType */
#define DCM_DSL_R0_C1_PROTOCOLRX_NUM        ((uint8)0x01U)   /* Number of Dcm_Dsl_ProtocolRxType */
#define DCM_DSL_R0_C2_PROTOCOLRX_NUM        ((uint8)0x02U)   /* Number of Dcm_Dsl_ProtocolRxType */
#define DCM_DSL_R0_C3_PROTOCOLRX_NUM        ((uint8)0x01U)   /* Number of Dcm_Dsl_ProtocolRxType */
...
#define DCM_DSL_INDSESCHG_NUM               ((uint8)1U)      /* Number of notification destinations at session change */
...
#define DCM_DSL_CANCELIDQUEUE_MAX           ((uint16)4U)     /* Cancel ID queue max size */
...
#define DCM_DSL_ROE_ENABLE                  (STD_OFF)        /* ROE enable */
...
extern CONST(AB_83_ConstV Dcm_Dsl_ProtocolTxType, DCM_CONFIG_DATA) Dcm_Dsl_R0_C0_stProtocolTx[1];
...
extern CONST(AB_83_ConstV Dcm_Dsl_ProtocolRxType, DCM_CONFIG_DATA) Dcm_Dsl_R0_C0_stProtocolRx[DCM_DSL_R0_C0_PROTOCOLRX_NUM];
...
extern CONST(AB_83_ConstV Dcm_Dsl_MainConnectionType, DCM_CONFIG_DATA) Dcm_Dsl_R0_C0_stMainConnection[1];
