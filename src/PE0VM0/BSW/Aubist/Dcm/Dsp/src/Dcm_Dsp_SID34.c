...
#define DCM_DSP_SID34_REQ_LEN_NOMEMID_MEMADDR ((uint32)4U)
...
#define DCM_DSP_SID34_REQ_POS_MEMADDR0        ((uint8)0x02U)
#define DCM_DSP_SID34_REQ_POS_MEMADDR1        ((uint8)0x03U)
#define DCM_DSP_SID34_REQ_POS_MEMADDR2        ((uint8)0x04U)
#define DCM_DSP_SID34_REQ_POS_MEMADDR3        ((uint8)0x05U)
#define DCM_DSP_SID34_REQ_POS_MEMSIZE0        ((uint8)0x06U)
#define DCM_DSP_SID34_REQ_POS_MEMSIZE1        ((uint8)0x07U)
#define DCM_DSP_SID34_REQ_POS_MEMSIZE2        ((uint8)0x08U)
#define DCM_DSP_SID34_REQ_POS_MEMSIZE3        ((uint8)0x09U)
...
( void )
{
    ...
    if( u1_RetChkAlfid == (Std_ReturnType)E_OK )
    {
        ...
        {
            if( u4_MemoryAddressLen == DCM_DSP_SID34_REQ_LEN_NOMEMID_MEMADDR )
            {
                Dcm_Dsp_SID34_u1MemoryId = (uint8)0U;
                Dcm_Dsp_SID34_u4MemoryAddress = (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMADDR0] << DCM_DSP_SID34_BITSHIFT_24 ) |
                                                (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMADDR1] << DCM_DSP_SID34_BITSHIFT_16 ) |
                                                (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMADDR2] << DCM_DSP_SID34_BITSHIFT_8 ) |
                                                (uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMADDR3];

                Dcm_Dsp_SID34_u4MemorySize = (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMSIZE0] << DCM_DSP_SID34_BITSHIFT_24 ) |
                                             (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMSIZE1] << DCM_DSP_SID34_BITSHIFT_16 ) |
                                             (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMSIZE2] << DCM_DSP_SID34_BITSHIFT_8 ) |
                                             (uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID34_REQ_POS_MEMSIZE3];
            }
            else
            {
