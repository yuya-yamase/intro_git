...
/****************************************************************************/
/* Object Name  | DCM/Dsp_SID35/CODE                                        */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/
...
#include <Dcm/Dcm_Dsp_SID35.h>
#include <Dcm/Dcm_Dsp_SID35_Callout.h>
#include "../../Dsp/cfg/Dcm_Dsp_SID35_Cfg.h"
...
/*--------------------------------------------------------------------------*/
/* Request Information */
#define DCM_DSP_SID35_REQ_LEN_MIN             ((Dcm_MsgLenType)0x00000004U) /* dataFormatIdentifier +             */
...
#define DCM_DSP_SID35_REQ_POS_MEMID_MEMADDR3  ((uint8)0x05U)
#define DCM_DSP_SID35_REQ_POS_MEMID_MEMADDR4  ((uint8)0x06U)
#define DCM_DSP_SID35_REQ_POS_MEMID_MEMSIZE0  ((uint8)0x07U)
#define DCM_DSP_SID35_REQ_POS_MEMID_MEMSIZE1  ((uint8)0x08U)
#define DCM_DSP_SID35_REQ_POS_MEMID_MEMSIZE2  ((uint8)0x09U)
#define DCM_DSP_SID35_REQ_POS_MEMID_MEMSIZE3  ((uint8)0x0AU)

/* Response Information */
#define DCM_DSP_SID35_RES_POS_LFID             ((uint8)0U)
#define DCM_DSP_SID35_RES_POS_MNROB_0          ((uint8)1U)
#define DCM_DSP_SID35_RES_POS_MNROB_1          ((uint8)2U)
#define DCM_DSP_SID35_RES_POS_MNROB_2          ((uint8)3U)
#define DCM_DSP_SID35_RES_POS_MNROB_3          ((uint8)4U)
#define DCM_DSP_SID35_RES_LEN_LFID             ((uint32)1U)
#define DCM_DSP_SID35_RES_LEN_MNROB_4B         ((uint32)4U)
#define DCM_DSP_SID35_RES_LEN_MNROB_2B         ((uint32)2U)
#define DCM_DSP_SID35_RES_LEN_SIDANDBSC        ((uint32)2U)
#define DCM_DSP_SID35_RES_LEN_BSC              ((uint32)1U)

/* Bitshift Information */
#define DCM_DSP_SID35_BITSHIFT_4               ((uint8)4U)
#define DCM_DSP_SID35_BITSHIFT_8               ((uint8)8U)
#define DCM_DSP_SID35_BITSHIFT_16              ((uint8)16U)
#define DCM_DSP_SID35_BITSHIFT_24              ((uint8)24U)

#define DCM_DSP_SID35_SUP_LFID_2B              ((uint8)0x20U)
...
static FUNC( Std_ReturnType, DCM_CODE ) Dcm_Dsp_SID35_InitialProc
(
    P2CONST( Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA ) ptMsgContext
);

static FUNC( Std_ReturnType, DCM_CODE ) Dcm_Dsp_SID35_ChkSupportedDfidUL
(
    const Dcm_OpStatusType u1OpStatus
);

static FUNC( Std_ReturnType, DCM_CODE ) Dcm_Dsp_SID35_ChkAndStoredRequestData
( void );

static FUNC( Std_ReturnType, DCM_CODE ) Dcm_Dsp_SID35_RequestUpLoadProc
(
    const Dcm_OpStatusType u1OpStatus
);

static FUNC( Std_ReturnType, DCM_CODE ) Dcm_Dsp_SID35_CancelProc
( void );
...
static VAR( uint32, DCM_VAR_NO_INIT ) Dcm_Dsp_SID35_u4MemoryAddress;
static VAR( uint32, DCM_VAR_NO_INIT ) Dcm_Dsp_SID35_u4MemorySize;
static VAR( uint8, DCM_VAR_NO_INIT ) Dcm_Dsp_SID35_u1Dfid;
static VAR( uint8, DCM_VAR_NO_INIT ) Dcm_Dsp_SID35_u1MemoryId;
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_Init                                       */
/* Description   | SID35 initialization                                     */
/* Preconditions | None                                                     */
/* Parameters    | None                                                     */
/* Return Value  | None                                                     */
/* Notes         | None                                                     */
...
( void )
{
    Dcm_Dsp_SID35_u4MemoryAddress = (uint32)0x00000000U;
    Dcm_Dsp_SID35_u4MemorySize    = (uint32)0x00000000U;
    Dcm_Dsp_SID35_u1Dfid          = (uint8)0x00U;
    Dcm_Dsp_SID35_u1MemoryId      = (uint8)0x00U;

    return;
}

/****************************************************************************/
/* Function Name | Dcm_SID35                                                */
/* Description   | Request processing of SID35                              */
/* Preconditions | None                                                     */
...
)
{
    ...
    {
        u1_RetVal = Dcm_Dsp_SID35_InitialProc( pMsgContext );
    }
    else if( OpStatus == (Dcm_OpStatusType)DCM_CANCEL )
    {
        u1_RetVal = Dcm_Dsp_SID35_CancelProc();
    }
    else
    {
        /* no process */
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_ChkSupportedDfidULCbk                      */
/* Description   | Callback function for event delivery registration of     */
/*               | Xxx_CheckSupportedDfidUL                                 */
/* Preconditions | None                                                     */
...
)
{
    ...
    u1_RetVal = Dcm_Dsp_SID35_ChkSupportedDfidUL( DCM_PENDING );
    if( u1_RetVal == (Std_ReturnType)E_OK )
    {
        u1_RetVal = Dcm_Dsp_SID35_ChkAndStoredRequestData();
        if( u1_RetVal == (Std_ReturnType)E_OK )
        {
            (void)Dcm_Dsp_SID35_RequestUpLoadProc( DCM_INITIAL );             /* no return check required */
        }
    }
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_ProcReqUploadCbk                           */
/* Description   | Callback function for event delivery registration of     */
...
{
    (void)Dcm_Dsp_SID35_RequestUpLoadProc( DCM_PENDING );             /* no return check required */
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_InitialProc                                */
/* Description   | Initial process of SID35                                 */
/* Preconditions | None                                                     */
...
)
{
    ...
    if( Dcm_Dsp_Main_stMsgContext.reqDataLen >= DCM_DSP_SID35_REQ_LEN_MIN )
    {
        Dcm_Dsp_SID35_u1Dfid = Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_DFID];
        u1_RetVal = Dcm_Dsp_SID35_ChkSupportedDfidUL( DCM_INITIAL );
        if( u1_RetVal == (Std_ReturnType)E_OK )
        {
            u1_RetVal = Dcm_Dsp_SID35_ChkAndStoredRequestData();
            if( u1_RetVal == (Std_ReturnType)E_OK )
            {
                u1_RetVal = Dcm_Dsp_SID35_RequestUpLoadProc( DCM_INITIAL );
            }
        }
    }
    else
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_ChkSupportedDfidUL                         */
/* Description   | Check on supported dataFormatIdentifier for Upload       */
/* Preconditions | None                                                     */
...
)
{
    ...
    u1_RetVal = Dcm_Dsp_SID35_CallCheckSupportedDfidULFnc( u1OpStatus,
                                                           Dcm_Dsp_SID35_u1Dfid );
    if( u1_RetVal == (Std_ReturnType)E_OK )
    {
    ...
    else if( u1_RetVal == (Std_ReturnType)DCM_E_PENDING )
    {
        ...
        (void)Dcm_Main_EvtDistr_SendEvent( DCM_M_EVTID_SID35_CHKDFID );             /* no return check required */
    }
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_ChkAndStoredRequestData                    */
...
( void )
{
    ...
    u1_RetChkAlfid = Dcm_Dsp_DataTfrMng_ChkAlfid( Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_ALFID] );
    if( u1_RetChkAlfid == (Std_ReturnType)E_OK )
    {
        u4_MemorySizeLen = (uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_ALFID] >> DCM_DSP_SID35_BITSHIFT_4;
        u4_MemoryAddressLen = (uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_ALFID] &
                              DCM_DSP_SID35_REQ_DATA_OFFMEMADDR;
        u4_DataFullLen = DCM_DSP_SID35_REQ_LEN_DFIDANDALFID +               /* no wrap around */
        ...
        if( Dcm_Dsp_Main_stMsgContext.reqDataLen == (Dcm_MsgLenType)u4_DataFullLen )
        {
            if( Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_ALFID] == DCM_DSP_SID35_REQ_DATA_ALFID45 )
            {
                ...
                Dcm_Dsp_SID35_u4MemoryAddress = (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_MEMID_MEMADDR1] << DCM_DSP_SID35_BITSHIFT_24 ) |
                                                (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_MEMID_MEMADDR2] << DCM_DSP_SID35_BITSHIFT_16 ) |
                                                (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_MEMID_MEMADDR3] << DCM_DSP_SID35_BITSHIFT_8 ) |
                                                (uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_MEMID_MEMADDR4];

                Dcm_Dsp_SID35_u4MemorySize = (uint32)((uint32)Dcm_Dsp_Main_stMsgContext.reqData[DCM_DSP_SID35_REQ_POS_MEMID_MEMSIZE0] << DCM_DSP_SID35_BITSHIFT_24 ) |
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_RequestUpLoadProc                          */
...
)
{
    ...
    Std_ReturnType                u1_RetProcReqUl;
    Std_ReturnType                u1_RetVal;
    Dcm_NegativeResponseCodeType  u1_ErrorCode;
    ...
    u4_BlockLen = Dcm_Dsp_Main_stMsgContext.resMaxDataLen - DCM_DSP_SID35_RES_LEN_BSC;  /* no wrap around */ 
    u1_RetProcReqUl = Dcm_Dsp_DataTfrMng_ProcReqUL( u1OpStatus,
                                                    Dcm_Dsp_SID35_u1Dfid,
                                                    Dcm_Dsp_SID35_u1MemoryId,
                                                    Dcm_Dsp_SID35_u4MemoryAddress,
                                                    Dcm_Dsp_SID35_u4MemorySize,
                                                    &u4_BlockLen,
                                                    &u1_ErrorCode );
    if( u1_RetProcReqUl == (Std_ReturnType)E_OK )
    {
        if( u1OpStatus == (Dcm_OpStatusType)DCM_PENDING )
        {
            Dcm_Dsp_Main_SetUserNotifyFlag( (boolean)FALSE );
        ...
        u4_MaxNumOfBlockLen = u4_BlockLen +                                             /* no wrap around */
                              DCM_DSP_SID35_RES_LEN_SIDANDBSC;
        u1_SupportLengthFormatId = Dcm_Dsp_SID35_u1SupportLengthFormatId;
        Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_LFID] = u1_SupportLengthFormatId;
        if( u1_SupportLengthFormatId == DCM_DSP_SID35_SUP_LFID_2B )
        {
            if( u4_MaxNumOfBlockLen > DCM_DSP_SID35_MNROB_LEN_2BMAX )
            {
                Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_0] = DCM_DSP_SID35_MNROB_2BMAX_H;
                Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_1] = DCM_DSP_SID35_MNROB_2BMAX_L;
            }
            else
            {
                Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_0] = (uint8)(u4_MaxNumOfBlockLen >> DCM_DSP_SID35_BITSHIFT_8);
                Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_1] = (uint8)u4_MaxNumOfBlockLen;
            }
            Dcm_Dsp_Main_stMsgContext.resDataLen = DCM_DSP_SID35_RES_LEN_LFID +
                                                   DCM_DSP_SID35_RES_LEN_MNROB_2B;
        }
        else
        {
            Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_0] = (uint8)(u4_MaxNumOfBlockLen >> DCM_DSP_SID35_BITSHIFT_24);
            Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_1] = (uint8)(u4_MaxNumOfBlockLen >> DCM_DSP_SID35_BITSHIFT_16);
            Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_2] = (uint8)(u4_MaxNumOfBlockLen >> DCM_DSP_SID35_BITSHIFT_8);
            Dcm_Dsp_Main_stMsgContext.resData[DCM_DSP_SID35_RES_POS_MNROB_3] = (uint8)u4_MaxNumOfBlockLen;

            Dcm_Dsp_Main_stMsgContext.resDataLen = DCM_DSP_SID35_RES_LEN_LFID +
                                                   DCM_DSP_SID35_RES_LEN_MNROB_4B;
        }
    ...
    else if( u1_RetProcReqUl == (Std_ReturnType)DCM_E_PENDING )
    {
        Dcm_Dsp_Main_SetUserNotifyFlag( (boolean)TRUE );
        (void)Dcm_Main_EvtDistr_SendEvent( DCM_M_EVTID_SID35_PROCREQUL );               /* no return check required */
...
/****************************************************************************/
/* Function Name | Dcm_Dsp_SID35_CancelProc                                 */
/* Description   | Cancel process of SID35                                  */
/* Preconditions | None                                                     */
/* Parameters    | None                                                     */
/* Return Value  | Std_ReturnType                                           */
/*               |   E_OK : Processing normal                               */
...
( void )
{
    ...
    {
        (void)Dcm_Dsp_SID35_CallCheckSupportedDfidULFnc( DCM_CANCEL,                /* no return check required */
                                                         0x00U );

        (void)Dcm_Dsp_DataTfrMng_ProcReqUL( DCM_CANCEL,                             /* no return check required */
                                            0x00U,
                                            0x00U,
                                            0x00000000U,
                                            0x00000000U,
    ...
    (void)Dcm_Main_EvtDistr_DeleteEvent( DCM_M_EVTID_SID35_CHKDFID,                 /* no return check required */
                                         (boolean)FALSE );

    (void)Dcm_Main_EvtDistr_DeleteEvent( DCM_M_EVTID_SID35_PROCREQUL,               /* no return check required */
                                         (boolean)FALSE );
