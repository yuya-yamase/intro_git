/* can_rscf2_cm_phy_h_m10700_v3-0-0                                         */
/****************************************************************************/
/* Protected                                                                */
...
/****************************************************************************/
/* Object Name  | CAN/RSCF2/CM/PHYSICAL/HEADER                              */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/
#ifndef CAN_RSCF2_CM_PHY_H
#define CAN_RSCF2_CM_PHY_H
...
#define CAN_OPEMODE                     (CAN_CFG_OPEMODE_0)

#define CAN_u2BIT_NONE                  ((uint16)0x0000U)   /* bit なし(uint16)                         */
#define CAN_u4BIT_NONE                  (0x00000000UL)      /* bit なし(uint32)                         */
#define CAN_u2BIT0                      ((uint16)0x0001U)   /* bit 0(uint16)                            */
#define CAN_u4BIT31                     (0x80000000UL)      /* bit 31                                   */
#define CAN_u2ALLBIT                    ((uint16)0xFFFFU)   /* bit 全て(uint16)                         */
...
#define CAN_MBSFT_MSK                   (0x0FU)             /* MBOX番号に対応した16Bit列ビット位置変換用マスク */
...
#define CAN_NUM_BUF_SND_PER_CH          (16U)               /* 送信バッファ数/1チャネル                 */
#define CAN_NUM_MERGE_BUF_SND_PER_CH    (2U)                /* マージモード送信バッファ数/1チャネル     */

#define CAN_NUM_RULETABLE_PAGE_CH       (4U)                /* 受信ルールページ数/1チャネル             */
...
#define CAN_TRX_FIFO_INVALID            (255U)              /* 無効な送受信FIFO番号                     */
#define CAN_TRX_FIFO_FOR_TX             (2U)                /* 送信で使用する送受信FIFO数               */

#define CAN_CFTYPE_RX_INT               (CAN_TRX_FIFO_2)    /* 割り込み受信で使用する送受信FIFOのNo     */
...
/* レジスタ初期値マクロ                 */
/*======================================*/
#define CAN_u4CMCFG_INIT                (0x00000000UL)      /* 初期値 クラシカルCANモード：CmCFG        */
                                                            /* 初期値 CAN FDモード       ：CmNCFG       */
...
#define CAN_u2TMIECY_INIT               ((uint16)0x0000U)   /* 初期値 TMIECy                            */
...
#define CAN_u4GRMCFG_INIT               (0x00000000UL)      /* 初期値 GRMCFG                            */
#else /* (CAN_OPEMODE != CAN_OPEMODE_CAN) */
#define CAN_u4GRMCFG_INIT               (0x00000001UL)      /* 初期値 GRMCFG                            */
#define CAN_u4GCRCCFG_INIT              (0x00000000UL)      /* 初期値 GCRCCFG                           */
#define CAN_u4CDTCT_INIT                (0x00000000UL)      /* 初期値 CDTCT                             */
#define CAN_u4CMDCFG_INIT               (0x00000000UL)      /* 初期値 CmDCFG                            */
#define CAN_u4CMFDCFG_INIT              (0x08000000UL)      /* 初期値 CmFDCFG                           */
#endif /* (CAN_OPEMODE) */
...
#define CAN_u4RFSTSX_RFIF_CLR           (0x00000005UL)      /* 受信FIFO受信割り込み要求フラグクリア     */

#define CAN_u4CFCCK_CFRXIE_DIS          (0xFFFFFFFDUL)      /* 送受信FIFO受信割り込み禁止               */
#define CAN_u4CFCCK_CFTXRXIE_DIS        (0xFFFFFFF9UL)      /* 送受信FIFO送受信割り込み禁止             */
...
#define CAN_u4CFSTSK_TXIDLE             (0x00000001UL)      /* 送受信FIFO送信向けアイドル状態           */

#define CAN_u4CFFDCSTSK_CFFDF_CAN       (0x00000000UL)      /* クラシカルCANフレーム設定                */
#define CAN_u4CFFDCSTSK_CFFDF_CANFD     (0x00000004UL)      /* CAN FDフレーム設定                       */
#define CAN_u4CFFDCSTSK_CFBRS_OFF       (0x00000000UL)      /* データ領域のビットレートは変わらない     */
#define CAN_u4CFFDCSTSK_CFBRS_ON        (0x00000002UL)      /* データ領域のビットレートは変わる         */
#define CAN_u4CFFDCSTSK_CFESI_E_ACT     (0x00000000UL)      /* ESIビットをエラーアクティブノード        */
#define CAN_u4CFFDCSTSK_CFESI_E_PCV     (0x00000001UL)      /* ESIビットをエラーパッシブノード          */

#define CAN_u4CFPCTRK_CFPC_SET          (0x000000FFUL)      /* 送受信FIFOのリードポインタ移動           */

#define CAN_u4RFCCX_RFIE_DIS            (0xFFFFFFFDUL)      /* 受信FIFO割り込み禁止                     */
#define CAN_u4RFCCX_RFE_NOUSE           (0xFFFFFFFEUL)      /* 受信FIFO未使用                           */

#define CAN_u4RFFDSTSX_RFFDF_CANFD      (0x00000004UL)      /* CAN FDフレーム設定                       */

#define CAN_u4RFPCTRX_RFPC_SET          (0x000000FFUL)      /* 受信FIFOのリードポインタ移動             */

#define CAN_u1TMCP_TMTR_SET             ((uint8)0x01U)      /* 送信要求                                 */
#define CAN_u1TMCP_TMTAR_SET            ((uint8)0x02U)      /* 送信アボート要求                         */

#define CAN_u4TMFDCTR_FDF_CAN           (0x00000000UL)      /* クラシカルCANフレーム設定                */
#define CAN_u4TMFDCTR_FDF_CANFD         (0x00000004UL)      /* CAN FDフレーム設定                       */
#define CAN_u4TMFDCTR_BRS_OFF           (0x00000000UL)      /* データ領域のビットレートは変わらない     */
#define CAN_u4TMFDCTR_BRS_ON            (0x00000002UL)      /* データ領域のビットレートは変わる         */
#define CAN_u4TMFDCTR_ESI_E_ACT         (0x00000000UL)      /* ESIビットをエラーアクティブノード        */
#define CAN_u4TMFDCTR_ESI_E_PCV         (0x00000001UL)      /* ESIビットをエラーパッシブノード          */
...
/* レジスタマスク用マクロ               */
/*======================================*/
#define CAN_u4GRMCFG_USEDBIT_MSK        (0x00000001UL)      /* GRMCFGレジスタ   使用ビットマスク                       */
...
#define CAN_u4GAFLECTR_AFLPN_MSK        (0x0000001FUL)      /* GAFLECTRレジスタ AFLPNマスク                            */
...
#define CAN_u4CFSTSK_TXIDLE_MSK         (0x00000011UL)      /* CFSTSkレジスタ   CFEMP,CFTXIFマスク                     */
#define CAN_u4CFSTSK_CFTXIF_MSK         (0x00000010UL)      /* CFSTSkレジスタ   CFTXIFマスク                           */
#define CAN_u4CFSTSK_CFEMP_MSK          (0x00000001UL)      /* CFSTSkレジスタ   CFEMPマスク                            */
#define CAN_u4CFIDK_SID_MSK             (0x000007FFUL)      /* CFIDkレジスタ    CFIDマスク(標準ID用)                   */
...
#define CAN_u4CFPTRK_CFPTR_MSK          (0x0FFF0000UL)      /* CFPTRkレジスタ   CFPTRマスク                            */
#define CAN_u4RFSTSX_RFMC_MSK           (0x0000FF00UL)      /* RFSTSxレジスタ   RFMCマスク                             */
#define CAN_u4RFIDX_ID_MSK              (0x9FFFFFFFUL)      /* RFIDxレジスタ    RFIDE,CFIDマスク                       */
#define CAN_u4RFPTRX_RFDLC_MSK          (0xF0000000UL)      /* RFPTRxレジスタ   RFDLCマスク                            */
#define CAN_u4RFPTRX_RFPTR_MSK          (0x0FFF0000UL)      /* RFPTRxレジスタ   RFPTRマスク                            */
...
#define CAN_u4TXQCCM_USEDBIT_MSK        (0x00003F01UL)      /* TXQCCmレジスタ   使用ビットマスク                       */
...
#define CAN_u4GTSTCFG_RTMPS_MSK         (0x007F0000UL)      /* GTSTCFGレジスタ  RTMPSマスク                            */
...
#if (CAN_OPEMODE == CAN_OPEMODE_CAN)
#define CAN_u4CMCTR_USEDBIT_MSK         (0x47E1FF0FUL)      /* CmCTRレジスタ    使用ビットマスク                       */
#define CAN_u4CMCTR_MODEALL_MSK         (0x00000007UL)      /* CmCTRレジスタ    CSLPR,CHMDCマスク                      */
#define CAN_u4GCFG_USEDBIT_MSK          (0x000000DFUL)      /* GCFGレジスタ     使用ビットマスク                       */
#define CAN_u4GCFG_DCS_MSK              (0x00000010UL)      /* GCFGレジスタ     DCSマスク                              */
#define CAN_u4GCTR_USEDBIT_MSK          (0x00000707UL)      /* GCTRレジスタ     使用ビットマスク                       */
#define CAN_u4RMNB_USEDBIT_MSK          (0x000000FFUL)      /* RMNBレジスタ     使用ビットマスク                       */
#define CAN_u4CFCCK_USEDBIT_MSK         (0xFFFFF707UL)      /* CFCCkレジスタ    使用ビットマスク                       */
#define CAN_u4CFCCK_GCHKBIT_MSK         (0x00F3F700UL)      /* CFCCkレジスタ    グローバルレジスタチェック用マスク     */
#define CAN_u4RFCCX_GCHKBIT_MSK         (0x0000F700UL)      /* RFCCxレジスタ    グローバルレジスタチェック用マスク     */
#else /* (CAN_OPEMODE != CAN_OPEMODE_CAN) */
...
#define CAN_u4RMNB_USEDBIT_MSK          (0x000003FFUL)      /* RMNBレジスタ     使用ビットマスク                       */
#define CAN_u4CFCCK_USEDBIT_MSK         (0xFFFFF777UL)      /* CFCCkレジスタ    使用ビットマスク                       */
#define CAN_u4CFCCK_GCHKBIT_MSK         (0x00F3F770UL)      /* CFCCkレジスタ    グローバルレジスタチェック用マスク     */
#define CAN_u4CFCCK_CFE_MSK             (0x00000001UL)      /* CFCCkレジスタ    CFEマスク                              */
#define CAN_u4GFDCFG_USEDBIT_MSK        (0x00000001UL)      /* GFDCFGレジスタ   使用ビットマスク                       */
#define CAN_u4GCRCCFG_USEDBIT_MSK       (0x00000001UL)      /* GCRCCFGレジスタ  使用ビットマスク                       */
...
#define CAN_u4RFFDSTSX_RFFDF_MSK        (0x00000004UL)      /* RFFDSTSレジスタ  RFFDFマスク                            */
#define CAN_u4RFCCX_GCHKBIT_MSK         (0x0000F770UL)      /* RFCCxレジスタ    グローバルレジスタチェック用マスク     */
#endif /* (CAN_OPEMODE) */
