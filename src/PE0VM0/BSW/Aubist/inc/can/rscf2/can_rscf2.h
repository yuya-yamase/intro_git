...
#define Can_tx_SetTxFifoReg             (CAN_CV_CONVERT_NAME(_tx_SetTxFifoReg))
#define Can_tx_TxFinish                 (CAN_CV_CONVERT_NAME(_tx_TxFinish))

#define Can_rx_RxFinish                 (CAN_CV_CONVERT_NAME(_rx_RxFinish))
#define Can_rx_ChkRxFinMboxInt          (CAN_CV_CONVERT_NAME(_rx_ChkRxFinMboxInt))
#define Can_rx_ChkRxFinMboxPol          (CAN_CV_CONVERT_NAME(_rx_ChkRxFinMboxPol))
...
#define Can_tb_u1LastTestpage           (CAN_CV_CONVERT_NAME(_tb_u1LstTstpage))
...
#define Can_tb_u1TxFifo0LinkConf        (CAN_CV_CONVERT_NAME(_tb_u1TxFifo0LinkConf))
#define Can_tb_u1TxFifo1LinkConf        (CAN_CV_CONVERT_NAME(_tb_u1TxFifo1LinkConf))
#define Can_tb_u2TxFifoBitMask          (CAN_CV_CONVERT_NAME(_tb_u2TxFifoBitMask))
#define Can_tb_u1FifoWriteSize          (CAN_CV_CONVERT_NAME(_tb_u1FifoWriteSize))
#define Can_tb_u1FifoReadSizePol        (CAN_CV_CONVERT_NAME(_tb_u1FifoReadSizePol))
#define Can_tb_u1FifoReadSizeInt        (CAN_CV_CONVERT_NAME(_tb_u1FifoReadSizeInt))
...
/* phy層静的定数 */
#define Can_tx_u1MergeMBNo              (CAN_CV_CONVERT_NAME(_tx_u1MergeMBNo))
