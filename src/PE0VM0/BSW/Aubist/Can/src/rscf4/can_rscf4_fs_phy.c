/* can_rscf4_fs_phy_c_m10700_v2-2-1                                         */
/****************************************************************************/
/* Protected                                                                */
...
/****************************************************************************/
/* Object Name  | CAN/RSCF4/FS/PHYSICAL/CODE                                */
/*--------------------------------------------------------------------------*/
/* Notes        |                                                           */
/****************************************************************************/
...
#include <can/rscf4/can_rscf4_rx.h>
...
Can_fs_ResetInterrupt( uint8 u1Controller )
{
    ...
    ptChReg->ptu4CFSTSk[ CAN_TRX_FIFO_0 ] = ptSetRSCANReg->u4CFSTSkConf;
    ptChReg->ptu4CFSTSk[ CAN_TRX_FIFO_1 ] = CAN_u4CFSTSK_CLEARALL;
    ptChReg->ptu4CFSTSk[ CAN_TRX_FIFO_2 ] = CAN_u4CFSTSK_CLEARALL;

    *(ptChReg->ptu4TXQSTS0m) = CAN_u4TXQSTS0M_CLEARALL;
    *(ptChReg->ptu4TXQSTS1m) = CAN_u4TXQSTS1M_CLEARALL;
    *(ptChReg->ptu4TXQSTS2m) = CAN_u4TXQSTS2M_CLEARALL;
    *(ptChReg->ptu4TXQSTS3m) = CAN_u4TXQSTS3M_CLEARALL;
    ...
    *(ptChReg->ptu4CmFDSTS) = CAN_u4CMFDSTS_CLEARALL;
    ...
    if ( ( ( ptChReg->ptu4TMIECy[CAN_IDX0])                                     != u4TmpTxIntrBitLo )
    ||   ( ( ptChReg->ptu4TMIECy[CAN_IDX1])                                     != u4TmpTxIntrBitHi )
    ...
    ||   ( ( ptChReg->ptu4CFCCEk[ CAN_TRX_FIFO_0 ] & CAN_u4CFCCEK_USEDBIT_MSK ) != CAN_u4CFCCEK_INIT )
    ||   ( ( ptChReg->ptu4CFCCEk[ CAN_TRX_FIFO_1 ] & CAN_u4CFCCEK_USEDBIT_MSK ) != CAN_u4CFCCEK_INIT )
    ||   ( ( ptChReg->ptu4CFCCEk[ CAN_TRX_FIFO_2 ] & CAN_u4CFCCEK_USEDBIT_MSK ) != CAN_u4CFCCEK_INIT )
    ||   ( ( *(ptChReg->ptu4TXQCC0m) & CAN_u4TXQCC0M_USEDBIT_MSK )              != CAN_u4TXQCC0M_INIT )
    ||   ( ( *(ptChReg->ptu4TXQCC1m) & CAN_u4TXQCC1M_USEDBIT_MSK )              != CAN_u4TXQCC1M_INIT )
    ||   ( ( *(ptChReg->ptu4TXQCC2m) & CAN_u4TXQCC2M_USEDBIT_MSK )              != CAN_u4TXQCC2M_INIT )
    ||   ( ( *(ptChReg->ptu4TXQCC3m) & CAN_u4TXQCC3M_USEDBIT_MSK )              != CAN_u4TXQCC3M_INIT )
