...
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define L3R_TEST_PDU_LOG_TX                      (MSG_AVN1SC2_TXCH0)  /* CAN-ID 0x2D5                       */
#define L3R_TEST_LOG_DLC_MAX                     (64U)                /* data length of L3R_TEST_PDU_LOG_TX */
#define L3R_TEST_LOG_RXC_MAX                     (31U)                /* (64 byte - 2 byte) / 2 byte        */

/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define L3R_TEST_PDU_CYC_TX                      (MSG_AVN1SC3_TXCH0)  /* CAN-ID 0x2D6                       */
#define L3R_TEST_CYC_DLC_MAX                     (64U)                /* data length of L3R_TEST_PDU_CYC_TX */
...
static U1   u1_sp_l3r_test_rlycnt[L3R_TEST_NUM_CHKPT];
static U1   u1_sp_l3r_test_rlymax[L3R_TEST_NUM_CHKPT];
static U2   u2_s_l3r_test_fwdlost;
...
void    vd_g_L3rTestInit(void)
{
    ...
    for(u4_t_lpcnt = (U4)0U; u4_t_lpcnt < (U4)L3R_TEST_NUM_CHKPT; u4_t_lpcnt++){
        u1_sp_l3r_test_rlycnt[u4_t_lpcnt] = (U1)0U;
        u1_sp_l3r_test_rlymax[u4_t_lpcnt] = (U1)0U;
    }

    u2_s_l3r_test_fwdlost = (U2)0U;
}
/*===================================================================================================================================*/
...
void    vd_g_L3rTestRelayCnt(const U1 u1_a_CHKPT)
{
    if((u1_a_CHKPT                        < (U1)L3R_TEST_NUM_CHKPT) &&
       (u1_sp_l3r_test_rlycnt[u1_a_CHKPT] < (U1)U1_MAX            )){

        u1_sp_l3r_test_rlycnt[u1_a_CHKPT]++;
    }
}
/*===================================================================================================================================*/
...
void    vd_g_L3rTestHighFinish(void)
{
    ...
    for(u4_t_lpcnt = (U4)0U; u4_t_lpcnt < (U4)L3R_TEST_NUM_CHKPT; u4_t_lpcnt++){
        ...
        if(u1_sp_l3r_test_rlycnt[u4_t_lpcnt] > u1_sp_l3r_test_rlymax[u4_t_lpcnt]){
            u1_sp_l3r_test_rlymax[u4_t_lpcnt] = u1_sp_l3r_test_rlycnt[u4_t_lpcnt];
        }
    }

    if((u1_sp_l3r_test_rlycnt[L3R_TEST_CHKPT_PCAN_RX] != u1_sp_l3r_test_rlycnt[L3R_TEST_CHKPT_VCAN_TX_1]) &&
       (u2_s_l3r_test_fwdlost                         <  (U2)U2_MAX                                     )){

        u2_s_l3r_test_fwdlost++;
    }
}
/*===================================================================================================================================*/
...
static void    vd_s_L3rTestCycTx(void)
{
    ...
    if(u4_t_elpsd >= u4_s_L3R_TEST_CYC_TX){
        ...
        u1_tp_byte_ctx[16U] = u1_sp_l3r_test_rlymax[L3R_TEST_CHKPT_PCAN_RX];
        u1_tp_byte_ctx[17U] = u1_sp_l3r_test_rlymax[L3R_TEST_CHKPT_VCAN_TX_0];
        u1_tp_byte_ctx[18U] = u1_sp_l3r_test_rlymax[L3R_TEST_CHKPT_VCAN_TX_1];

        u2_t_lost = u2_s_l3r_test_fwdlost;
        u1_tp_byte_ctx[19U] = (U1)(u2_t_lost >> 8U);
        u1_tp_byte_ctx[20U] = (U1)u2_t_lost;
