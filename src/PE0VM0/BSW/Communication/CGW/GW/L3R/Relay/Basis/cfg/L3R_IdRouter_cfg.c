 ...
 * @note		テンプレートファイル：
 * @note            templates/L3R_IdRouter_cfgC.tmpl
 * @note	ツールバージョン
 * @note		SMC_4.0.1
 ****************************************************************************/
#include "Std_Types.h"
...
void ( * const L3R_SendReqIdFuncTbl[CHM_LOG_ALL_CH_NUM])(uint8 ch, CommonBuffer *const pCommonBuffer) = {
	&Router_SendGWId,
	&Router_SendGWId,
	&Router_SendGWId,
	&Router_SendGWId
