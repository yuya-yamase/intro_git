...
#ifndef NVMC_MOD_OTH_SUM_SNGL_H
#define NVMC_MOD_OTH_SUM_SNGL_H

/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define NVMC_MOD_OTH_SUM_SNGL_H_MAJOR            (1U)
#define NVMC_MOD_OTH_SUM_SNGL_H_MINOR            (2U)
#define NVMC_MOD_OTH_SUM_SNGL_H_PATCH            (4U)
