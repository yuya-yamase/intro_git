...
#ifndef NVMC_MOD_OTH_SUM_DBL_SMLL_H
#define NVMC_MOD_OTH_SUM_DBL_SMLL_H

/*-----------------------------------------------------------------------------------------------------------------------------------*/
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define NVMC_MOD_OTH_SUM_DBL_SMLL_H_MAJOR        (1U)
#define NVMC_MOD_OTH_SUM_DBL_SMLL_H_MINOR        (1U)
#define NVMC_MOD_OTH_SUM_DBL_SMLL_H_PATCH        (2U)
...
#endif /* NVMC_MOD_OTH_SUM_DBL_SMLL_H */

/*===================================================================================================================================*/
/*                                                                                                                                   */
/*  Change History  :  see nvmc_mod_oth_dbl_smll.c                                                                                   */
/*                                                                                                                                   */
/*===================================================================================================================================*/
