...
/*  Version                                                                                                                          */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define SCHDLR_CFG_H_MAJOR                       (2)
#define SCHDLR_CFG_H_MINOR                       (7)
...
/*  Macro Definitions                                                                                                                */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
#define __SCHDLR_MAIN_TASK_IMMD_START__          (0)

#define u1_g_SchdlrCfgMainRunnablechk()          ((U1)TRUE)
#define __SCHDLR_CFGHK_NOT_IN_RUN__              (0)
/* #define vd_g_SchdlrCfgMainNonInRun()             (vd_g_WdgM_MainTask()) */

#define __SCHDLR_CFGHK_IDLE_START__              (0)
/* #define vd_g_SchdlrCfgIdleStart()                (vd_g_IntDrvEcuRun()) */

#define __SCHDLR_CFGHK_IDLE_FINISH__             (0)
/* #define vd_g_SchdlrCfgIdleFinish()               ((void)u4_g_PLM_DI(u4_g_SCHDLR_IRQ_PREP_SHTDWN)) */
#define u1_g_SchdlrCfgShtdwnchk()                ((U1)FALSE)
...
/*  Constant Externs                                                                                                                 */
/*-----------------------------------------------------------------------------------------------------------------------------------*/
extern const U4               u4_gp_SCHDLR_TASK_CYCL_CFG[];
extern const U2               u2_g_SCHDLR_TASK_CYCL_START;
extern const U2               u2_g_SCHDLR_TASK_CYCL_MAX;

extern const ST_SCHDLR_RGLR   st_gp_SCHDLR_RGLR_TASK[];
extern const U2               u2_g_SCHDLR_RGLR_NUM_TASK;
