...
void SS_Pm_postClockUpCallout(SS_BootType u4_BootSource)
{
    ...
    (void)SS_Memory_set(__ghsbegin_bsw_sec_nvar_top, 0UL, (uintptr_t)BSW_SEC_NVAR_SIZE);
    (void)SS_Memory_copy(__ghsbegin_bsw_sec_nvar_withval_top, __ghsbegin_bsw_sec_nvar_ival_top, (uintptr_t)BSW_SEC_NVAR_WITHVAL_SIZE);
    (void)SS_Memory_set(__ghsbegin_bsw_sec_hsm_nvar_top, 0UL, (uintptr_t)BSW_SEC_HSM_NVAR_SIZE);
    (void)SS_Memory_copy(__ghsbegin_bsw_sec_hsm_nvar_withval_top, __ghsbegin_bsw_sec_hsm_nvar_ival_top, (uintptr_t)BSW_SEC_HSM_NVAR_WITHVAL_SIZE);
