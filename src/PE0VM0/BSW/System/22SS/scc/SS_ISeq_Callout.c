 ...
 * [Arguments]	SS_BootType u4_BootSource宴螢ｹ繝ｶ郢晢ｽｼ郢晞メ・ｦ竏晏ｱ・
 * [Return]		None
 * [Notes]		None
 *--------------------------------------------------------------------------*/
...
{
    /* vv User Hook start vv */
    Ecu_Arb_wkUpFctrInit(); /* Wfd邵ｺ・ｧ驗ゑｽｮ邵ｺ閧ｴ驪､邵ｺ莠包ｽｺ莠･・ｮ・*/
#ifdef ECU_SAMPLE_ON
 ...
 * [Arguments]	SS_ShutdownReqSrcType u4_ReqSrc宴蜚ｮhutdown request source type
 * [Return]		None
 ...
 * [Function]	郢ｧ・ｷ郢ｧ・ｹ郢暄綜ﾎ定ｿ･・ｶ隲ｷ邇厄ｽｪ・ｿ陋帶㏍蟲ｩ陷鷹亂・郢ｧ・ｿ郢ｧ・､郢晄ｺ佩ｦ郢ｧ・ｰ郢ｧ蜻育ｽｲ關灘ｸ吮・郢ｧ・
 * [Arguments]	None
 * [Return] 	None
 * [Notes]		None
 *--------------------------------------------------------------------------*/
