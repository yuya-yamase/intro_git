...
static void SS_Boot_initStackTopBottom(void)
{
...
#endif
    {
        (void)SS_Memory_set(__ghsbegin_ss_stack_top, 0UL, (uint32)__ghssize_ss_stack_top);
        (void)SS_Memory_set(__ghsbegin_ss_stack_bottom, 0UL, (uint32)__ghssize_ss_stack_bottom);
    }
#if (SS_USE_CORE_COUNT >= 2u)
    else if (u4CoreId == SS_CPUCORE_u4SLAVECORE1)
    {
        SS_ISeq_u4SyncCheck_1 = 0UL;
        (void)SS_Memory_set(__ghsbegin_ss_stack1_top, 0UL, (uint32)__ghssize_ss_stack1_top);
        (void)SS_Memory_set(__ghsbegin_ss_stack1_bottom, 0UL, (uint32)__ghssize_ss_stack1_bottom);
    }
#endif
#if (SS_USE_CORE_COUNT >= 3u)
    else if (u4CoreId == SS_CPUCORE_u4SLAVECORE2)
    {
        ...
        (void)SS_Memory_set(__ghsbegin_ss_stack2_top, 0UL, (uint32)__ghssize_ss_stack2_top);
        (void)SS_Memory_set(__ghsbegin_ss_stack2_bottom, 0UL, (uint32)__ghssize_ss_stack2_bottom);
    }
#endif
#if (SS_USE_CORE_COUNT >= 4u)
    else if (u4CoreId == SS_CPUCORE_u4SLAVECORE3)
    {
        ...
        (void)SS_Memory_set(__ghsbegin_ss_stack3_top, 0UL, (uint32)__ghssize_ss_stack3_top);
        (void)SS_Memory_set(__ghsbegin_ss_stack3_bottom, 0UL, (uint32)__ghssize_ss_stack3_bottom);
    }
#endif
#if (SS_USE_CORE_COUNT >= 2u)
    else
