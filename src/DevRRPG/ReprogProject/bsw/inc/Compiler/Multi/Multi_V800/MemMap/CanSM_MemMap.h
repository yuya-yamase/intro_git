/* CanSM_MemMap_h_Revision(v1.00) */
/******************************************************************************/
/* Protected                                                                  */
/* Copyright AUBASS CO., LTD.                                                 */
/******************************************************************************/
/******************************************************************************/
/* Object Name  | CanSM/MemMap/HEADER                                         */
/******************************************************************************/
...
#ifdef CANSM_START_SEC_VAR
#pragma ghs startsda
#pragma ghs section sbss = ".B_RAM_2ND"
#undef CANSM_START_SEC_VAR
#endif

#ifdef CANSM_STOP_SEC_VAR
#pragma ghs section sbss = default
#pragma ghs endsda
#undef CANSM_STOP_SEC_VAR
#endif

#ifdef CANSM_START_SEC_CST
 #if (REPROG_CFG_SMALL_RAM_USE == STD_ON)
 ...
 #endif
#undef CANSM_START_SEC_CST
#endif

#ifdef CANSM_STOP_SEC_CST
 #if (REPROG_CFG_SMALL_RAM_USE == STD_ON)
