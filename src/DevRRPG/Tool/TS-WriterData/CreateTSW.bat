...
set RPGAPL_ROM_STA=0x007BFDF0
set RPGAPL_ROM_END=0x007BFDFF
...
%GSREC_EXE% %GSREC_OPTION% -pad2 0x007BFDE0 0x007BFDFF 0x5AA5 -start 0x007BFDE0 -end 0x007BFDFF -bytes 16 %RPGAPL_OUT% -o %RPGAPL_TEMP%
