...
set GSREC_OPTION_HOST=-start 0x00000000 -end 0x001FFFFF -pad2 0x00000000 0x001FFFFF 0xFFFF
set GSREC_OPTION_PE0VM0=-start 0x00200000 -end 0x003FFFFF -pad2 0x00200000 0x003FFFFF 0xFFFF
set GSREC_OPTION_PE1VM1=-start 0x00400000 -end 0x007FFFFF -pad2 0x00400000 0x007FFFFF 0xFFFF
set GSREC_OPTION_PE2VM2=-start 0x00800000 -end 0x00BFFFFF -pad2 0x00800000 0x00BFFFFF 0xFFFF
set GSREC_OPTION_PE3VM3=-start 0x00C00000 -end 0x00FFFFFF -pad2 0x00C00000 0x00FFFFFF 0xFFFF
