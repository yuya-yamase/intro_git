...
set GHS_MOT_TSW_TRGT=..\RFP\bin\bs3ckpt_1m_usa_usr_tsw
set GHS_MOT_OTA_TRGT=..\RFP\bin\bs3ckpt_1m_usa_usr_ota
set GHS_MOT_RFP_TRGT=..\RFP\bin\bs3ckpt_1m_usa_usr_acbd
